...
public abstract class AbstractAppStorageArchiveTest {
    ...
    public void archive() throws IOException  {
        ...
        storage.consistent(rootFolderInfo.getId());
        ...
        storage.consistent(file1Info.getId());
        ...
        NodeInfo file2Info = storage.createNode(folder2Info.getId(), "file2", AbstractAppStorageTest.DATA_FILE_CLASS, "", 0, new NodeGenericMetadata()
                .setString("s1", "a"));
        storage.consistent(file2Info.getId());
        ...
        storage2.consistent(newRootFolderInfo.getId());
        ...
        storage2.consistent(rootFolderInfo2.getId());
