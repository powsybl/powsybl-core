...
//        network.getLoad("_LOAD__10_EC").setP0(100.0).setQ0(5.0);
//        network.getVoltageLevel("_BUS___10_VL").setHighVoltageLimit(1.2 * 380.0).setLowVoltageLimit(301.0)
//            .setNominalV(10.50);
//        network.getLine("_BUS___10-BUS___11-1_AC").setB1(1.0).setB2(2.0).setG1(1.1).setG2(2.1)
//            .setR(3.0).setX(4.0).getTerminal("_BUS___10_VL");
...
//        assertTrue(changes.size() == 9);
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ChangeTestIidmModel14.class);
}
