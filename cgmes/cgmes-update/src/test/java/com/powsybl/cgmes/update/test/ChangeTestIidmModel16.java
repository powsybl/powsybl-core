...
//        lccConverterStation.getTerminal().setQ(q1);
        ...
        network.getTwoWindingsTransformer("_045c1248-c766-11e1-8775-005056c00008").getRatioTapChanger().setTapPosition(7);
        ...
        network.getVoltageLevel("_0460f448-c766-11e1-8775-005056c00008").setHighVoltageLimit(1.2 * 380.0)
            .setNominalV(10.50);
