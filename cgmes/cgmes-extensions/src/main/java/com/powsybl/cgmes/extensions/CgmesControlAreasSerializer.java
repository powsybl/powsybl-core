...
public class CgmesControlAreasSerializer extends AbstractExtensionSerializer<Network, CgmesControlAreas> {
    ...
    public CgmesControlAreasSerializer() {
    ...
    @Override
    public void write(CgmesControlAreas extension, WriterContext context) {
    ...
    @Override
    public CgmesControlAreas read(Network extendable, ReaderContext context) {
