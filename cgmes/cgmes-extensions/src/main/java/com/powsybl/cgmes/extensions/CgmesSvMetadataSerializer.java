...
public class CgmesSvMetadataSerializer extends AbstractExtensionSerializer<Network, CgmesSvMetadata> {
    ...
    public CgmesSvMetadataSerializer() {
    ...
    @Override
    public void write(CgmesSvMetadata extension, WriterContext context) {
    ...
    @Override
    public CgmesSvMetadata read(Network extendable, ReaderContext context) {
