...
public class BaseVoltageMappingSerializer extends AbstractExtensionSerializer<Network, BaseVoltageMapping> {
    ...
    public BaseVoltageMappingSerializer() {
    ...
    @Override
    public void write(BaseVoltageMapping extension, WriterContext context) {
    ...
    @Override
    public BaseVoltageMapping read(Network extendable, ReaderContext context) {
