...
public class CgmesSshMetadataSerializer extends AbstractExtensionSerializer<Network, CgmesSshMetadata> {
    ...
    public CgmesSshMetadataSerializer() {
    ...
    @Override
    public void write(CgmesSshMetadata extension, WriterContext context) {
    ...
    @Override
    public CgmesSshMetadata read(Network extendable, ReaderContext context) {
