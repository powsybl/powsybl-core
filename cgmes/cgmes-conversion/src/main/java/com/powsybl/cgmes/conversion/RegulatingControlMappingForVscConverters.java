...
public class RegulatingControlMappingForVscConverters {
    ...
    private void apply(VscConverterStation vscConverter, String pccTerminal) {
        ...
        /** the flow terminal is also used for voltage TODO JAM Delete
        Terminal mappedRegulatingTerminal = RegulatingTerminalMapper
                .mapForVoltageControl(pccTerminal, context)
