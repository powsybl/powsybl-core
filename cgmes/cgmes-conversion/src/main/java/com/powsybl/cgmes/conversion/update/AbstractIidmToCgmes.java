...
public abstract class AbstractIidmToCgmes {
    ...
    protected static final String TRANSFORMER_WINDING = "TransformerWinding";
    protected static final String SUBREGION_ID = "subRegionId";
    protected static final String SUBREGION_NAME = "subRegionName";
    protected static final String REGION_NAME = "regionName";
    protected static final String REGION_ID = "regionId";
