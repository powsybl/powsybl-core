 ...
 */
public class OldTwoWindingsTransformerConversion extends AbstractConductingEquipmentConversion {

    protected static final String STRING_PHASE_ANGLE_CLOCK = "phaseAngleClock";

    public OldTwoWindingsTransformerConversion(PropertyBags ends, Map<String, PropertyBag> powerTransformerRatioTapChanger,
