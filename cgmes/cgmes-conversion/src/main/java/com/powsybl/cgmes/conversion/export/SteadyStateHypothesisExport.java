        ...
        for (ThreeWindingsTransformer twt : network.getThreeWindingsTransformers()) {
            for (ThreeWindingsTransformer.Leg leg : Arrays.asList(twt.getLeg1(), twt.getLeg2(), twt.getLeg3())) {
                ...
                if (leg.hasPhaseTapChanger()) {
                    ...
                    String tcCtrlId = getCgmesTapChangerControlId(twt, ptcId).orElseGet(() -> context.getNamingStrategy().getCgmesId(ref(twt), PHASE_TAP_CHANGER, ref(leg.getSide().getNum()), REGULATING_CONTROL));
                ...
                if (leg.hasRatioTapChanger()) {
                    ...
                    String tcCtrlId = getCgmesTapChangerControlId(twt, rtcId).orElseGet(() -> context.getNamingStrategy().getCgmesId(ref(twt), RATIO_TAP_CHANGER, ref(leg.getSide().getNum()), REGULATING_CONTROL));
