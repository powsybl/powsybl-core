...
class ExportNumberMaxValueTest extends AbstractSerDeTest {
    ...
    void testTemporaryLimitWithoutValue() throws IOException {
        ...
        Pattern tatl60Pattern = Pattern.compile("<cim:CurrentLimit rdf:ID=\"_L01_ACLS_T_1_DEFAULT_OLS_CurrentLimit_TATL_60_OLV\">.*?<cim:CurrentLimit.value>(.*?)</cim:CurrentLimit.value>",
            Pattern.DOTALL);
