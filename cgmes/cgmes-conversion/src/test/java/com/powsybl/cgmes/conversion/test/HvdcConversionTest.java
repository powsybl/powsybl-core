...
class HvdcConversionTest {
    ...
    void hvdcLinesEqTest() {
        ...
        Network network = readCgmesResources(DIR, "hvdcLine_EQ.xml");
    ...
    @Test
    void hvdcLinesEqSshTest() {
        // Same test as with EQ only, but this time the SSH is also read.
        Network network = readCgmesResources(DIR, "hvdcLine_EQ.xml", "hvdcLine_SSH.xml");

        // SSH provides converter state data (operating kinds, powers and voltages).
        assertTrue(containsLccConverter(network, "CSC_1", "Current source converter 1", "DCL_12", 0.0, -0.82506186));
        assertTrue(containsLccConverter(network, "CSC_2", "Current source converter 2", "DCL_12", 0.0, 0.8));
        assertTrue(containsHvdcLine(network, "DCL_12", SIDE_1_INVERTER_SIDE_2_RECTIFIER, "DC line 12", "CSC_1", "CSC_2", 4.65, 99.0, 118.8));

        assertTrue(containsVscConverter(network, "VSC_3", "Voltage source converter 3", "DCL_34", 0.0, 95, 0.0));
        assertTrue(containsVscConverter(network, "VSC_4", "Voltage source converter 4", "DCL_34", 0.0, 90, 0.0));
        assertTrue(containsHvdcLine(network, "DCL_34", SIDE_1_RECTIFIER_SIDE_2_INVERTER, "DC line 34", "VSC_3", "VSC_4", 9.92, 100.0, 120.0));
    }

    @Test
    void hvdcLinesFullTest() {
        // Same test as with EQ and SSH, but this time the SV is also read (the TP too but it isn't used).
        Network network = readCgmesResources(DIR, "hvdcLine_EQ.xml", "hvdcLine_SSH.xml", "hvdcLine_SV.xml", "hvdcLine_TP.xml");
        ...
        assertTrue(containsVscConverter(network, "VSC_3", "Voltage source converter 3", "DCL_34", 0.6, 95, 0.0));
        assertTrue(containsVscConverter(network, "VSC_4", "Voltage source converter 4", "DCL_34", 0.6036, 90, 0.0));
        assertTrue(containsHvdcLine(network, "DCL_34", SIDE_1_RECTIFIER_SIDE_2_INVERTER, "DC line 34", "VSC_3", "VSC_4", 9.92, 100.0, 120.0));
    }
