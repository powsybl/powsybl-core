...
class TapChangerConversionTest extends AbstractSerDeTest {
    ...
    void currentLimiterExportTest() throws IOException {
        ...
        assertEquals("http://iec.ch/TC57/2013/CIM-schema-cim16#RegulatingControlModeKind.activePower", getAttribute(tapChangerControl, "RegulatingControl.mode"));
        String limitSet = getElement(eqFile, "OperationalLimitSet", "PS1_PT_T_2_CURRENT_LIMITER_OLS");
        assertEquals("PS1_PT_T_2", getAttribute(limitSet, "OperationalLimitSet.Terminal"));
