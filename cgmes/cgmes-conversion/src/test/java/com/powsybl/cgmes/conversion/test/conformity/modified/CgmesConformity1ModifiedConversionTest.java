...
public class CgmesConformity1ModifiedConversionTest {
    ...
    public void microBEInvalidRegulatingControl() {
        ...
        assertSame(RegulationMode.OFF, generator1.getRegulationMode());
    ...
    public void microT4InvalidSvcMode() {
        ...
        assertEquals(RegulationMode.OFF, offSvc.getRegulationMode());
    }
    ...
    public void microT4ReactivePowerSvc() {
        ...
        assertEquals(RegulationMode.REACTIVE_POWER, reactivePowerSvc.getRegulationMode());
    ...
    public void microT4OffSvc() {
        ...
        assertNotNull(off1);
        assertEquals(RegulationMode.OFF, off1.getRegulationMode());
        ...
        assertNotNull(off2);
        assertEquals(RegulationMode.REACTIVE_POWER, off2.getRegulationMode());
    ...
    public void microT4SvcWithoutRegulatingControl() {
        ...
        assertEquals(RegulationMode.VOLTAGE, modifiedSvc.getRegulationMode());
    ...
    public void microT4ReactivePowerSvcWithMissingRegulatingControl() {
        ...
        StaticVarCompensator modifiedSvc = modified.getStaticVarCompensator("_3c69652c-ff14-4550-9a87-b6fdaccbb5f4");
        assertNotNull(modifiedSvc);
        assertEquals(RegulationMode.REACTIVE_POWER, modifiedSvc.getRegulationMode());
    ...
    public void miniBusBranchExternalInjectionControl() throws IOException {
        ...
        assertSame(RegulationMode.OFF, network.getGenerator("_089c1945-4101-487f-a557-66c013b748f6").getRegulationMode());
        assertSame(RegulationMode.VOLTAGE, network.getGenerator("_3de9e1ad-4562-44df-b268-70ed0517e9e7").getRegulationMode());
