...
public class CgmesConformity1ModifiedConversionTest {
    ...
    public void microBEUndefinedPatl() {
        ...
        CurrentLimits limits = line.getActiveCurrentLimits1().orElse(null);
    ...
    public void microBEMissingLimitValue() {
        ...
        CurrentLimits limits = line.getActiveCurrentLimits().orElse(null);
        assertNotNull(limits);
    ...
    public void miniNodeBreakerTestLimits() {
        ...
        assertEquals(1000, dl0.getActiveCurrentLimits().map(LoadingLimits::getPermanentLimit).orElse(0.0), tol);
        assertEquals(1000, dl1.getActiveCurrentLimits().map(LoadingLimits::getPermanentLimit).orElse(0.0), tol);
