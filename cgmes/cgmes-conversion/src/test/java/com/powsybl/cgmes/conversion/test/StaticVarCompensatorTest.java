...
class StaticVarCompensatorTest {
    ...
    void staticVarCompensatorControlTest() {
        ...
        assertExpectedControl(svc, RegulationMode.VOLTAGE, 405.0, -10.0, true);
    ...
    private static void assertExpectedControl(StaticVarCompensator staticVarCompensator, RegulationMode defaultRegulationMode,
