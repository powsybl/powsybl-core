...
public final class CgmesConformity1ModifiedCatalog {
    ...
    public static TestGridModelResources microGridBaseCaseBEEquivalentBranchWithDifferentNominals() {
        String base = ENTSOE_CONFORMITY_1
            + "/MicroGrid/BaseCase/CGMES_v2.4.15_MicroGridTestConfiguration_BC_BE_v2/";
        String baseModified = ENTSOE_CONFORMITY_1_MODIFIED
        ...
        String baseBoundary = ENTSOE_CONFORMITY_1
            + "/MicroGrid/BaseCase/CGMES_v2.4.15_MicroGridTestConfiguration_BD_v2/";
        return new TestGridModelResources("MicroGrid-BaseCase-BE-EquivalentBranch-with-different-nominals",
            null,
            new ResourceSet(baseModified,
                "MicroGridTestConfiguration_BC_BE_EQ_V2.xml"),
            new ResourceSet(base,
    ...
    public static TestGridModelResources microGridBaseCaseBEEquivalentBranchWithZeroImpedanceInsideVoltageLevel() {
        String base = ENTSOE_CONFORMITY_1
            + "/MicroGrid/BaseCase/CGMES_v2.4.15_MicroGridTestConfiguration_BC_BE_v2/";
        String baseModified = ENTSOE_CONFORMITY_1_MODIFIED
        ...
        String baseBoundary = ENTSOE_CONFORMITY_1
            + "/MicroGrid/BaseCase/CGMES_v2.4.15_MicroGridTestConfiguration_BD_v2/";
        return new TestGridModelResources("MicroGrid-BaseCase-BE-EquivalentBranch-with-zero-impedance-inside-voltage_level",
            null,
            new ResourceSet(baseModified,
                "MicroGridTestConfiguration_BC_BE_TP_V2.xml",
                "MicroGridTestConfiguration_BC_BE_EQ_V2.xml"),
    ...
    public static TestGridModelResources smallNodeBreakerHvdcTwoDcLineSegmentsOneTransformer() {
    ...
    public static TestGridModelResources smallNodeBreakerHvdcWithTwoTransformers() {
    ...
    public static TestGridModelResources smallNodeBreakerHvdcTwoAcDcConvertersTwoDcLineSegments() {
    ...
    public static TestGridModelResources smallNodeBreakerHvdcTwoAcDcConvertersTwoDcLineSegmentsNoAcConnectionAtOneEnd() {
    ...
    public static TestGridModel microGridBaseCaseAssembledBadIds() {
        String baseModified = ENTSOE_CONFORMITY_1_MODIFIED
                + "/MicroGrid/BaseCase/BC_Assembled_v2_bad_ids/";
        String baseBoundary = ENTSOE_CONFORMITY_1
                + "/MicroGrid/BaseCase/CGMES_v2.4.15_MicroGridTestConfiguration_BD_v2/";
        return new TestGridModelResources("MicroGrid-BaseCase-Assembled-bad-ids",
                null,
                new ResourceSet(baseModified,
                        "MicroGridTestConfiguration_BC_BE_EQ_V2.xml",
                        "MicroGridTestConfiguration_BC_BE_SSH_V2.xml",
    ...
    public static TestGridModel microGridBaseBEStationSupply() {
        String base = ENTSOE_CONFORMITY_1_MODIFIED
    ...
    public static TestGridModel microGridBaseBETargetDeadbandNegative() {
        String base = ENTSOE_CONFORMITY_1_MODIFIED
    ...
    public static TestGridModel microGridBaseBEInvalidVoltageBus() {
        String base = ENTSOE_CONFORMITY_1_MODIFIED
