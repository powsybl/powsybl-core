...
public final class CgmesConformity1Catalog {
    ...
    private static final String[] MICRO_GRID_BASED_CASE_BE_OPERATIONAL_LIMITS = {
        "05b69cbf-0e24-4c98-bd81-9450c751be6f",
    ...
    private static final String[] MICRO_GRID_BASED_CASE_BE_TERMINALS = {
        "02a244ca-8bcb-4e25-8613-e948b8ba1f22",
    ...
    private static final String[] MINI_NODE_BREAKER_OPERATIONAL_LIMITS = {
        "03f63965-4a6c-48c1-b859-b1247a48a49f",
    ...
    private static final String[] MINI_NODE_BREAKER_TERMINALS = {
        "01a240e9-5607-4844-9d53-5c8b08b5c9a8",
    ...
    public static InMemoryCgmesModel expectedMicroGridBaseCaseBE() {
        return new InMemoryCgmesModel()
                ...
                .terminals(MICRO_GRID_BASED_CASE_BE_TERMINALS)
                .operationalLimits(MICRO_GRID_BASED_CASE_BE_OPERATIONAL_LIMITS)
    ...
    private static InMemoryCgmesModel expectedMiniNodeBreaker() {
        return new InMemoryCgmesModel()
                ...
                .terminals(MINI_NODE_BREAKER_TERMINALS)
                .operationalLimits(MINI_NODE_BREAKER_OPERATIONAL_LIMITS)
