...
public class CgmesConformity1NetworkCatalog {
    ...
    public Network microBE(String modelId) {
        ...
        be7.newCurrentLimits().setPermanentLimit(1180)
                .beginTemporaryLimit()
                    .setName("BE-Line_7 - CL-0")
                    .setValue(1312.0)
                    .setAcceptableDuration(60 * 20)
                .endTemporaryLimit()
                .beginTemporaryLimit()
    ...
    public Network microBaseCaseBE() {
        ...
        be1.newCurrentLimits().setPermanentLimit(1443)
                .beginTemporaryLimit()
                    .setName("BE-Line_1 - CL-4")
                    .setValue(1500.0)
                    .setAcceptableDuration(60 * 30)
                .endTemporaryLimit()
                .beginTemporaryLimit()
                    .setName("BE-Line_1 - CL-3")
                    .setValue(1550.0)
                    .setAcceptableDuration(60 * 25)
                .endTemporaryLimit()
                .beginTemporaryLimit()
                    .setName("BE-Line_1 - CL-0")
                    .setValue(1574.0)
                    .setAcceptableDuration(60 * 20)
                .endTemporaryLimit()
                .beginTemporaryLimit()
