...
public final class Cgmes3Catalog {
    ...
    public static TestGridModelResources microGridWithoutTp() {
        String base = CGMES_3_TEST_MODELS + "/MicroGrid/";
        String baseBoundary = base;
        return new TestGridModelResources(
                "MicroGrid",
    ...
    public static TestGridModelResources miniGridWithoutTp() {
        String base = CGMES_3_TEST_MODELS + "/MiniGrid/";
        String baseBoundary = base;
        return new TestGridModelResources(
                "MiniGrid",
    ...
    public static TestGridModelResources smallGridWithoutTp() {
        String base = CGMES_3_TEST_MODELS + "/SmallGrid/";
        String baseBoundary = base;
        return new TestGridModelResources(
                "SmallGrid",
    ...
    public static TestGridModelResources svedalaWithoutTp() {
        String base = CGMES_3_TEST_MODELS + "/Svedala/";
        return new TestGridModelResources(
                "Svedala",
                null,
