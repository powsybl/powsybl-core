...
public final class CgmesConformity1ModifiedCatalog {
    ...
    public static TestGridModel miniNodeBreakerPhaseTapChangerMoveRegulatingTerminal() {
        ...
        String baseBoundary = ENTSOE_CONFORMITY_1
                + "/MiniGrid/NodeBreaker/CGMES_v2.4.15_MiniGridTestConfiguration_Boundary_v3/";
        return new TestGridModelResources(
                "MiniGrid-NodeBreaker-PhaseTapChangerMoveRegulatingTerminal",
                null,
                new ResourceSet(base,
                        "MiniGridTestConfiguration_BC_EQ_v3.0.0.xml",
                        "MiniGridTestConfiguration_BC_SSH_v3.0.0.xml"),
    ...
    public static TestGridModel miniNodeBreakerPhaseTapChangerRemoteRegulatingTerminalAtBusbarSection() {
        String base = ENTSOE_CONFORMITY_1_MODIFIED
                + "/MiniGrid/NodeBreaker/BaseCase_Complete_v3_phaseTapChangerRemoteRegulatingTerminalAtBusbarSection/";
        String baseOriginal = ENTSOE_CONFORMITY_1
                + "/MiniGrid/NodeBreaker/CGMES_v2.4.15_MiniGridTestConfiguration_BaseCase_Complete_v3/";
        String baseBoundary = ENTSOE_CONFORMITY_1
                + "/MiniGrid/NodeBreaker/CGMES_v2.4.15_MiniGridTestConfiguration_Boundary_v3/";
        return new TestGridModelResources(
                "MiniGrid-NodeBreaker-PhaseTapChangerRemoteRegulatingTerminalAtBusbarSection",
                null,
                new ResourceSet(base,
                        "MiniGridTestConfiguration_BC_EQ_v3.0.0.xml",
                        "MiniGridTestConfiguration_BC_SSH_v3.0.0.xml"),
