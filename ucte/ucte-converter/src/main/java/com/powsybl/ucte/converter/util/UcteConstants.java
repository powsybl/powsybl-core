...
public final class UcteConstants {
    ...
    public static final String NOT_POSSIBLE_TO_EXPORT = "It's not possible to export this network";
    public static final String NOT_POSSIBLE_TO_IMPORT = "It's not possible to import this network";
    public static final String ORDER_CODE = "orderCode";
    public static final int DEFAULT_MAX_CURRENT = 999999;
    public static final int DEFAULT_MAX_POWER = 999999;
