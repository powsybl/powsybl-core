...
public class UcteNodeCodeTest {
    ...
    @Test
    public void test() {
        UcteNodeCode node = new UcteNodeCode(UcteCountryCode.FR, "SUBST", UcteVoltageLevelCode.LV_380, '1');
        ...
        assertEquals(UcteVoltageLevelCode.LV_380, node.getVoltageLevelCode());
        node.setVoltageLevelCode(UcteVoltageLevelCode.LV_220);
        assertEquals(UcteVoltageLevelCode.LV_220, node.getVoltageLevelCode());
    ...
    public void testEquals() {
        UcteNodeCode node1 = new UcteNodeCode(UcteCountryCode.FR, "SUBST", UcteVoltageLevelCode.LV_380, '1');
        UcteNodeCode node2 = new UcteNodeCode(UcteCountryCode.FR, "SUBST", UcteVoltageLevelCode.LV_380, '1');
