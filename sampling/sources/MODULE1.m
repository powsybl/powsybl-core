...
%% Re-assign indices from largest to smallest cluster
% Sort indices according to freuqnecy
[~,I] = sort(histc(idx,1:K),'descend'); 
temp_idx = zeros(NObs,1);
for i = 1:K
    % Replace all indices in descending order
    temp_idx(idx == I(i)) = i;
end;
idx = temp_idx;
