...
public class DummyFaultResultExtensionSerializer implements ExtensionJsonSerializer<FaultResult, TestingResultFactory.DummyFaultResultExtension> {
    ...
    @Override
    public void serialize(TestingResultFactory.DummyFaultResultExtension extension, JsonGenerator jsonGenerator, SerializationContext serializationContext) throws JacksonException {
        jsonGenerator.writeStartObject();
        jsonGenerator.writeEndObject();
    }

    @Override
    public TestingResultFactory.DummyFaultResultExtension deserialize(JsonParser parser, DeserializationContext deserializationContext) throws JacksonException {
