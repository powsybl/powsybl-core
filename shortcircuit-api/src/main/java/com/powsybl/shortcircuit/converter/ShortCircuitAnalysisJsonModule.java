...
public class ShortCircuitAnalysisJsonModule extends SimpleModule {
    ...
    public ShortCircuitAnalysisJsonModule() {
        ...
        addSerializer(ShortCircuitAnalysisMultiResult.class, new ShortCircuitAnalysisResultSerializer());
        addDeserializer(ShortCircuitAnalysisMultiResult.class, new ShortCircuitAnalysisResultDeserializer());
