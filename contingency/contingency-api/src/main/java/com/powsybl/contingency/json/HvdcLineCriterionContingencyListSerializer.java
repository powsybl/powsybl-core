 ...
 */
public class HvdcLineCriterionContingencyListSerializer extends StdSerializer<HvdcLineCriterionContingencyList> {

    public HvdcLineCriterionContingencyListSerializer() {
