 ...
 */
public final class SidedContingencyElementUtils {

    private static final Logger LOGGER = LoggerFactory.getLogger(SidedContingencyElementUtils.class);

    private SidedContingencyElementUtils() {
    }
