...
class BranchTrippingTest {
    ...
    void lineTrippingTest() {
        ...
        Exception e1 = assertThrows(PowsyblException.class, () -> unknownLineModif.apply(network, true, ReportNode.NO_OP));
        ...
        Exception e2 = assertThrows(PowsyblException.class, () -> unknownVlModif.apply(network, true, ReportNode.NO_OP));
    ...
    void transformerTrippingTest() {
        ...
        Exception e1 = assertThrows(PowsyblException.class, () -> modifUnknown2wt.apply(network, true, ReportNode.NO_OP));
        ...
        Exception e2 = assertThrows(PowsyblException.class, () -> modifUnknownVl.apply(network, true, ReportNode.NO_OP));
