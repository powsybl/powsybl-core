 ...
 */
public class HighVoltageMeasurementPointAdderSmaccImpl extends AbstractMeasurementPointAdderImpl<SmaccAdder> {

    HighVoltageMeasurementPointAdderSmaccImpl(SmaccAdderImpl parent) {
        super(parent);
    }
    ...
    public SmaccAdderImpl add() {
        ...
        ((SmaccAdderImpl) parent).setHighVoltageMeasurementPoint(new MeasurementPointImpl(busbarSectionsOrBusesIds, ""));
