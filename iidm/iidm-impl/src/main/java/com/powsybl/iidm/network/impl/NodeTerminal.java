...
class NodeTerminal extends AbstractTerminal {
    ...
    protected final ExtendedDoubleArrayList v;

    protected final ExtendedDoubleArrayList angle;

    protected final ExtendedIntArrayList connectedComponentNumber;

    protected final ExtendedIntArrayList synchronousComponentNumber;
    ...
    NodeTerminal(Ref<? extends VariantManagerHolder> network, ThreeSides side, int node) {
        ...
        connectedComponentNumber = new ExtendedIntArrayList(variantArraySize, 0);
        synchronousComponentNumber = new ExtendedIntArrayList(variantArraySize, 0);
    }
    ...
    protected double getV() {
        ...
        return v.getDouble(getVariantManagerHolder().getVariantIndex());
    }
    ...
    double getAngle() {
        ...
        return angle.getDouble(getVariantManagerHolder().getVariantIndex());
    }
    ...
    int getConnectedComponentNumber() {
        ...
        return connectedComponentNumber.getInt(getVariantManagerHolder().getVariantIndex());
    }
    ...
    int getSynchronousComponentNumber() {
        ...
        return synchronousComponentNumber.getInt(getVariantManagerHolder().getVariantIndex());
    }
