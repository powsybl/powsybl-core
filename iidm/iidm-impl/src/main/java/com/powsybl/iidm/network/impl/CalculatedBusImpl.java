...
class CalculatedBusImpl extends AbstractBus implements CalculatedBus {
    ...
    CalculatedBusImpl(String id, String name, boolean fictitious, VoltageLevelExt voltageLevel, IntArrayList nodes, List<NodeTerminal> terminals, Function<Terminal, Bus> getBusFromTerminal) {
