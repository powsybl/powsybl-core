...
public class TieLineTest {
    ...
    private static Network createNetworkWithTieLine(NetworkFactory networkFactory,
        Branch.Side originalBoundarySide1, Branch.Side originalBoundarySide2, CaseSv caseSv) {
        ...
        TieLineAdder adder = network.newTieLine()
            .setId(originalBoundarySide1.name() + " + " + originalBoundarySide2.name())
            .setName(originalBoundarySide1.name() + " + " + originalBoundarySide2.name())
            .newHalfLine1()
            .setId(originalBoundarySide1.name())
            .setName(originalBoundarySide1.name())
            .setR(0.019)
            .setX(0.059)
            .setG1(0.02000)
            .setB1(0.050 * 0.5 + 0.05000)
            .setG2(0.03000)
            .setB2(0.050 * 0.5 + 0.04000)
            .setOriginalBoundarySide(originalBoundarySide1)
            .add()
            .newHalfLine2()
            .setId(originalBoundarySide2.name())
            .setName(originalBoundarySide2.name())
            .setR(0.038)
            .setX(0.118)
            .setG1(0.01500)
            .setB1(0.050 * 0.5 + 0.02500)
            .setG2(0.02500)
            .setB2(0.050 * 0.5 + 0.05500)
            .setOriginalBoundarySide(originalBoundarySide2)
            .add();
        ...
        tieLine.getTerminal1().setP(getOtherSideP(caseSv.line1, originalBoundarySide1));
        tieLine.getTerminal1().setQ(getOtherSideQ(caseSv.line1, originalBoundarySide1));

        tieLine.getTerminal2().getBusView().getBus().setV(caseSv.node2.v);
        tieLine.getTerminal2().getBusView().getBus().setAngle(caseSv.node2.a);
        tieLine.getTerminal2().setP(getOtherSideP(caseSv.line2, originalBoundarySide2));
        tieLine.getTerminal2().setQ(getOtherSideQ(caseSv.line2, originalBoundarySide2));
    ...
    private static double getOtherSideP(LineSv line, Branch.Side originalBoundarySide) {
        if (originalBoundarySide == Branch.Side.ONE) {
            return line.p2;
        } else {
            return line.p1;
        }
    ...
    private static double getOtherSideQ(LineSv line, Branch.Side originalBoundarySide) {
        if (originalBoundarySide == Branch.Side.ONE) {
            return line.q2;
        } else {
            return line.q1;
    ...
    private static double getP(LineSv line, Branch.Side originalBoundarySide) {
        if (originalBoundarySide == Branch.Side.ONE) {
            return line.p1;
        } else {
            return line.p2;
    ...
    private static double getQ(LineSv line, Branch.Side originalBoundarySide) {
        if (originalBoundarySide == Branch.Side.ONE) {
            return line.q1;
        } else {
            return line.q2;
