...
class TopologyTraverseDepthAndBreadthTest {
    ...
    void setUp() {
        ...
        vl1.newGenerator().setId("G1").setNode(2).setMinP(0).setMaxP(1).setTargetP(1).setLocalTargetQ(0).add();
        vl1.newGenerator().setId("G2").setNode(5).setMinP(0).setMaxP(1).setTargetP(1).setLocalTargetQ(0).add();
