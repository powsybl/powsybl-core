 ...
 */
public final class ThreeWindingsTransformerWithUnsortedEndsNodeBreakerNetworkFactory {
    ...
    private ThreeWindingsTransformerWithUnsortedEndsNodeBreakerNetworkFactory() {
    }
}
