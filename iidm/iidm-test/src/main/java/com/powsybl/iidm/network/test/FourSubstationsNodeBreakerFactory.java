...
public final class FourSubstationsNodeBreakerFactory {
    ...
    public static Network create(NetworkFactory networkFactory) {
        ...
        Generator generatorHydro1 = s1vl2.newGenerator()
                ...
                .setNode(7)
                .add();
        generatorHydro1.setRegulatingTerminal(generatorHydro1.getTerminal())
            .setTargetV(400.0)
            .setVoltageRegulatorOn(true);
        ...
        Generator generatorHydro2 = s1vl2.newGenerator()
                ...
                .setNode(9)
                .add();
        generatorHydro2.setRegulatingTerminal(generatorHydro2.getTerminal())
            .setTargetV(400.0)
            .setVoltageRegulatorOn(true);
        ...
        Generator generatorHydro3 = s1vl2.newGenerator()
                ...
                .setNode(11)
                .add();
        generatorHydro3.setRegulatingTerminal(generatorHydro3.getTerminal())
            .setTargetV(400)
            .setVoltageRegulatorOn(true);
        ...
        Generator generatorThermal2 = s3vl1.newGenerator()
                ...
                .setNode(6)
                .add();
        generatorThermal2.setRegulatingTerminal(generatorThermal2.getTerminal())
            .setTargetV(400)
            .setVoltageRegulatorOn(true);
