...
public final class FictitiousSwitchFactory {
    ...
    public static Network create() {
        ...
        twtCI.newPhaseTapChanger()
                ...
                .beginStep().setRdr(39.78473).setRdx(39.784725).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-42.8).endStep()
                .beginStep().setRdr(31.720245).setRdx(31.720242).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-40.18).endStep()
                .beginStep().setRdr(23.655737).setRdx(23.655735).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-37.54).endStep()
                .beginStep().setRdr(16.263271).setRdx(16.263268).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-34.9).endStep()
                .beginStep().setRdr(9.542847).setRdx(9.542842).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-32.26).endStep()
                .beginStep().setRdr(3.4944773).setRdx(3.4944773).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-29.6).endStep()
                .beginStep().setRdr(-1.8818557).setRdx(-1.8818527).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-26.94).endStep()
                .beginStep().setRdr(-7.258195).setRdx(-7.2581954).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-24.26).endStep()
                .beginStep().setRdr(-11.962485).setRdx(-11.962484).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-21.58).endStep()
                .beginStep().setRdr(-15.994745).setRdx(-15.994745).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-18.9).endStep()
                .beginStep().setRdr(-19.354952).setRdx(-19.354952).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-16.22).endStep()
                .beginStep().setRdr(-22.043127).setRdx(-22.043129).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-13.52).endStep()
                .beginStep().setRdr(-24.73129).setRdx(-24.731287).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-10.82).endStep()
                .beginStep().setRdr(-26.747417).setRdx(-26.747417).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-8.12).endStep()
                .beginStep().setRdr(-28.091503).setRdx(-28.091503).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-5.42).endStep()
                .beginStep().setRdr(-28.763538).setRdx(-28.763536).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-2.7).endStep()
                .beginStep().setRdr(-28.763538).setRdx(-28.763536).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(0.0).endStep()
                .beginStep().setRdr(-28.763538).setRdx(-28.763536).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(2.7).endStep()
                .beginStep().setRdr(-28.091503).setRdx(-28.091503).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(5.42).endStep()
                .beginStep().setRdr(-26.747417).setRdx(-26.747417).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(8.12).endStep()
                .beginStep().setRdr(-24.73129).setRdx(-24.731287).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(10.82).endStep()
