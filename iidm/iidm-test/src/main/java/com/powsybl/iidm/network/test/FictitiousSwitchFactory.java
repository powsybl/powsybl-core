...
public final class FictitiousSwitchFactory {
    ...
    public static Network create() {
        ...
        twtCI.newPhaseTapChanger()
                ...
                .beginStep().setR(39.78473).setX(39.784725).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-42.8).endStep()
                .beginStep().setR(31.720245).setX(31.720242).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-40.18).endStep()
                .beginStep().setR(23.655737).setX(23.655735).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-37.54).endStep()
                .beginStep().setR(16.263271).setX(16.263268).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-34.9).endStep()
                .beginStep().setR(9.542847).setX(9.542842).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-32.26).endStep()
                .beginStep().setR(3.4944773).setX(3.4944773).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-29.6).endStep()
                .beginStep().setR(-1.8818557).setX(-1.8818527).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-26.94).endStep()
                .beginStep().setR(-7.258195).setX(-7.2581954).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-24.26).endStep()
                .beginStep().setR(-11.962485).setX(-11.962484).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-21.58).endStep()
                .beginStep().setR(-15.994745).setX(-15.994745).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-18.9).endStep()
                .beginStep().setR(-19.354952).setX(-19.354952).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-16.22).endStep()
                .beginStep().setR(-22.043127).setX(-22.043129).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-13.52).endStep()
                .beginStep().setR(-24.73129).setX(-24.731287).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-10.82).endStep()
                .beginStep().setR(-26.747417).setX(-26.747417).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-8.12).endStep()
                .beginStep().setR(-28.091503).setX(-28.091503).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-5.42).endStep()
                .beginStep().setR(-28.763538).setX(-28.763536).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(-2.7).endStep()
                .beginStep().setR(-28.763538).setX(-28.763536).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(0.0).endStep()
                .beginStep().setR(-28.763538).setX(-28.763536).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(2.7).endStep()
                .beginStep().setR(-28.091503).setX(-28.091503).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(5.42).endStep()
                .beginStep().setR(-26.747417).setX(-26.747417).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(8.12).endStep()
                .beginStep().setR(-24.73129).setX(-24.731287).setG1(0.0).setB1(0.0).setG2(0.0).setB2(0.0).setRho(1.0).setAlpha(10.82).endStep()
