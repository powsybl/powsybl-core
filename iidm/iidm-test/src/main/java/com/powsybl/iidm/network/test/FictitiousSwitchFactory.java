...
public final class FictitiousSwitchFactory {
    ...
    public static Network create() {
        ...
        twtCI.newPhaseTapChanger()
                ...
                .endTap().setRdr(39.78473).setRdx(39.784725).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-42.8).endTap()
                .endTap().setRdr(31.720245).setRdx(31.720242).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-40.18).endTap()
                .endTap().setRdr(23.655737).setRdx(23.655735).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-37.54).endTap()
                .endTap().setRdr(16.263271).setRdx(16.263268).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-34.9).endTap()
                .endTap().setRdr(9.542847).setRdx(9.542842).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-32.26).endTap()
                .endTap().setRdr(3.4944773).setRdx(3.4944773).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-29.6).endTap()
                .endTap().setRdr(-1.8818557).setRdx(-1.8818527).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-26.94).endTap()
                .endTap().setRdr(-7.258195).setRdx(-7.2581954).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-24.26).endTap()
                .endTap().setRdr(-11.962485).setRdx(-11.962484).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-21.58).endTap()
                .endTap().setRdr(-15.994745).setRdx(-15.994745).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-18.9).endTap()
                .endTap().setRdr(-19.354952).setRdx(-19.354952).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-16.22).endTap()
                .endTap().setRdr(-22.043127).setRdx(-22.043129).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-13.52).endTap()
                .endTap().setRdr(-24.73129).setRdx(-24.731287).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-10.82).endTap()
                .endTap().setRdr(-26.747417).setRdx(-26.747417).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-8.12).endTap()
                .endTap().setRdr(-28.091503).setRdx(-28.091503).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-5.42).endTap()
                .endTap().setRdr(-28.763538).setRdx(-28.763536).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(-2.7).endTap()
                .endTap().setRdr(-28.763538).setRdx(-28.763536).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(0.0).endTap()
                .endTap().setRdr(-28.763538).setRdx(-28.763536).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(2.7).endTap()
                .endTap().setRdr(-28.091503).setRdx(-28.091503).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(5.42).endTap()
                .endTap().setRdr(-26.747417).setRdx(-26.747417).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(8.12).endTap()
                .endTap().setRdr(-24.73129).setRdx(-24.731287).setRdg(0.0).setRdb(0.0).setRatio(1.0).setPhaseShift(10.82).endTap()
