    ...
    public static Network create() {
        ...
        twt.getLeg2().newRatioTapChanger()
            .beginStep()
                ...
                .setRdr(0.9801)
                .setRdx(0.09801)
                .setRdg(0.08264462809917356)
                .setRdb(0.008264462809917356)
            .endStep()
            .beginStep()
                .setRatio(1.0)
                .setRdr(1.089)
                .setRdx(0.1089)
                .setRdg(0.09182736455463728)
                .setRdb(0.009182736455463728)
            .endStep()
            .beginStep()
                .setRatio(1.1)
                .setRdr(1.1979)
                .setRdx(0.11979)
                .setRdg(0.10101010101010101)
                .setRdb(0.010101010101010101)
            .endStep()
            .setTapPosition(2)
        ...
        twt.getLeg3().newRatioTapChanger()
            .beginStep()
                ...
                .setRdr(0.1089)
                .setRdx(0.01089)
                .setRdg(0.8264462809917356)
                .setRdb(0.08264462809917356)
            .endStep()
            .beginStep()
                .setRatio(1.0)
                .setRdr(0.121)
            ...
            .beginStep()
                ...
                .setRdr(0.1331)
                .setRdx(0.01331)
                .setRdg(0.9090909090909092)
                .setRdb(0.09090909090909092)
            .endStep()
            .setTapPosition(0)
            .setLoadTapChangingCapabilities(true)
            .setRegulating(true)
