    ...
    public static Network create() {
        ...
        twt.getLeg2().newRatioTapChanger()
            .beginStep()
                ...
                .setR(0.9801)
                .setX(0.09801)
                .setG1(0.08264462809917356)
                .setB1(0.008264462809917356)
                .setG2(0.0)
                .setB2(0.0)
            .endStep()
            .beginStep()
                ...
                .setR(1.089)
                .setX(0.1089)
                .setG1(0.09182736455463728)
                .setB1(0.009182736455463728)
                .setG2(0.0)
                .setB2(0.0)
            .endStep()
            .beginStep()
                ...
                .setR(1.1979)
                .setX(0.11979)
                .setG1(0.10101010101010101)
                .setB1(0.010101010101010101)
                .setG2(0.0)
                .setB2(0.0)
            .endStep()
            .setTapPosition(2)
        ...
        twt.getLeg3().newRatioTapChanger()
            .beginStep()
                ...
                .setR(0.1089)
                .setX(0.01089)
                .setG1(0.8264462809917356)
                .setB1(0.08264462809917356)
                .setG2(0.0)
                .setB2(0.0)
            .endStep()
            .beginStep()
            ...
            .beginStep()
                ...
                .setR(0.1331)
                .setX(0.01331)
                .setG1(0.9090909090909092)
                .setB1(0.09090909090909092)
                .setG2(0.0)
                .setB2(0.0)
            .endStep()
            .setTapPosition(0)
