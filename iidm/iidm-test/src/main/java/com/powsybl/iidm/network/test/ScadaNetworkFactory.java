...
public final class ScadaNetworkFactory {
    ...
    public static Network create(NetworkFactory networkFactory) {
        ...
        network.newHvdcLine()
                ...
                .setId("hvdcline")
                .add();
        createTransformers(sub, vl, vl2, vl3, busId, bus2Id);
        return network;
    }

    private static void createTransformers(Substation sub, VoltageLevel vl, VoltageLevel vl2, VoltageLevel vl3, String busId, String bus2Id) {
