 ...
 */
public interface LimitsGroupsHolder<G extends CurrentLimitsGroup> {
    ...
    /**
     * <p>Get the ID of the last {@link CurrentLimitsGroup} set as selected (either by {@link #setSelectedOperationalLimitsGroup(String)} or any other mean).</p>
     ...
     * @return the ID of the last selected {@link CurrentLimitsGroup} from all the selected groups if any,
    ...
    /**
     * Get the IDs of all the selected {@link CurrentLimitsGroup}
     * @return a collection containing one ID per selected {@link CurrentLimitsGroup} (might be empty if there is none selected)
     */
    Collection<String> getAllSelectedOperationalLimitsGroupIds();

    /**
     * Get the IDs of all the selected {@link CurrentLimitsGroup}, in the order in which they were selected.<br>
     ...
     *
     * @return an ordered collection of the IDs of all the selected {@link CurrentLimitsGroup}, the ordering relation being the order of the selection, from
     * the oldest selected group to the most recently selected group.
     */
    List<String> getAllSelectedOperationalLimitsGroupIdsOrdered();

    /**
     * Get the {@link CurrentLimitsGroup} corresponding to an ID.
     * <p>Throw a {@link NullPointerException} if the ID is <code>null</code>.</p>
     * @return the {@link CurrentLimitsGroup} of the given ID if any, an empty {@link Optional} otherwise.
     */
    Optional<G> getOperationalLimitsGroup(String id);

    /**
     * Get the {@link CurrentLimitsGroup} that was last selected (either by {@link #setSelectedOperationalLimitsGroup(String)} or any other mean)
     ...
     * @return the first selected {@link CurrentLimitsGroup} from all the selected if any,
    ...
    /**
     * Get all the selected {@link CurrentLimitsGroup}. The list's order must be stable when elements are added or deleted.
     * @return a list containing all selected {@link CurrentLimitsGroup} (might be empty if there is none selected)
     */
    List<G> getAllSelectedOperationalLimitsGroups();

    /**
     * <p>Create a new {@link CurrentLimitsGroup} with the given ID.</p>
     * <p>If a group of the given ID already exists, it is replaced silently.</p>
     * @return the newly created group {@link CurrentLimitsGroup}.
     */
    G newOperationalLimitsGroup(String id);

    /**
     * <p>Set the {@link CurrentLimitsGroup} corresponding to the given ID as the only selected one. If other groups were also selected, they are all deselected</p>
     ...
     * @param id an ID of {@link CurrentLimitsGroup}
     */
    void setSelectedOperationalLimitsGroup(String id);

    /**
     * <p>Set the {@link CurrentLimitsGroup} corresponding to the given IDs as selected. If other groups were also selected, they are still selected</p>
     ...
     * @param ids the IDs of one or more {@link CurrentLimitsGroup}
     */
    void addSelectedOperationalLimitsGroups(String... ids);

    /**
     * <p>Set all the existing {@link CurrentLimitsGroup} whose id match the <code>predicate</code> as selected</p>
     * To deselect a selected group, use {@link #deselectOperationalLimitsGroups(String...)}.
     * To deselect all the selected groups, use {@link #cancelSelectedOperationalLimitsGroup()}
     * To have a single group selected and deselect all other groups, use {@link #setSelectedOperationalLimitsGroup(String)}
    ...
    /**
     * <p>Remove the {@link CurrentLimitsGroup} corresponding to the given ID.
    ...
    /**
     * <p>Deselect all the selected {@link CurrentLimitsGroup}.</p>
     * <p>After calling this method, no {@link CurrentLimitsGroup} is selected.</p>
     * To deselect a specific {@link CurrentLimitsGroup}, use {@link #deselectOperationalLimitsGroups(String...)}
     */
    void cancelSelectedOperationalLimitsGroup();

    /**
     * <p>Deselect the {@link CurrentLimitsGroup} corresponding to all the <code>ids</code>.</p>
     * <p>For any of the ID, this method will do nothing in the following cases:
     * <ul>
     *     <li>The {@link CurrentLimitsGroup} corresponding to the ID exists but is not selected</li>
     *     <li>The ID does not correspond to any existing group</li>
     *     <li>The ID is null</li>
     * </ul>
     * </p>
     * To deselect all {@link CurrentLimitsGroup}, use {@link #cancelSelectedOperationalLimitsGroup()}
     * @param ids the IDs of the groups to remove from the selected
     */
    void deselectOperationalLimitsGroups(String... ids);

    /**
     * Get the {@link CurrentLimits} of the last selected {@link CurrentLimitsGroup}.
     * @return {@link CurrentLimits} of the last selected {@link CurrentLimitsGroup} if any, <code>null</code> otherwise.
     */
    ...
    /**
     * Get the {@link CurrentLimits} of the {@link CurrentLimitsGroup} corresponding to <code>id</code>
     * <p>Throw a {@link NullPointerException} if the ID is <code>null</code>.</p>
     * @return a {@link Optional} containing the {@link CurrentLimits} of the {@link CurrentLimitsGroup} corresponding to the id if it exists,
     * an empty {@link Optional} otherwise,
     */
    ...
    /**
     * Get all the {@link CurrentLimits} of all the selected {@link CurrentLimitsGroup}
    ...
    /**
     * <p>Get the {@link CurrentLimitsGroup} corresponding to the default ID or create a new one if it does not exist.
     * Set the {@link CurrentLimitsGroup} as the only selected one.</p>
     * @return the selected {@link CurrentLimitsGroup}.
     */
    G getOrCreateSelectedOperationalLimitsGroup();

    /**
     * <p>Get the {@link CurrentLimitsGroup} corresponding to the given ID or create a new one if it does not exist.
     * Set the {@link CurrentLimitsGroup} as the only selected one .</p>
     * @param limitsGroupId an ID of {@link CurrentLimitsGroup}
     * @return the selected {@link CurrentLimitsGroup}.
     */
