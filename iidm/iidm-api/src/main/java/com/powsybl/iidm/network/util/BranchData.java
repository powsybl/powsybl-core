...
public class BranchData {
    ...
    public BranchData(TwoWindingsTransformer twt, double epsilonX, boolean applyReactanceCorrection,
         ...
         * LOG.info("1 / rho1 {} ", 1 / (twt.getRatedU2() / twt.getRatedU1())); if
         * (twt.getRatioTapChanger() != null) { LOG.info("rho1' {}",
         * twt.getRatioTapChanger().getCurrentStep().getRho()); }
         * LOG.info("rateU1 {} rateU2 {}", twt.getRatedU1(), twt.getRatedU2()); }
         */
    ...
    private void computeValues() {
        if (!connected1 && !connected2) {
            ...
            /*
             * if (id.equals("_f9aec7ee-396b-4401-aebf-31644eb4b06d")) {
             * LOG.info("1 / rho1 {} -alpha1 {}", 1 / rho1, -alpha1);
             * LOG.info("1 / rho2 {} -alpha2 {}", 1 / rho2, -alpha2); LOG.info("y11 {}",
             * branchAdmittance.y11); LOG.info("y12 {}", branchAdmittance.y12);
             * LOG.info("y21 {}", branchAdmittance.y21); LOG.info("y22 {}",
             * branchAdmittance.y22); }
             */
