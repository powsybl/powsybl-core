...
public final class NetworkReports {
    ...
    public static void acDcConverterControlModeNotSet(ReportNode reportNode) {
        reportNode.newReportNode()
    ...
    public static void acDcConverterControlTargetPInvalid(ReportNode reportNode) {
        reportNode.newReportNode()
    ...
    public static void acDcConverterControlInvalidTargetVDc(ReportNode reportNode) {
        reportNode.newReportNode()
    ...
    public static void ptcPhaseRegulationCannotBeEnabledWithoutLoadTapChanging(ReportNode reportNode) {
        reportNode.newReportNode()
