...
public class TwtTestData {
    ...
    public TwtTestData() {
        ...
        Mockito.when(leg1.getB1()).thenReturn(B11);
        Mockito.when(leg1.getG1()).thenReturn(G11);
        Mockito.when(leg1.getB2()).thenReturn(B12);
        Mockito.when(leg1.getG2()).thenReturn(G12);
        ...
        Mockito.when(leg2.getB1()).thenReturn(B21);
        Mockito.when(leg2.getG1()).thenReturn(G21);
        Mockito.when(leg2.getB2()).thenReturn(B22);
        Mockito.when(leg2.getG2()).thenReturn(G22);
        ...
        Mockito.when(leg3.getB1()).thenReturn(B31);
        Mockito.when(leg3.getG1()).thenReturn(G31);
        Mockito.when(leg3.getB2()).thenReturn(B32);
        Mockito.when(leg3.getG2()).thenReturn(G32);
