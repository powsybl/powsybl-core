...
class CreateLineOnLineTest extends AbstractModificationTest {
    ...
    void testExceptions() {
        ...
        assertEquals("unexpectedIdentifiableType", reporter3.getSubReporters().iterator().next().getKey());
        ...
        assertEquals("undefinedFictitiousSubstationId", reporter4.getSubReporters().iterator().next().getKey());
        ...
        assertEquals("undefinedPercent", reporter5.getSubReporters().iterator().next().getKey());
    }
