...
class RemoveFeederBayTest {
    ...
    void testRemoveBbs() {
        Network network = createNetwork2Feeders();
        ReportNode reportNode = new ReportNodeRootBuilderImpl().withMessageTemplate("reportTestRemoveBbs", "Testing reportNode when trying to remove a busbar section").build();
