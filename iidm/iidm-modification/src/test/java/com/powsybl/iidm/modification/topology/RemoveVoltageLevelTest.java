...
class RemoveVoltageLevelTest extends AbstractModificationTest {
    ...
    void testLoops() {
        ...
        DanglingLine dl1 = vl1.newDanglingLine().setId("DL1").setPairingKey("XNODE").setNode(2).setP0(0.0).setQ0(0.0).setR(1.5).setX(13.0).setG(0.0).setB(1e-6).add();
        DanglingLine dl2 = vl2.newDanglingLine().setId("DL2").setPairingKey("XNODE").setNode(1).setP0(0.0).setQ0(0.0).setR(1.5).setX(13.0).setG(0.0).setB(1e-6).add();
