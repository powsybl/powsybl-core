...
class CreateFeederBayTest extends AbstractModificationTest {
    ...
    void testException() {
        ...
        assertEquals("networkMismatch", reportNode1.getChildren().iterator().next().getMessageKey());
        ...
        assertEquals("notFoundBusOrBusbarSection", reportNode2.getChildren().iterator().next().getMessageKey());
        ...
        assertEquals("unsupportedIdentifiableType", reportNode3.getChildren().iterator().next().getMessageKey());
    }
    ...
    void testExceptionInvalidValue() {
        ...
        assertEquals("unexpectedNegativePositionOrder", reportNode1.getChildren().iterator().next().getMessageKey());
        ...
        assertEquals("unexpectedNullPositionOrder", reportNode2.getChildren().iterator().next().getMessageKey());
    }
