...
class CreateVoltageLevelTopologyTest extends AbstractModificationTest {
    ...
    void testWithNullSwitchKind() {
        ...
        assertEquals("undefinedSwitchKind", reporter.getSubReporters().iterator().next().getKey());
    ...
    void testWithUnsupportedSwitchKind() {
        ...
        assertEquals("wrongSwitchKind", reporter.getSubReporters().iterator().next().getKey());
    ...
    void testWithNegativeCount() {
        ...
        assertEquals("countLowerThanMin", reporter.getSubReporters().iterator().next().getKey());
    ...
    void testWithUnexpectedSwitchKindsSize() {
        ...
        assertEquals("unexpectedSwitchKindsCount", reporter.getSubReporters().iterator().next().getKey());
    ...
    void testWithNotExistingVoltageLevel() {
        ...
        assertEquals("voltageLevelNotFound", reporter.getSubReporters().iterator().next().getKey());
    }
