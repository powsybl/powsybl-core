 ...
 */
class CreateBranchFeederBaysTest extends AbstractSerializerTest {
    ...
    void baseNodeBreakerLineTest() throws IOException {
        ...
        roundTripXmlTest(nbNetwork, NetworkSerializer::writeAndValidate, NetworkSerializer::validateAndRead,
    ...
    void baseBusBreakerLineTest() throws IOException {
        ...
        roundTripXmlTest(bbNetwork, NetworkSerializer::writeAndValidate, NetworkSerializer::validateAndRead,
