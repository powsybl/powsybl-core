...
class ReplaceTieLinesByLinesTest extends AbstractModificationTest {
    ...
    private static Network createBusBreakerNetworkWithAliasesPropertiesExtensions() {
        ...
        BoundaryLine dl1 = network.getDanglingLine("NHV1_XNODE1");
        dl1.addAlias("test1");
        ...
        BoundaryLine dl2 = network.getDanglingLine("XNODE1_NHV2");
        dl2.addAlias("test3");
    ...
    private static Network createDummyNodeBreakerNetwork() {
        ...
        BoundaryLine dl1 = vl1.newDanglingLine().setId("DL1").setNode(0).setP0(0.0).setQ0(0.0).setR(1.5).setX(13.0).setG(0.0).setB(1e-6).add();
        BoundaryLine dl2 = vl2.newDanglingLine().setId("DL2").setNode(0).setP0(0.0).setQ0(0.0).setR(1.5).setX(13.0).setG(0.0).setB(1e-6).add();
