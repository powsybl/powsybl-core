...
class ReplaceTeePointByVoltageLevelOnLineTest extends AbstractModificationTest {
    ...
    void replaceTeePointByVoltageLevelOnLineNbTest() throws IOException {
        ...
        assertEquals("lineNotFound", reporter3.getSubReporters().iterator().next().getKey());
        ...
        assertEquals("busbarSectionNotFound", reporter4.getSubReporters().iterator().next().getKey());
        ...
        assertEquals("noTeePointAndOrTappedVoltageLevel", reporter5.getSubReporters().iterator().next().getKey());
        ...
        assertEquals("busbarSectionNotFound", reporter6.getSubReporters().iterator().next().getKey());
    ...
    void replaceTeePointByVoltageLevelOnLineBbTest() throws IOException {
        ...
        assertEquals("busNotFound", reporter1.getSubReporters().iterator().next().getKey());
        ...
        assertEquals("busNotFound", reporter2.getSubReporters().iterator().next().getKey());
