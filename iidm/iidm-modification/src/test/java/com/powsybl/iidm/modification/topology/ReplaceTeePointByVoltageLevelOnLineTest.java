...
public class ReplaceTeePointByVoltageLevelOnLineTest extends AbstractXmlConverterTest {
    ...
    public void replaceTeePointByVoltageLevelOnLineNbTest() throws IOException {
        ...
        NetworkModification modificationWithError1 = new ReplaceTeePointByVoltageLevelOnLine("line1NotFound", "CJ_2", "testLine", "VLTEST", BBS, "NEW LINE1", null, "NEW LINE2", null);
        ...
        NetworkModification modificationWithError2 = new ReplaceTeePointByVoltageLevelOnLine("CJ_1", "line2NotFound", "testLine", "VLTEST", BBS, "NEW LINE1", null, "NEW LINE2", null);
        ...
        NetworkModification modificationWithError3 = new ReplaceTeePointByVoltageLevelOnLine("CJ_1", "CJ_2", "line3NotFound", "VLTEST", BBS, "NEW LINE1", null, "NEW LINE2", null);
        ...
        NetworkModification modificationWithError4 = new ReplaceTeePointByVoltageLevelOnLine("CJ_1", "CJ_2", "testLine", "notFoundVoltageLevel", BBS, "NEW LINE1", null, "NEW LINE2", null);
        ...
        NetworkModification modificationWithError5 = new ReplaceTeePointByVoltageLevelOnLine("CJ_1", "CJ_2", "testLine", "VLTEST", "notFoundBusbarSection", "NEW LINE1", null, "NEW LINE2", null);
        ...
        NetworkModification modificationWithError6 = new ReplaceTeePointByVoltageLevelOnLine("CJ_1", "CJ_2", "LINE34", "VLTEST", BBS, "NEW LINE1", null, "NEW LINE2", null);
        ...
        modification = new ReplaceTeePointByVoltageLevelOnLine("CJ_1", "CJ_2", "testLine", "VLTEST", BBS, "NEW LINE1", null, "NEW LINE2", null);
        modification.apply(network);
    ...
    public void replaceTeePointByVoltageLevelOnLineNbBbTest() throws IOException {
        ...
        modification = new ReplaceTeePointByVoltageLevelOnLine("NHV1_NHV2_1_1", "NHV1_NHV2_1_2", "testLine", VOLTAGE_LEVEL_ID, BBS, "NEW LINE1", null, "NEW LINE2", null);
        modification.apply(network);
        roundTripXmlTest(network, NetworkXml::writeAndValidate, NetworkXml::validateAndRead,
    ...
    public void replaceTeePointByVoltageLevelOnLineBbTest() throws IOException {
        ...
        NetworkModification modificationWithError = new ReplaceTeePointByVoltageLevelOnLine("NHV1_NHV2_1_1", "NHV1_NHV2_1_2", "testLine", VOLTAGE_LEVEL_ID, "busNotFound", "NEW LINE1", null, "NEW LINE2", null);
        ...
        modification = new ReplaceTeePointByVoltageLevelOnLine("NHV1_NHV2_1_1", "NHV1_NHV2_1_2", "testLine", VOLTAGE_LEVEL_ID, "bus", "NEW LINE1", null, "NEW LINE2", null);
        modification.apply(network);
        roundTripXmlTest(network, NetworkXml::writeAndValidate, NetworkXml::validateAndRead,
    ...
    public void testConstructor() {
        ReplaceTeePointByVoltageLevelOnLine modification = new ReplaceTeePointByVoltageLevelOnLine("NHV1_NHV2_1", "NHV1_NHV2_2", "NHV1_NHV2_3", "VL", "BBS", "NEW LINE1 ID", null, "NEW LINE2 ID", null);
        ...
        modification = new ReplaceTeePointByVoltageLevelOnLine("NHV1_NHV2_1", "NHV1_NHV2_2", "NHV1_NHV2_3", "VL", "BBS", "NEW LINE1 ID", "NEW LINE1 NAME", "NEW LINE2 ID", "NEW LINE2 NAME");
