...
class ReplaceTeePointByVoltageLevelOnLineTest extends AbstractModificationTest {
    ...
    void replaceTeePointByVoltageLevelOnLineNbTest() throws IOException {
        ...
        ReportNode reporter1 = ReportNode.newRootReportNode().withMessageTemplate("reportTestLineNotFound", "Testing reporter with wrong line1 id").build();
        ...
        ReportNode reporter2 = ReportNode.newRootReportNode().withMessageTemplate("reportTestLineNotFound2", "Testing reporter with wrong line2 id").build();
        ...
        ReportNode reporter3 = ReportNode.newRootReportNode().withMessageTemplate("reportTestLineNotFound", "Testing reporter with wrong tee point line").build();
        ...
        ReportNode reporter4 = ReportNode.newRootReportNode().withMessageTemplate("reportTestBbsNotFound", "Testing reporter with wrong bbs").build();
        ...
        ReportNode reporter5 = ReportNode.newRootReportNode().withMessageTemplate("reportTestWrongTeePoint", "Testing reporter with wrong tee point").build();
        ...
        ReportNode reporter6 = ReportNode.newRootReportNode().withMessageTemplate("reportTestBbsInWrongVL", "Testing reporter with busbar section in wrong voltage level").build();
        ...
        ReportNode reporter = ReportNode.newRootReportNode().withMessageTemplate("reportTestReplaceTeePointByVoltageLevelOnLineNB", "Testing reporter when replacing tee point by voltage level on line in Node/breaker network").build();
    ...
    void replaceTeePointByVoltageLevelOnLineNbBbTest() throws IOException {
        ...
        ReportNode reporter = ReportNode.newRootReportNode().withMessageTemplate("reportTestReplaceTeePointByVoltageLevelOnLineNBBb", "Testing reporter when replacing tee point by voltage level on line").build();
        modification = new ReplaceTeePointByVoltageLevelOnLineBuilder()
    ...
    void replaceTeePointByVoltageLevelOnLineBbTest() throws IOException {
        ...
        ReportNode reporter1 = ReportNode.newRootReportNode().withMessageTemplate("reportTestUndefinedBus", "Testing reporter with undefined bus").build();
        NetworkModification modificationWithError1 = new ReplaceTeePointByVoltageLevelOnLineBuilder()
                .withTeePointLine1("NHV1_NHV2_1_1")
                .withTeePointLine2("NHV1_NHV2_1_2")
                .withTeePointLineToRemove("testLine")
        ...
        ReportNode reporter2 = ReportNode.newRootReportNode().withMessageTemplate("reportTestBusInWrongVl", "Testing reporter with bus in wrong voltage level").build();
        NetworkModification modificationWithError2 = new ReplaceTeePointByVoltageLevelOnLineBuilder()
                .withTeePointLine1("NHV1_NHV2_1_1")
                .withTeePointLine2("NHV1_NHV2_1_2")
                .withTeePointLineToRemove("testLine")
        ...
        ReportNode reporter3 = ReportNode.newRootReportNode().withMessageTemplate("reportTestReplaceTeePointByVoltageLevelOnLineBb", "Testing reporter when replacing tee point by voltage level on line in bus/breaker network").build();
        modification = new ReplaceTeePointByVoltageLevelOnLineBuilder()
                .withTeePointLine1("NHV1_NHV2_1_1")
                .withTeePointLine2("NHV1_NHV2_1_2")
                .withTeePointLineToRemove("testLine")
