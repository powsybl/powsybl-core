...
class RevertConnectVoltageLevelOnLineTest extends AbstractModificationTest {
    ...
    void revertConnectVoltageLevelOnLineNbTest() throws IOException {
        ...
        ReportNodeImpl reporter1 = new ReportNodeImpl("reportTestUndefinedLine", "Testing reporter with undefined line1 ID");
        ...
        ReportNodeImpl reporter2 = new ReportNodeImpl("reportTestUndefinedLine", "Testing reporter with undefined line2 ID");
        ...
        ReportNodeImpl reporter3 = new ReportNodeImpl("reportTestNoVLInCommon", "Testing reporter with lines having no voltage level in common");
        ...
        ReportNodeImpl reporter = new ReportNodeImpl("reportTestRevertConnectVoltageLevelOnLine", "Testing reporter to revert connecting a voltage level on a line in node/breaker network");
    ...
    void revertConnectVoltageLevelOnLineNbBbTest() throws IOException {
        ...
        ReportNodeImpl reporter = new ReportNodeImpl("reportTestRevertConnectVoltageLevelOnLineNbBb", "Testing reporter to revert connecting a voltage level on a line");
        modification = new RevertConnectVoltageLevelOnLineBuilder()
    ...
    void revertConnectVoltageLevelOnLineBbTest() throws IOException {
        ...
        ReportNodeImpl reporter = new ReportNodeImpl("reportTestRevertConnectVoltageLevelOnLineBb", "Testing reporter to revert connecting a voltage level on a line in bus/breaker network");
        modification = new RevertConnectVoltageLevelOnLineBuilder()
                .withLine1Id("NHV1_NHV2_1_1")
                .withLine2Id("NHV1_NHV2_1_2")
                .withLineId("NHV1_NHV2_1")
