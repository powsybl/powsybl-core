...
class RevertConnectVoltageLevelOnLineTest extends AbstractModificationTest {
    ...
    void revertConnectVoltageLevelOnLineNbTest() throws IOException {
        ...
        ReportNode reportNode1 = new ReportNodeRootBuilderImpl().withMessageTemplate("reportTestUndefinedLine", "Testing reportNode with undefined line1 ID").build();
        ...
        ReportNode reportNode2 = new ReportNodeRootBuilderImpl().withMessageTemplate("reportTestUndefinedLine", "Testing reportNode with undefined line2 ID").build();
        ...
        ReportNode reportNode3 = new ReportNodeRootBuilderImpl().withMessageTemplate("reportTestNoVLInCommon", "Testing reportNode with lines having no voltage level in common").build();
        ...
        ReportNode reportNode = new ReportNodeRootBuilderImpl().withMessageTemplate("reportTestRevertConnectVoltageLevelOnLine", "Testing reportNode to revert connecting a voltage level on a line in node/breaker network").build();
    ...
    void revertConnectVoltageLevelOnLineNbBbTest() throws IOException {
        ...
        ReportNode reportNode = new ReportNodeRootBuilderImpl().withMessageTemplate("reportTestRevertConnectVoltageLevelOnLineNbBb", "Testing reportNode to revert connecting a voltage level on a line").build();
        modification = new RevertConnectVoltageLevelOnLineBuilder()
    ...
    void revertConnectVoltageLevelOnLineBbTest() throws IOException {
        ...
        ReportNode reportNode = new ReportNodeRootBuilderImpl().withMessageTemplate("reportTestRevertConnectVoltageLevelOnLineBb", "Testing reportNode to revert connecting a voltage level on a line in bus/breaker network").build();
        modification = new RevertConnectVoltageLevelOnLineBuilder()
                .withLine1Id("NHV1_NHV2_1_1")
                .withLine2Id("NHV1_NHV2_1_2")
                .withLineId("NHV1_NHV2_1")
