...
class RemoveHvdcLineTest extends AbstractSerDeTest {
    ...
    void testRemoveHvdcLineUnknownShunt() {
        ...
        ReportNode reportNode = ReportNode.newRootReportNode()
                .withLocaleMessageTemplate("reportTestRemoveHvdcLineWithUnknownShunt", ReportBundleBaseName.BUNDLE_TEST_BASE_NAME)
                .build();
    ...
    void testRemoveHvdcLineUnknownLine() {
        ...
        ReportNode reportNode = ReportNode.newRootReportNode()
                .withLocaleMessageTemplate("reportTestRemoveHvdcLineUnknownLine", ReportBundleBaseName.BUNDLE_TEST_BASE_NAME)
                .build();
