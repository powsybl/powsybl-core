 ...
 */
public final class ConnectGeneratorWithStepUpTransformer extends AbstractNetworkModification {

    private final String generatorId;

    public ConnectGeneratorWithStepUpTransformer(String generatorId) {
        this.generatorId = generatorId;
    }

    @Override
    public String getName() {
        return "ConnectGeneratorWithStepUpTransformer";
    }
