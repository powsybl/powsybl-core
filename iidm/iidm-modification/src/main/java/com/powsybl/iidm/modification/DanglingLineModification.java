...
public class DanglingLineModification extends AbstractLoadModification {
     ...
     * @param areValuesRelative True if the dangling line P0 and/or Q0 variation is relative, False if absolute.
     ...
     */
    public DanglingLineModification(String danglingLineId, boolean areValuesRelative, Double p0, Double q0) {
        super(p0, q0, areValuesRelative);
    ...
    public void apply(Network network, NamingStrategy namingStrategy, boolean throwException, ComputationManager computationManager,
        ...
        if (danglingLine == null) {
            logOrThrow(throwException, "DanglingLine '" + danglingLineId + "' not found");
            return;
        }
