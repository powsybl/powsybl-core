...
public abstract class AbstractLoadModification extends AbstractNetworkModification {
    ...
    protected final boolean areValuesRelative;

    AbstractLoadModification(Double p0, Double q0, boolean areValuesRelative) {
        this.p0 = p0;
        this.q0 = q0;
        this.areValuesRelative = areValuesRelative;
    }

    public boolean isRelativeValue() {
        return areValuesRelative;
    }
