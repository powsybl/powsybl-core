...
public class ScalingParametersDeserializer extends StdDeserializer<ScalingParameters> {
    ...
    @Override
    public ScalingParameters deserialize(JsonParser parser, DeserializationContext context) throws JacksonException {
        return deserialize(parser, context, new ScalingParameters());
    }

    @Override
    public ScalingParameters deserialize(JsonParser parser, DeserializationContext context, ScalingParameters parameters) throws JacksonException {
        String version = null;
