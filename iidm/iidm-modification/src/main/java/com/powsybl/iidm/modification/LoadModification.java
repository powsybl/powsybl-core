...
public class LoadModification extends AbstractLoadModification {
     ...
     * @param areValuesRelative True if the load P0 and/or Q0 variation is relative, False if absolute.
     ...
     */
    public LoadModification(String loadId, boolean areValuesRelative, Double p0, Double q0) {
    ...
    public void apply(Network network, NamingStrategy namingStrategy, boolean throwException, ComputationManager computationManager,
        ...
        if (load == null) {
            logOrThrow(throwException, "Load '" + load + "' not found");
            return;
        }
