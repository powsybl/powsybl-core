...
public class ThreeWindingsTransformerAdapterTest {
    ...
    public void testSetterGetter() {
        ...
        assertNotNull(leg1);
        assertTrue(leg1 instanceof ThreeWindingsTransformerAdapter.LegAdapter);
        ...
        assertNotNull(leg2);
        assertTrue(leg2 instanceof ThreeWindingsTransformerAdapter.LegAdapter);
        // --> PhaseTapChanger
        ...
        assertNotNull(leg3);
        assertTrue(leg3 instanceof ThreeWindingsTransformerAdapter.LegAdapter);
