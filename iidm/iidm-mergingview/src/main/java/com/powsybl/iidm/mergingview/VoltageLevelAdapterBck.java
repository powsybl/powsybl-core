 ...
 */
class VoltageLevelAdapterBck extends AbstractIdentifiableAdapter<VoltageLevel> implements VoltageLevel {
    ...
    VoltageLevelAdapterBck(final VoltageLevel delegate, final MergingViewIndex index) {
        super(delegate, index);
