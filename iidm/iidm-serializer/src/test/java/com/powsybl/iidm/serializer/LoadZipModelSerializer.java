...
public class LoadZipModelSerializer extends AbstractExtensionSerializer<Load, LoadZipModel> {

    public LoadZipModelSerializer() {
    ...
    @Override
    public void write(LoadZipModel zipModel, WriterContext context) {
    ...
    @Override
    public LoadZipModel read(Load load, ReaderContext context) {
