...
public class LoadMockSerializer extends AbstractVersionableNetworkExtensionSerializer<Load, LoadMockExt> {

    public LoadMockSerializer() {
    ...
    @Override
    public void write(LoadMockExt extension, WriterContext context) {
        // do nothing
    }

    @Override
    public LoadMockExt read(Load extendable, ReaderContext context) {
