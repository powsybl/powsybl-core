...
public class TerminalMockSerializer extends AbstractVersionableNetworkExtensionSerializer<Load, TerminalMockExt> {

    public TerminalMockSerializer() {
    ...
    @Override
    public void write(TerminalMockExt extension, WriterContext context) {
    ...
    @Override
    public TerminalMockExt read(Load extendable, ReaderContext context) {
