 ...
 */
class EuropeanLvTestFeederFactoryXmlTest extends AbstractIidmSerializerTest {

    @Test
    void roundTripTest() throws IOException {
        roundTripXmlTest(EuropeanLvTestFeederFactory.create(),
            (n, xmlFile) -> NetworkSerializer.writeAndValidate(n, new ExportOptions().setSorted(true), xmlFile),
