...
public class ConnectablePositionSerializer<C extends Connectable<C>> extends AbstractVersionableNetworkExtensionSerializer<C, ConnectablePosition<C>> {

    private static final String V_1_0 = "1.0";
    private static final String V_1_1 = "1.1";

    public ConnectablePositionSerializer() {
    ...
    @Override
    public void write(ConnectablePosition<C> connectablePosition, WriterContext context) {
    ...
    private void readPosition(ReaderContext context, ConnectablePositionAdder.FeederAdder<C> adder) {
    ...
    @Override
    public ConnectablePosition<C> read(C connectable, ReaderContext context) {
