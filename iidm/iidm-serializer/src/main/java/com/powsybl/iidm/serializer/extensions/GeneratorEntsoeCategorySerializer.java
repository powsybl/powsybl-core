...
public class GeneratorEntsoeCategorySerializer extends AbstractExtensionSerializer<Generator, GeneratorEntsoeCategory> {

    public GeneratorEntsoeCategorySerializer() {
    ...
    @Override
    public void write(GeneratorEntsoeCategory entsoeCategory, WriterContext context) {
        context.getWriter().writeNodeContent(Integer.toString(entsoeCategory.getCode()));
    }

    @Override
    public GeneratorEntsoeCategory read(Generator generator, ReaderContext context) {
