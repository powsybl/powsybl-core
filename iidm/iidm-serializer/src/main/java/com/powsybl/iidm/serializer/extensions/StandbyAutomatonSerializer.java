...
public class StandbyAutomatonSerializer extends AbstractExtensionSerializer<StaticVarCompensator, StandbyAutomaton> {

    // TODO make this serializer versionable to fix lowVoltageSetpoint/highVoltageSetpoint
    public StandbyAutomatonSerializer() {
    ...
    @Override
    public void write(StandbyAutomaton standbyAutomaton, WriterContext context) {
    ...
    @Override
    public StandbyAutomaton read(StaticVarCompensator svc, ReaderContext context) {
