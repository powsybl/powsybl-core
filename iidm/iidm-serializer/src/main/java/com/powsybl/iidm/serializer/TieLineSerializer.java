 ...
 */
class TieLineSerializer extends AbstractSimpleIdentifiableSerializer<TieLine, TieLineAdder, Network> {

    private static final Logger LOGGER = LoggerFactory.getLogger(TieLineSerializer.class);

    static final TieLineSerializer INSTANCE = new TieLineSerializer();
    ...
    private static void writeDanglingLine(DanglingLine danglingLine, NetworkSerializerWriterContext context, int side) {
        ...
        IidmSerializerUtil.runUntilMaximumVersion(IidmVersion.V_1_4, context, () -> {
        ...
        IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_3, context, () -> context.getWriter().writeBooleanAttribute("fictitious_" + side, danglingLine.isFictitious(), false));
    }

    @Override
    protected void writeRootElementAttributes(TieLine tl, Network n, NetworkSerializerWriterContext context) {
        IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_10, context, () -> {
        ...
        IidmSerializerUtil.runUntilMaximumVersion(IidmVersion.V_1_9, context, () -> {
    ...
    @Override
    protected void writeSubElements(TieLine tl, Network n, NetworkSerializerWriterContext context) {
        IidmSerializerUtil.runUntilMaximumVersion(IidmVersion.V_1_9, context, () -> {
            ...
            if (activePowerLimits1.isPresent()) {
                ...
                IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> writeActivePowerLimits(1, activePowerLimits1.get(), context.getWriter(),
            ...
            if (apparentPowerLimits1.isPresent()) {
                ...
                IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> writeApparentPowerLimits(1, apparentPowerLimits1.get(), context.getWriter(), context.getVersion(), context.isValid(), context.getOptions()));
            }
            ...
            if (activePowerLimits2.isPresent()) {
                IidmSerializerUtil.assertMinimumVersion(ROOT_ELEMENT_NAME, ACTIVE_POWER_LIMITS_2, IidmSerializerUtil.ErrorMessage.NOT_NULL_NOT_SUPPORTED, IidmVersion.V_1_5, context);
                IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> writeActivePowerLimits(2, activePowerLimits2.get(), context.getWriter(),
                        context.getVersion(), context.isValid(), context.getOptions()));
            }
            ...
            if (apparentPowerLimits2.isPresent()) {
                IidmSerializerUtil.assertMinimumVersion(ROOT_ELEMENT_NAME, APPARENT_POWER_LIMITS_2, IidmSerializerUtil.ErrorMessage.NOT_NULL_NOT_SUPPORTED, IidmVersion.V_1_5, context);
                IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> writeApparentPowerLimits(2, apparentPowerLimits2.get(), context.getWriter(), context.getVersion(), context.isValid(), context.getOptions()));
            }
    ...
    private static DanglingLine readDanglingLine(DanglingLineAdder adder, String pairingKey, NetworkSerializerReaderContext context, int side) {
    ...
    @Override
    protected TieLine readRootElementAttributes(TieLineAdder adder, Network network, NetworkSerializerReaderContext context) {
        IidmSerializerUtil.runUntilMaximumVersion(IidmVersion.V_1_9, context, () -> {
    ...
    private static DanglingLineAdder readVlAndNodeOrBus(NetworkSerializerReaderContext context, Network network, int side) {
    ...
    @Override
    protected void readSubElements(TieLine tl, NetworkSerializerReaderContext context) {
        context.getReader().readChildNodes(elementName -> {
            switch (elementName) {
                case ACTIVE_POWER_LIMITS_1 -> {
                    ...
                    IidmSerializerUtil.assertMaximumVersion(ROOT_ELEMENT_NAME, ACTIVE_POWER_LIMITS_1, IidmSerializerUtil.ErrorMessage.NOT_SUPPORTED, IidmVersion.V_1_9, context);
                    IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> readActivePowerLimits(tl.getDanglingLine1().newActivePowerLimits(), context.getReader()));
                }
                case APPARENT_POWER_LIMITS_1 -> {
                    ...
                    IidmSerializerUtil.assertMaximumVersion(ROOT_ELEMENT_NAME, ACTIVE_POWER_LIMITS_1, IidmSerializerUtil.ErrorMessage.NOT_SUPPORTED, IidmVersion.V_1_9, context);
                    IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> readApparentPowerLimits(tl.getDanglingLine1().newApparentPowerLimits(), context.getReader()));
                }
                case "currentLimits1" -> {
                    IidmSerializerUtil.assertMaximumVersion(ROOT_ELEMENT_NAME, ACTIVE_POWER_LIMITS_1, IidmSerializerUtil.ErrorMessage.NOT_SUPPORTED, IidmVersion.V_1_9, context);
                ...
                case ACTIVE_POWER_LIMITS_2 -> {
                    ...
                    IidmSerializerUtil.assertMaximumVersion(ROOT_ELEMENT_NAME, ACTIVE_POWER_LIMITS_1, IidmSerializerUtil.ErrorMessage.NOT_SUPPORTED, IidmVersion.V_1_9, context);
                    IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> readActivePowerLimits(tl.getDanglingLine2().newActivePowerLimits(), context.getReader()));
                }
                case APPARENT_POWER_LIMITS_2 -> {
                    ...
                    IidmSerializerUtil.assertMaximumVersion(ROOT_ELEMENT_NAME, ACTIVE_POWER_LIMITS_1, IidmSerializerUtil.ErrorMessage.NOT_SUPPORTED, IidmVersion.V_1_9, context);
                    IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> readApparentPowerLimits(tl.getDanglingLine2().newApparentPowerLimits(), context.getReader()));
                }
                case "currentLimits2" -> {
                    IidmSerializerUtil.assertMaximumVersion(ROOT_ELEMENT_NAME, ACTIVE_POWER_LIMITS_1, IidmSerializerUtil.ErrorMessage.NOT_SUPPORTED, IidmVersion.V_1_9, context);
