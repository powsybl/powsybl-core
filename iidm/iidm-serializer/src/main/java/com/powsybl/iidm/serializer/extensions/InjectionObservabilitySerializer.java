...
public class InjectionObservabilitySerializer<T extends Injection<T>> extends AbstractExtensionSerializer<T, InjectionObservability<T>> {
    ...
    public InjectionObservabilitySerializer() {
    ...
    @Override
    public void write(InjectionObservability<T> injectionObservability, WriterContext context) {
    ...
    @Override
    public InjectionObservability<T> read(T identifiable, ReaderContext context) {
