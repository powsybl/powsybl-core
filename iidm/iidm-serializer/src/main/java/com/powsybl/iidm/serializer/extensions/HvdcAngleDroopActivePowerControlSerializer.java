...
public class HvdcAngleDroopActivePowerControlSerializer extends AbstractExtensionSerializer<HvdcLine, HvdcAngleDroopActivePowerControl> {

    public HvdcAngleDroopActivePowerControlSerializer() {
    ...
    @Override
    public void write(HvdcAngleDroopActivePowerControl extension, WriterContext context) {
    ...
    @Override
    public HvdcAngleDroopActivePowerControl read(HvdcLine hvdcLine, ReaderContext context) {
