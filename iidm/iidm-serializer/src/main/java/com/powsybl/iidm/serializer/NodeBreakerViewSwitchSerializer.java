 ...
 */
public class NodeBreakerViewSwitchSerializer extends AbstractSwitchSerializer<VoltageLevel.NodeBreakerView.SwitchAdder> {

    static final NodeBreakerViewSwitchSerializer INSTANCE = new NodeBreakerViewSwitchSerializer();
    ...
    @Override
    protected void writeRootElementAttributes(Switch s, VoltageLevel vl, NetworkSerializerWriterContext context) {
    ...
    @Override
    protected Switch readRootElementAttributes(VoltageLevel.NodeBreakerView.SwitchAdder adder, VoltageLevel voltageLevel, NetworkSerializerReaderContext context) {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(NodeBreakerViewSwitchSerializer.class);
}
