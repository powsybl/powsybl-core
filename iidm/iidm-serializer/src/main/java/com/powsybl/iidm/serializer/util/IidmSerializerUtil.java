 ...
 */
package com.powsybl.iidm.serializer.util;
...
import com.powsybl.iidm.serializer.*;
 ...
 */
public final class IidmSerializerUtil {

    private static final Logger LOGGER = LoggerFactory.getLogger(IidmSerializerUtil.class);
    ...
    private static void createExceptionOrLogError(String rootElementName, String elementName, ErrorMessage type, IidmVersion refVersion, String reason, NetworkSerializerWriterContext context) {
        createExceptionOrLogError(rootElementName + "." + elementName, type, refVersion, reason, context);
    }

    private static void createExceptionOrLogError(String elementName, ErrorMessage type, IidmVersion refVersion, String reason, NetworkSerializerWriterContext context) {
     ...
     */
    public static void assertMaximumVersion(String rootElementName, String elementName, ErrorMessage type, IidmVersion maxVersion, NetworkSerializerReaderContext context) {
     ...
     */
    public static void assertMaximumVersion(String rootElementName, String elementName, ErrorMessage type, IidmVersion maxVersion, NetworkSerializerWriterContext context) {
        if (context.getVersion().compareTo(maxVersion) > 0) {
     ...
     * If not, throw an exception with a given type of error message.
     */
    public static void assertMaximumVersion(String elementName, ErrorMessage type, IidmVersion maxVersion, NetworkSerializerReaderContext context) {
        if (context.getVersion().compareTo(maxVersion) > 0) {
     ...
     * depending of {@link ExportOptions.IidmVersionIncompatibilityBehavior} found in the {@link ExportOptions} of the given context.
     */
    public static void assertMaximumVersion(String elementName, ErrorMessage type, IidmVersion maxVersion, NetworkSerializerWriterContext context) {
        if (context.getVersion().compareTo(maxVersion) > 0) {
     ...
     * If not, throw an exception with a given type of error message.
     */
    public static void assertMinimumVersion(String rootElementName, String elementName, ErrorMessage type, IidmVersion minVersion, NetworkSerializerReaderContext context) {
     ...
     * depending of {@link ExportOptions.IidmVersionIncompatibilityBehavior} found in the {@link ExportOptions} of the given context.
     */
    public static void assertMinimumVersion(String rootElementName, String elementName, ErrorMessage type, IidmVersion minVersion, NetworkSerializerWriterContext context) {
        if (context.getVersion().compareTo(minVersion) < 0) {
     ...
     * If not, throw an exception with a given type of error message.
     */
    public static void assertMinimumVersion(String elementName, ErrorMessage type, IidmVersion minVersion, NetworkSerializerReaderContext context) {
        if (context.getVersion().compareTo(minVersion) < 0) {
     ...
     * depending of {@link ExportOptions.IidmVersionIncompatibilityBehavior} found in the {@link ExportOptions} of the given context.
     */
    public static void assertMinimumVersion(String elementName, ErrorMessage type, IidmVersion minVersion, NetworkSerializerWriterContext context) {
        if (context.getVersion().compareTo(minVersion) < 0) {
    ...
    public static void assertMinimumVersionIfNotDefault(boolean valueIsNotDefault, String rootElementName,
                                                        String elementName, ErrorMessage type, IidmVersion minVersion,
                                                        NetworkSerializerReaderContext context) {
        if (valueIsNotDefault) {
    ...
    public static void assertMinimumVersionIfNotDefault(boolean valueIsNotDefault, String rootElementName,
                                                        String elementName, ErrorMessage type, IidmVersion minVersion,
                                                        NetworkSerializerWriterContext context) {
        if (valueIsNotDefault) {
            assertMinimumVersion(rootElementName, elementName, type, minVersion, context);
        }
    }
    ...
    public static void assertMinimumVersionAndRunIfNotDefault(boolean valueIsNotDefault, String rootElementName,
                                                              String elementName, ErrorMessage type, IidmVersion minVersion,
                                                              NetworkSerializerReaderContext context, Runnable runnable) {
        if (valueIsNotDefault) {
            assertMinimumVersion(rootElementName, elementName, type, minVersion, context);
            runnable.run();
        }
    ...
    public static void assertMinimumVersionAndRunIfNotDefault(boolean valueIsNotDefault, String rootElementName,
                                                              String elementName, ErrorMessage type, IidmVersion minVersion,
                                                              NetworkSerializerWriterContext context, Runnable runnable) {
        if (valueIsNotDefault) {
            assertMinimumVersion(rootElementName, elementName, type, minVersion, context);
     ...
     * If not, throw an exception with a given type of error message.
     */
    public static void assertStrictMaximumVersion(String rootElementName, String elementName, ErrorMessage type, IidmVersion maxVersion, NetworkSerializerReaderContext context) {
        if (context.getVersion().compareTo(maxVersion) >= 0) {
     ...
     * depending of {@link ExportOptions.IidmVersionIncompatibilityBehavior} found in the {@link ExportOptions} of the given context.
     */
    public static void assertStrictMaximumVersion(String rootElementName, String elementName, ErrorMessage type, IidmVersion maxVersion, NetworkSerializerWriterContext context) {
        if (context.getVersion().compareTo(maxVersion) >= 0) {
     ...
     */
    public static <C extends AbstractNetworkSerializerContext> void runFromMinimumVersion(IidmVersion minVersion, C context, Runnable runnable) {
        if (context.getVersion().compareTo(minVersion) >= 0) {
            runnable.run();
        }
     ...
     */
    public static <C extends AbstractNetworkSerializerContext> void runUntilMaximumVersion(IidmVersion maxVersion, C context, Runnable runnable) {
        if (context.getVersion().compareTo(maxVersion) <= 0) {
            runnable.run();
        }
    }
    ...
    public static void writeBooleanAttributeFromMinimumVersion(String rootElementName, String attributeName, boolean value, boolean defaultValue,
                                                               ErrorMessage type, IidmVersion minVersion, NetworkSerializerWriterContext context) {
     ...
     */
    public static void writeIntAttributeUntilMaximumVersion(String attributeName, int value, IidmVersion maxVersion, NetworkSerializerWriterContext context) {
        if (context.getVersion().compareTo(maxVersion) <= 0) {
