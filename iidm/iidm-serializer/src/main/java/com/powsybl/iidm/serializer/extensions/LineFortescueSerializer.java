...
public class LineFortescueSerializer extends AbstractExtensionSerializer<Line, LineFortescue> {

    public LineFortescueSerializer() {
    ...
    @Override
    public void write(LineFortescue lineFortescue, WriterContext context) {
    ...
    @Override
    public LineFortescue read(Line line, ReaderContext context) {
