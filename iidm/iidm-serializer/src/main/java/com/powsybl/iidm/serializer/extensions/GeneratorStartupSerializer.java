...
public class GeneratorStartupSerializer extends AbstractVersionableNetworkExtensionSerializer<Generator, GeneratorStartup> {
    ...
    public GeneratorStartupSerializer() {
    ...
    @Override
    public void write(GeneratorStartup startup, WriterContext context) {
    ...
    @Override
    public GeneratorStartup read(Generator generator, ReaderContext context) {
