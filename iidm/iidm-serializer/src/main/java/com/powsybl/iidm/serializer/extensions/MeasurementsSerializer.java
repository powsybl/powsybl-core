...
public class MeasurementsSerializer<C extends Connectable<C>> extends AbstractExtensionSerializer<C, Measurements<C>> {
    ...
    @Override
    public void write(Measurements<C> extension, WriterContext context) {
    ...
    @Override
    public Measurements<C> read(C extendable, ReaderContext context) {
