...
public class HvdcOperatorActivePowerRangeSerializer extends AbstractExtensionSerializer<HvdcLine, HvdcOperatorActivePowerRange> {

    public HvdcOperatorActivePowerRangeSerializer() {
    ...
    @Override
    public void write(HvdcOperatorActivePowerRange opr, WriterContext context) {
    ...
    @Override
    public HvdcOperatorActivePowerRange read(HvdcLine hvdcLine, ReaderContext context) {
