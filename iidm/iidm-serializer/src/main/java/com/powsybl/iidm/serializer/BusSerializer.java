 ...
 */
class BusSerializer extends AbstractSimpleIdentifiableSerializer<Bus, BusAdder, VoltageLevel> {

    static final BusSerializer INSTANCE = new BusSerializer();
    ...
    @Override
    protected void writeRootElementAttributes(Bus b, VoltageLevel vl, NetworkSerializerWriterContext context) {
    ...
    @Override
    protected void writeSubElements(Bus b, VoltageLevel vl, NetworkSerializerWriterContext context) {
    ...
    @Override
    protected Bus readRootElementAttributes(BusAdder adder, VoltageLevel voltageLevel, NetworkSerializerReaderContext context) {
    ...
    @Override
    protected void readSubElements(Bus b, NetworkSerializerReaderContext context) {
