 ...
 */
public class LccConverterStationSerializer extends AbstractSimpleIdentifiableSerializer<LccConverterStation, LccConverterStationAdder, VoltageLevel> {

    static final LccConverterStationSerializer INSTANCE = new LccConverterStationSerializer();
    ...
    @Override
    protected void writeRootElementAttributes(LccConverterStation cs, VoltageLevel vl, NetworkSerializerWriterContext context) {
    ...
    @Override
    protected LccConverterStation readRootElementAttributes(LccConverterStationAdder adder, VoltageLevel voltageLevel, NetworkSerializerReaderContext context) {
    ...
    @Override
    protected void readSubElements(LccConverterStation cs, NetworkSerializerReaderContext context) {
