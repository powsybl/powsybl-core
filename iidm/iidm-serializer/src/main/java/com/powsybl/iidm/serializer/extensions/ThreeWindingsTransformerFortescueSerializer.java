...
public class ThreeWindingsTransformerFortescueSerializer extends AbstractExtensionSerializer<ThreeWindingsTransformer, ThreeWindingsTransformerFortescue> {

    public ThreeWindingsTransformerFortescueSerializer() {
    ...
    @Override
    public void write(ThreeWindingsTransformerFortescue twtFortescue, WriterContext context) {
    ...
    @Override
    public ThreeWindingsTransformerFortescue read(ThreeWindingsTransformer twt, ReaderContext context) {
