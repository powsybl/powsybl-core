...
public class SubstationPositionSerializer extends AbstractExtensionSerializer<Substation, SubstationPosition> {

    private static final String COORDINATE_ROOT_NODE = "coordinate";

    public SubstationPositionSerializer() {
    ...
    @Override
    public void write(SubstationPosition substationPosition, WriterContext context) {
    ...
    @Override
    public SubstationPosition read(Substation substation, ReaderContext context) {
