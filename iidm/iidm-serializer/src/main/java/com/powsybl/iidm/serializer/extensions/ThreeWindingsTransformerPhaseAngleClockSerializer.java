...
public class ThreeWindingsTransformerPhaseAngleClockSerializer
        extends AbstractExtensionSerializer<ThreeWindingsTransformer, ThreeWindingsTransformerPhaseAngleClock> {

    public ThreeWindingsTransformerPhaseAngleClockSerializer() {
    ...
    @Override
    public void write(ThreeWindingsTransformerPhaseAngleClock extension, WriterContext context) {
    ...
    @Override
    public ThreeWindingsTransformerPhaseAngleClock read(ThreeWindingsTransformer extendable, ReaderContext context) {
