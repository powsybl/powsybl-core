...
public class LoadAsymmetricalSerializer extends AbstractExtensionSerializer<Load, LoadAsymmetrical> {

    public LoadAsymmetricalSerializer() {
    ...
    @Override
    public void write(LoadAsymmetrical loadAsym, WriterContext context) {
    ...
    @Override
    public LoadAsymmetrical read(Load load, ReaderContext context) {
