 ...
 */
public class NodeBreakerViewInternalConnectionSerializer {

    static final NodeBreakerViewInternalConnectionSerializer INSTANCE = new NodeBreakerViewInternalConnectionSerializer();
    ...
    protected void write(int node1, int node2, NetworkSerializerWriterContext context) {
    ...
    protected void read(VoltageLevel vl, NetworkSerializerReaderContext context) {
