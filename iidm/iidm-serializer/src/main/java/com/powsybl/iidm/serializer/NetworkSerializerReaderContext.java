...
public class NetworkSerializerReaderContext extends AbstractNetworkSerializerContext<ImportOptions> implements ReaderContext {
    ...
    public NetworkSerializerReaderContext(Anonymizer anonymizer, TreeDataReader reader) {
        this(anonymizer, reader, new ImportOptions(), CURRENT_IIDM_XML_VERSION, Collections.emptyMap());
    }

    public NetworkSerializerReaderContext(Anonymizer anonymizer, TreeDataReader reader, ImportOptions options, IidmVersion version,
