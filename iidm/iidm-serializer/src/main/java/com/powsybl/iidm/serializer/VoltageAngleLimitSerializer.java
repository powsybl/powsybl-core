 ...
 */
public final class VoltageAngleLimitSerializer {
    ...
    public static void write(VoltageAngleLimit voltageAngleLimit, NetworkSerializerWriterContext context) {
        IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_11, context, () -> {
            ...
            TerminalRefSerializer.writeTerminalRef(voltageAngleLimit.getTerminalFrom(), context, FROM);
            TerminalRefSerializer.writeTerminalRef(voltageAngleLimit.getTerminalTo(), context, TO);
            context.getWriter().writeEndNode();
        });
    }

    public static void read(Network network, NetworkSerializerReaderContext context) {
        IidmSerializerUtil.runFromMinimumVersion(IidmVersion.V_1_11, context, () -> {
            ...
            context.getReader().readChildNodes(elementName -> {
                Terminal terminal = TerminalRefSerializer.readTerminal(context, network);
                switch (elementName) {
    ...
    private VoltageAngleLimitSerializer() {
    }
}
