...
public class ActivePowerControlSerializer<T extends Injection<T>> extends AbstractVersionableNetworkExtensionSerializer<T, ActivePowerControl<T>> {

    public ActivePowerControlSerializer() {
    ...
    @Override
    public void write(ActivePowerControl<T> activePowerControl, WriterContext context) {
    ...
    @Override
    public ActivePowerControl<T> read(T identifiable, ReaderContext context) {
