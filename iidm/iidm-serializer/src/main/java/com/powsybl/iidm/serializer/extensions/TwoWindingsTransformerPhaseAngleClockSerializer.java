...
public class TwoWindingsTransformerPhaseAngleClockSerializer
        extends AbstractExtensionSerializer<TwoWindingsTransformer, TwoWindingsTransformerPhaseAngleClock> {

    public TwoWindingsTransformerPhaseAngleClockSerializer() {
    ...
    @Override
    public void write(TwoWindingsTransformerPhaseAngleClock extension, WriterContext context) {
        context.getWriter().writeIntAttribute("phaseAngleClock", extension.getPhaseAngleClock(), 0);
    }

    @Override
    public TwoWindingsTransformerPhaseAngleClock read(TwoWindingsTransformer extendable, ReaderContext context) {
