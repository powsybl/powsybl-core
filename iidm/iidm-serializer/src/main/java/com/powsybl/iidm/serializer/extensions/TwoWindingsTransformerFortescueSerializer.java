...
public class TwoWindingsTransformerFortescueSerializer extends AbstractExtensionSerializer<TwoWindingsTransformer, TwoWindingsTransformerFortescue> {

    public TwoWindingsTransformerFortescueSerializer() {
    ...
    @Override
    public void write(TwoWindingsTransformerFortescue twtFortescue, WriterContext context) {
    ...
    @Override
    public TwoWindingsTransformerFortescue read(TwoWindingsTransformer twt, ReaderContext context) {
