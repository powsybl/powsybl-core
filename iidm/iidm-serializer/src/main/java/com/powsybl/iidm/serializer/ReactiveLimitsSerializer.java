 ...
 */
public class ReactiveLimitsSerializer {

    static final ReactiveLimitsSerializer INSTANCE = new ReactiveLimitsSerializer();
    ...
    public void write(ReactiveLimitsHolder holder, NetworkSerializerWriterContext context) {
    ...
    public void readReactiveCapabilityCurve(ReactiveLimitsHolder holder, NetworkSerializerReaderContext context) {
    ...
    public void readMinMaxReactiveLimits(ReactiveLimitsHolder holder, NetworkSerializerReaderContext context) {
