...
import static com.powsybl.iidm.serializer.ExportOptions.IidmVersionIncompatibilityBehavior.THROW_EXCEPTION;
...
public class ExportOptions extends AbstractOptions<ExportOptions> {
    ...
    public IidmVersion getVersion() {
        return version != null ? IidmVersion.of(version, ".") : IidmSerializerConstants.CURRENT_IIDM_XML_VERSION;
    }
