...
public class LoadDetailSerializer extends AbstractExtensionSerializer<Load, LoadDetail> {

    public LoadDetailSerializer() {
    ...
    @Override
    public void write(LoadDetail detail, WriterContext context) {
    ...
    @Override
    public LoadDetail read(Load load, ReaderContext context) {
