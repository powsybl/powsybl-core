...
public class BranchObservabilitySerializer<T extends Branch<T>> extends AbstractExtensionSerializer<T, BranchObservability<T>> {
    ...
    public BranchObservabilitySerializer() {
    ...
    @Override
    public void write(BranchObservability<T> branchObservability, WriterContext context) {
    ...
    private void writeOptionalQuality(WriterContext context, ObservabilityQuality<T> quality, String type, TwoSides side) {
        if (quality == null) {
            return;
        }
    ...
    @Override
    public BranchObservability<T> read(T identifiable, ReaderContext context) {
