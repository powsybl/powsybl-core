 ...
 */
class BusbarSectionSerializer extends AbstractSimpleIdentifiableSerializer<BusbarSection, BusbarSectionAdder, VoltageLevel> {

    static final BusbarSectionSerializer INSTANCE = new BusbarSectionSerializer();
    ...
    @Override
    protected void writeRootElementAttributes(BusbarSection bs, VoltageLevel vl, NetworkSerializerWriterContext context) {
        context.getWriter().writeIntAttribute("node", bs.getTerminal().getNodeBreakerView().getNode());
        IidmSerializerUtil.runUntilMaximumVersion(IidmVersion.V_1_0, context, () -> {
    ...
    @Override
    protected BusbarSection readRootElementAttributes(BusbarSectionAdder adder, VoltageLevel voltageLevel, NetworkSerializerReaderContext context) {
    ...
    @Override
    protected void readSubElements(BusbarSection bs, NetworkSerializerReaderContext context) {
