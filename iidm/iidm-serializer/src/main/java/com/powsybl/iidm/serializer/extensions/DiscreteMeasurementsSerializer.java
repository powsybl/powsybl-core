...
public class DiscreteMeasurementsSerializer<I extends Identifiable<I>> extends AbstractExtensionSerializer<I, DiscreteMeasurements<I>> {
    ...
    public DiscreteMeasurementsSerializer() {
    ...
    @Override
    public void write(DiscreteMeasurements<I> extension, WriterContext context) {
    ...
    @Override
    public DiscreteMeasurements<I> read(I extendable, ReaderContext context) {
