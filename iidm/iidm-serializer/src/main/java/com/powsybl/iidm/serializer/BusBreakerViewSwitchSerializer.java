 ...
 */
public class BusBreakerViewSwitchSerializer extends AbstractSwitchSerializer<VoltageLevel.BusBreakerView.SwitchAdder> {

    static final BusBreakerViewSwitchSerializer INSTANCE = new BusBreakerViewSwitchSerializer();
    ...
    @Override
    protected Switch readRootElementAttributes(VoltageLevel.BusBreakerView.SwitchAdder adder, VoltageLevel voltageLevel, NetworkSerializerReaderContext context) {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(BusBreakerViewSwitchSerializer.class);
}
