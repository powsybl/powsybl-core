...
public class SecondaryVoltageControlSerializer extends AbstractExtensionSerializer<Network, SecondaryVoltageControl> {
    ...
    public SecondaryVoltageControlSerializer() {
    ...
    @Override
    public void write(SecondaryVoltageControl control, WriterContext context) {
    ...
    @Override
    public SecondaryVoltageControl read(Network network, ReaderContext context) {
    ...
    private static void readControlZone(ReaderContext context, SecondaryVoltageControlAdder adder) {
    ...
    private static void readPilotPoint(ReaderContext context, MutableDouble targetV, List<String> busbarSectionsOrBusesIds) {
    ...
    private static void readControlUnit(ReaderContext context, List<ControlUnit> controlUnits) {
