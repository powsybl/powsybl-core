 ...
 */
public abstract class AbstractVersionableNetworkExtensionSerializer<T extends Extendable, E extends Extension<T>> implements ExtensionSerializer<T, E> {
    ...
    protected AbstractVersionableNetworkExtensionSerializer(String extensionName, Class<? super E> extensionClass, String namespacePrefix,
