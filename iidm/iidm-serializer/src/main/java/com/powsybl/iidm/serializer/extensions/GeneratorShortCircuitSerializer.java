...
public class GeneratorShortCircuitSerializer extends AbstractExtensionSerializer<Generator, GeneratorShortCircuit> {

    public GeneratorShortCircuitSerializer() {
    ...
    @Override
    public void write(GeneratorShortCircuit generatorShortCircuit, WriterContext context) {
    ...
    @Override
    public GeneratorShortCircuit read(Generator generator, ReaderContext context) {
