...
public class ThreeWindingsTransformerToBeEstimatedSerializer extends AbstractExtensionSerializer<ThreeWindingsTransformer, ThreeWindingsTransformerToBeEstimated> {

    public ThreeWindingsTransformerToBeEstimatedSerializer() {
    ...
    @Override
    public void write(ThreeWindingsTransformerToBeEstimated extension, WriterContext context) {
    ...
    @Override
    public ThreeWindingsTransformerToBeEstimated read(ThreeWindingsTransformer extendable, ReaderContext context) {
