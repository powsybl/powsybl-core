...
public class LinePositionSerializer<T extends Identifiable<T>> extends AbstractExtensionSerializer<T, LinePosition<T>> {

    private static final String COORDINATE_ROOT_NODE = "coordinate";
    private static final String COORDINATE_ARRAY_NODE = "coordinates";

    public LinePositionSerializer() {
    ...
    @Override
    public void write(LinePosition<T> linePosition, WriterContext context) {
    ...
    @Override
    public LinePosition<T> read(T line, ReaderContext context) {
