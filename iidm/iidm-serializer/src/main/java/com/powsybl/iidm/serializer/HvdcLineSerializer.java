 ...
 */
class HvdcLineSerializer extends AbstractSimpleIdentifiableSerializer<HvdcLine, HvdcLineAdder, Network> {

    static final HvdcLineSerializer INSTANCE = new HvdcLineSerializer();
    ...
    @Override
    protected void writeRootElementAttributes(HvdcLine l, Network parent, NetworkSerializerWriterContext context) {
    ...
    @Override
    protected HvdcLine readRootElementAttributes(HvdcLineAdder adder, Network network, NetworkSerializerReaderContext context) {
    ...
    @Override
    protected void readSubElements(HvdcLine l, NetworkSerializerReaderContext context) {
