 ...
 */
public class ReducerNamingStrategyTest {

    @Test
    public void checkWithDefaultReducerNamingStrategy() {
        ...
        NetworkReducer reducer = NetworkReducer.builder().withDanglingLines(true).withNetworkPredicate(predicate).build();
    ...
    @Test
    public void checkWithCustomReducerNamingStrategy() {
        Network network = FourCountriesNetworkFactory.create();
        emulateLoadflow(network);
        NetworkPredicate predicate = CountriesNetworkPredicate.of(Country.FR, Country.DE);
        ReducerNamingStrategy reducerNamingStrategy = branch -> branch.getId().equals("FR-BE") ? "France Belgium interconnection" : branch.getId();
        ...
        assertNotNull(network.getDanglingLine("DE-NL"));
        assertNotNull(network.getDanglingLine("FR-BE"));
        assertNotNull(network.getDanglingLine("France Belgium interconnection"));
        assertEquals(network.getDanglingLine("FR-BE"), network.getDanglingLine("France Belgium interconnection"));
        assertEquals("France Belgium interconnection", network.getDanglingLine("FR-BE").getId());
    }
