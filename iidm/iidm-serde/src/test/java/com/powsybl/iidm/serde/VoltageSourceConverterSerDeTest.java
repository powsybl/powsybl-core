...
class VoltageSourceConverterSerDeTest extends AbstractIidmSerDeTest {
    ...
    void testNetworkVoltageSourceConverter() throws IOException {
        ...
        allFormatsRoundTripTxtTest(network, "/voltageSourceConverterRoundTripRef.xml", CURRENT_IIDM_VERSION);
    ...
    void testNotSupported() throws IOException {
        ...
        testWriteVersionedTxt(network, options, "voltageSourceConverterNotSupported.xml", IidmVersion.V_1_14);
    }
