...
class StaticVarCompensatorXmlTest extends AbstractIidmSerDeTest {
    ...
    void noRegulatioModeTest() throws IOException {
        ...
        allFormatsRoundTripFromVersionedXmlFromMinToMaxVersionTest("staticVarCompensatorNoRegulationMode.xml", "staticVarCompensatorRegulationModeOFF.xml", IidmVersion.V_1_7, IidmVersion.V_1_13);
