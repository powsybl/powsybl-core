...
public class TerminalMockSerDe extends AbstractVersionableNetworkExtensionSerDe<Load, TerminalMockExt, TerminalMockSerDe.Version> {
    ...
    public enum Version implements SerDeVersion<Version> {
        ...
        V_1_13("http://www.powsybl.org/schema/iidm/ext/terminal_mock/1_13",
                new VersionNumbers(1, 13), IidmVersion.V_1_13, IidmVersion.V_1_14),
        V_1_14("http://www.powsybl.org/schema/iidm/ext/terminal_mock/1_14",
                new VersionNumbers(1, 14), IidmVersion.V_1_14, IidmVersion.V_1_15),
        ...
        V_1_17("http://www.powsybl.org/schema/iidm/ext/terminal_mock/1_17",
                new VersionNumbers(1, 17), IidmVersion.V_1_17, IidmVersion.V_1_18),
        V_1_18("http://www.powsybl.org/schema/iidm/ext/terminal_mock/1_18",
            new VersionNumbers(1, 18), IidmVersion.V_1_18, null);
