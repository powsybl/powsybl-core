        ...
        context.getReader().readChildNodes(elementName -> {
            switch (elementName) {
                case ACTIVE_POWER_LIMITS_1 -> {
                    ...
                    IidmSerDeUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> readActivePowerLimits(l.newActivePowerLimits1(), context.getReader(), context.getVersion()));
                }
                case APPARENT_POWER_LIMITS_1 -> {
                    ...
                    IidmSerDeUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> readApparentPowerLimits(l.newApparentPowerLimits1(), context.getReader(), context.getVersion()));
                }
                case "currentLimits1" -> readCurrentLimits(l.newCurrentLimits1(), context.getReader(), context.getVersion());
                case ACTIVE_POWER_LIMITS_2 -> {
                    ...
                    IidmSerDeUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> readActivePowerLimits(l.newActivePowerLimits2(), context.getReader(), context.getVersion()));
                }
                case APPARENT_POWER_LIMITS_2 -> {
                    ...
                    IidmSerDeUtil.runFromMinimumVersion(IidmVersion.V_1_5, context, () -> readApparentPowerLimits(l.newApparentPowerLimits2(), context.getReader(), context.getVersion()));
                }
                case "currentLimits2" -> readCurrentLimits(l.newCurrentLimits2(), context.getReader(), context.getVersion());
