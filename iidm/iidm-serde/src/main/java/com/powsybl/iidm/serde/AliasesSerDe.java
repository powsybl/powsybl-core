...
public final class AliasesSerDe {
    ...
    public static void write(Identifiable<?> identifiable, String rootElementName, NetworkSerializerContext context) {
        IidmSerDeUtil.assertMinimumVersionIfNotDefault(!identifiable.getAliases().isEmpty(), rootElementName, ROOT_ELEMENT_NAME,
            IidmSerDeUtil.ErrorMessage.NOT_DEFAULT_NOT_SUPPORTED, IidmVersion.V_1_3, context);
