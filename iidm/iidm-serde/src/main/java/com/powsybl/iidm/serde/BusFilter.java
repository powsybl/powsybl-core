...
public class BusFilter {
    ...
    static void addBusOfOtherSideOfOpenBranches(Set<String> buses, Network n, ExportOptions options) {
        ...
        n.getBranchStream().forEach(branch -> addBusOfOtherSideOfOpenBranch(branch, buses, options));
    }

    private static void addBusOfOtherSideOfOpenBranch(Branch<?> branch, Set<String> buses, ExportOptions options) {
