...
public class ReactiveLimitsSerDe {
    ...
    private static void writeMinMaxReactiveLimits(ReactiveLimitsHolder holder, NetworkSerializerContext context) {
        ...
        IidmSerDeUtil.runFromMinimumVersion(IidmVersion.V_1_17, context, () -> PropertiesSerDe.write(limits, context));
    ...
    private static void writeReactiveCapabilityCurve(ReactiveLimitsHolder holder, NetworkSerializerContext context) {
        ...
        IidmSerDeUtil.runFromMinimumVersion(IidmVersion.V_1_17, context, () -> PropertiesSerDe.write(curve, context));
        for (ReactiveCapabilityCurve.Point point : curve.getPoints()) {
            ...
            IidmSerDeUtil.runFromMinimumVersion(IidmVersion.V_1_17, context, () -> PropertiesSerDe.write(point, context));
            context.getWriter().writeEndNode();
        }
    ...
    private static void writeReactiveCapabilityShape(ReactiveLimitsHolder holder, NetworkSerializerContext context) {
        ...
        context.getWriter().writeStartNodes();
        IidmSerDeUtil.runFromMinimumVersion(IidmVersion.V_1_17, context, () -> PropertiesSerDe.write(shape, context));
    ...
    public void readReactiveCapabilityShape(ReactiveLimitsHolder holder, NetworkDeserializerContext context) {
        ...
        context.getReader().readChildNodes(elementName -> {
            if (elementName.equals(PropertiesSerDe.ROOT_ELEMENT_NAME)) {
                PropertiesSerDe.read(shapeAdder, context);
            } else if (elementName.equals(PLANE_ROOT_ELEMENT_NAME)) {
    ...
    public void readMinMaxReactiveLimits(ReactiveLimitsHolder holder, NetworkDeserializerContext context) {
        ...
        MinMaxReactiveLimitsAdder limitsAdder = holder.newMinMaxReactiveLimits()
                .setMinQ(min)
                .setMaxQ(max);
        PropertiesSerDe.readProperties(context, limitsAdder);
        limitsAdder.add();
    }
}
