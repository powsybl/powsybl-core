    ...
    public ActivePowerControlSerDe() {
        super("activePowerControl", ActivePowerControl.class, "apc",
                new ImmutableMap.Builder<IidmVersion, List<String>>()
                        .put(IidmVersion.V_1_0, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_1, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_2, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_3, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_4, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_5, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_6, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_7, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_8, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_9, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_10, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_11, List.of("1.0", "1.1"))
                        .put(IidmVersion.V_1_12, List.of("1.0", "1.1"))
                        .build(),
