        ...
        context.getReader().readChildNodes(elementName -> {
            switch (elementName) {
                ...
                case ReactiveLimitsSerDe.ELEM_REACTIVE_CAPABILITY_SHAPE -> {
                    IidmSerDeUtil.assertMinimumVersion(getRootElementName() + GENERATION_CONSTANT, REACTIVE_LIMITS, IidmSerDeUtil.ErrorMessage.NOT_SUPPORTED, IidmVersion.V_1_17, context);
