...
public class XMLImporterLimitsTest extends AbstractXmlConverterTest {
    ...
    private void importExport(Network network) throws IOException {
        ...
        exportProperties.put(MultiXMLExporter.EXTENSIONS_LIST, Collections.emptyList());
    ...
    public void test() throws IOException {
        ...
        testForAllPreviousVersions(CURRENT_IIDM_XML_VERSION, v -> NetworkXml.read(getVersionedNetworkAsStream("multiple-extensions.xml", v)));
    }
}
