...
public abstract class AbstractNetworkTest {
    ...
    public void testStreams() {
        ...
        assertEquals(Collections.emptyList(), mapper.apply(network.getDanglingLineStream(BoundaryLineFilter.ALL)));
        assertEquals(Collections.emptyList(), mapper.apply(network.getVoltageLevel(VLHV1).getDanglingLineStream(BoundaryLineFilter.ALL)));
        assertEquals(network.getDanglingLineCount(), network.getDanglingLineStream(BoundaryLineFilter.ALL).count());
