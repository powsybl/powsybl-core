...
public abstract class AbstractConnectableTest {
    ...
    public void nominallyConnectedTest() {
        ...
        assertEquals("alreadyDisconnectedTerminal", reportNode.getChildren().iterator().next().getMessageKey());
    ...
    public void partiallyConnectedTest() {
        ...
        network.getReportNodeContext().popReportNode();
        assertEquals("alreadyConnectedTerminal", reportNode.getChildren().iterator().next().getMessageKey());
