...
public class BoundaryLineCriterion extends AbstractNetworkElementEquipmentCriterion {
    ...
    public BoundaryLineCriterion(SingleCountryCriterion singleCountryCriterion, SingleNominalVoltageCriterion singleNominalVoltageCriterion) {
        this(null, singleCountryCriterion, singleNominalVoltageCriterion);
    }

    public BoundaryLineCriterion(String name, SingleCountryCriterion singleCountryCriterion, SingleNominalVoltageCriterion singleNominalVoltageCriterion) {
        super(name);
