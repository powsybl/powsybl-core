...
public abstract class AbstractConnectableXml<T extends Connectable, A extends IdentifiableAdder<A>, P extends Container> extends AbstractIdentifiableXml<T, A, P> {
    ...
    public static final String ACTIVE_POWER_LIMITS = "activePowerLimits";
    public static final String APPARENT_POWER_LIMITS = "apparentPowerLimits";
    public static final String CURRENT_LIMITS = "currentLimits";
    ...
    public static void writeActivePowerLimits(Integer index, ActivePowerLimits limits, XMLStreamWriter writer, String nsUri, IidmXmlVersion version,
                                       ExportOptions exportOptions) throws XMLStreamException {
        writeLoadingLimits(index, limits, writer, nsUri, version, exportOptions, ACTIVE_POWER_LIMITS);
    }
    ...
    public static void writeApparentPowerLimits(Integer index, ApparentPowerLimits limits, XMLStreamWriter writer, String nsUri, IidmXmlVersion version,
                                         ExportOptions exportOptions) throws XMLStreamException {
        writeLoadingLimits(index, limits, writer, nsUri, version, exportOptions, APPARENT_POWER_LIMITS);
    }
