...
class LineXml extends AbstractConnectableXml<Line, LineAdder, Network> {
    ...
    protected void writeSubElements(Line l, Network n, NetworkXmlWriterContext context) throws XMLStreamException {
        Optional<ActivePowerLimits> activePowerLimits1 = l.getActiveActivePowerLimits1();
        ...
        Optional<ApparentPowerLimits> apparentPowerLimits1 = l.getActiveApparentPowerLimits1();
        ...
        Optional<CurrentLimits> currentLimits1 = l.getActiveCurrentLimits1();
        ...
        Optional<ActivePowerLimits> activePowerLimits2 = l.getActiveActivePowerLimits2();
        ...
        Optional<ApparentPowerLimits> apparentPowerLimits2 = l.getActiveApparentPowerLimits2();
        ...
        Optional<CurrentLimits> currentLimits2 = l.getActiveCurrentLimits2();
