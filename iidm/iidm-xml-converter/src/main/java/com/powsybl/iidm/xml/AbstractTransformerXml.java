 ...
 */
abstract class AbstractTransformerXml<T extends Connectable, A extends IdentifiableAdder<T, A>> extends AbstractConnectableXml<T, A, Container<? extends Identifiable<?>>> {
