 ...
 */
abstract class AbstractTransformerXml<T extends Connectable<? super T>, A extends IdentifiableAdder<T, A>> extends AbstractConnectableXml<T, A, Container<? extends Identifiable<?>>> {
