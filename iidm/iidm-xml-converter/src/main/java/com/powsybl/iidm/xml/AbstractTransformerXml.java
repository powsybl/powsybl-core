 ...
 */
abstract class AbstractTransformerXml<T extends Connectable, A extends IdentifiableAdder<A, T>> extends AbstractConnectableXml<T, A, Container<? extends Identifiable<?>>> {
