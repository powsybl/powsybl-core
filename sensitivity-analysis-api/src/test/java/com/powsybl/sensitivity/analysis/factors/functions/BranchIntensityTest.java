 ...
 */
package com.powsybl.sensitivity.analysis.factors.functions;
...
public class BranchIntensityTest {
    ...
    public void getName() {
        ...
        Assert.assertEquals(FUNCTION_NAME, branchIntensity.getName());
    }

    @Test
    public void getId() {
        BranchIntensity branchIntensity = new BranchIntensity(FUNCTION_ID, FUNCTION_NAME, BRANCH_ID);
        Assert.assertEquals(FUNCTION_ID, branchIntensity.getId());
    }
