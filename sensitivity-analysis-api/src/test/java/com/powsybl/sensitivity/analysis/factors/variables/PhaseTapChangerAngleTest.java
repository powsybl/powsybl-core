 ...
 */
package com.powsybl.sensitivity.analysis.factors.variables;
...
public class PhaseTapChangerAngleTest {
    ...
    public void getName() {
        ...
        Assert.assertEquals(VARIABLE_NAME, phaseTapChangerAngle.getName());
    }

    @Test
    public void getId() {
        PhaseTapChangerAngle phaseTapChangerAngle = new PhaseTapChangerAngle(VARIABLE_ID, VARIABLE_NAME, PHASE_TAP_CHANGER_HOLDER_ID);
        Assert.assertEquals(VARIABLE_ID, phaseTapChangerAngle.getId());
    }
