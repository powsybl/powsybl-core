 ...
 * Description :
 *
 * This class "Line.java" represents the
...
public class Line extends EquipmentContainer {
    ...
    */
     ...
     *
     * @param id
     *            id of the class Line to create
     * @return the class created
     */
    public static Line create(final String id) {
     ...
     *            the instance to copy
     */
    public void copyBase(final Line otherLine) {
     ...
     */
    private Line(final Line otherLine) {
        // TODO : check exception safe
        this.copyBase(otherLine);
    }
    ...
    */
     ...
     */
    public Line clone() {
        Line newInstance = new Line(this);
        Line newInstanceSP = newInstance;
