 ...
 * Description :
 *
 * This class "OperationalLimitSet.java" represents the
 * class OperationalLimitSet extends IdentifiedObject
 *    + OperationalLimitValue   0..-1   OperationalLimit   (inverseAssociation) 
 *    + Terminal   1..1   Terminal 

 */
public class OperationalLimitSet extends IdentifiedObject {

    private static Logger LOGGER = LoggerFactory.getLogger(OperationalLimitSet.class);

    /**
     * Attribute "operationalLimitValue"
     *
     * Comment from profile:
     * Values of equipment limits.
     */
    public List<OperationalLimit> operationalLimitValue;
  ...
  /**
   * Utility to return the "operationalLimitValue" List of 
   * "OperationalLimit" enum
   *
   * @return the list of the attributes "operationalLimitValue"
   */
    public List<OperationalLimit > getOperationalLimitValue() {
        return this.operationalLimitValue;
    }

    /**
     * Utility to add a value within the "operationalLimitValue" ArrayList of 
     * "OperationalLimit"
     *
     * @param operationalLimitValueValue 
     *            value to add within the ArrayList
     * @param setInverse
     *            boolean to specify whether to set the inverse association or not
     * @throws LinkageException
     */
    public void addOperationalLimitValue(
            OperationalLimit operationalLimitValueValue, 
            boolean setInverse) throws LinkageException {
        
        if (operationalLimitValue == null) {
            operationalLimitValue = new ArrayList<OperationalLimit>();
        }
        
        this.operationalLimitValue.add(operationalLimitValueValue);
        this.currentBitset.set(0);
       
        if (setInverse) {
            
            if (operationalLimitValueValue != null) {
                operationalLimitValueValue.setOperationalLimitSet(this, false);
            }
        }
    }

    /**
     * Utility to test if the value of "operationalLimitValue" has been set
     *
     * @return boolean
     *            if true the attribute "operationalLimitValue" is already set
     *            if false it isn't yet
     */
    public boolean operationalLimitValueIsSet() {
    ...
    public void setTerminal(
        ...
        if (setInverse) {
            ...
            if (terminalValue != null) {
                terminalValue.addOperationalLimitSet(this, false);
            }
        }
    }
     ...
     *
     * @param id
     *            id of the class OperationalLimitSet to create
     * @return the class created
     */
    public static OperationalLimitSet create(final String id) {
        OperationalLimitSet newOperationalLimitSet = new OperationalLimitSet();
        newOperationalLimitSet.setId(id);
        return newOperationalLimitSet;
    }
    ...
    public void readAttribute(final String class_name, final String attr_name,
        ...
        if (class_name.equals("OperationalLimitSet")) {
    ...
    public void write(XMLStreamWriter xmlsw, boolean writeID) {
        ...
        if (writeID) {
            ...
            try {
                xmlsw.writeStartElement(CIMURI.CIMURI, "OperationalLimitSet");
        ...
        if (idTerminal != null) {
            ...
            if (attributeToSet != null) {
                ...
                if(attributeToSetFromBoundary != null) {
                    ...
                    errorMessage.append("\" in \"OperationalLimitSet\" of id \"");
     ...
     *
     * @param otherOperationalLimitSet
     *            the instance to copy
     */
    public void copyBase(final OperationalLimitSet otherOperationalLimitSet) {
        ...
        if (otherOperationalLimitSet.currentBitset.get(1)) {
            Terminal terminalAssociation = otherOperationalLimitSet.getTerminal();
    ...
    private void writeClass(XMLStreamWriter xmlsw) {
      ...
      for (OperationalLimit operationalLimitValue : this.operationalLimitValue){
               try {
                 xmlsw.writeEmptyElement(CIMURI.CIMURI,"OperationalLimitSet.OperationalLimitValue");
                 xmlsw.writeAttribute(CIMModel.rdfURI, "resource", "#"
                           + operationalLimitValue.getId());
               } catch (XMLStreamException e) {
                 StringBuilder errorMessage = new StringBuilder(
     ...
     */
    private OperationalLimitSet(final OperationalLimitSet otherOperationalLimitSet) {
        // TODO : check exception safe
        this.copyBase(otherOperationalLimitSet);
    }

   /**
    * Constructor of the class OperationalLimitSet
    */
     ...
     */
    public OperationalLimitSet clone() {
        OperationalLimitSet newInstance = new OperationalLimitSet(this);
        OperationalLimitSet newInstanceSP = newInstance;
