 ...
 * Description :
 *
 * This class "GeographicalRegion.java" represents the
 * class GeographicalRegion extends IdentifiedObject
 *    + Regions   0..-1   SubGeographicalRegion   (inverseAssociation) 

 */
public class GeographicalRegion extends IdentifiedObject {

    private static Logger LOGGER = LoggerFactory.getLogger(GeographicalRegion.class);
     ...
     */
    public List<SubGeographicalRegion> regions;
  ...
  /**
   * Utility to return the "regions" List of 
   * "SubGeographicalRegion" enum
   *
   * @return the list of the attributes "regions"
   */
    ...
    /**
     * Utility to add a value within the "regions" ArrayList of 
    ...
    public void addRegions(
            SubGeographicalRegion regionsValue, 
            boolean setInverse) throws LinkageException {
        
        if (regions == null) {
            regions = new ArrayList<SubGeographicalRegion>();
        }
        
        this.regions.add(regionsValue);
        this.currentBitset.set(0);
       
        if (setInverse) {
            
            if (regionsValue != null) {
                regionsValue.setRegion(this, false);
            }
        }
    }

    /**
     * Utility to test if the value of "regions" has been set
     *
     * @return boolean
     *            if true the attribute "regions" is already set
     *            if false it isn't yet
     */
    public boolean regionsIsSet() {
     ...
     *
     * @param id
     *            id of the class GeographicalRegion to create
     * @return the class created
     */
    public static GeographicalRegion create(final String id) {
        GeographicalRegion newGeographicalRegion = new GeographicalRegion();
        newGeographicalRegion.setId(id);
        return newGeographicalRegion;
    }
    ...
    public void readAttribute(final String class_name, final String attr_name,
        ...
        if (class_name.equals("GeographicalRegion")) {
    ...
    public void write(XMLStreamWriter xmlsw, boolean writeID) {
        ...
        if (writeID) {
            ...
            try {
                xmlsw.writeStartElement(CIMURI.CIMURI, "GeographicalRegion");
     ...
     *
     * @param otherGeographicalRegion
     *            the instance to copy
     */
    public void copyBase(final GeographicalRegion otherGeographicalRegion) {
     ...
     */
    private GeographicalRegion(final GeographicalRegion otherGeographicalRegion) {
        // TODO : check exception safe
        this.copyBase(otherGeographicalRegion);
    }
    ...
    */
     ...
     */
    public GeographicalRegion clone() {
        GeographicalRegion newInstance = new GeographicalRegion(this);
        GeographicalRegion newInstanceSP = newInstance;
