 ...
 * Description :
 *
 * This class "BusbarSection.java" represents the
 * class BusbarSection extends ConductingEquipment
 *    + VoltageControlZone   1..1   VoltageControlZone 

 */
public class BusbarSection extends ConductingEquipment {

    private static Logger LOGGER = LoggerFactory.getLogger(BusbarSection.class);

    /**
     * Attribute "voltageControlZone"
     *
     * Comment from profile:
     * A VoltageControlZone is controlled by a designated BusbarSection.
     */
    public VoltageControlZone voltageControlZone;

    /**
     * The id of the attribute "voltageControlZone"
     * This id is mainly used to resolve links after parsing an instance
     */

    public String idVoltageControlZone;
    ...
    */
    ...
    /**
     * Utility to return the "voltageControlZone"
     *
     * @return the value of the attribute "voltageControlZone"
     */
    ...
    /**
     * Utility to test if the value of "voltageControlZone" has been set
     *
     * @return boolean
     *            if true the attribute "voltageControlZone" is already set
     *            if false it isn't yet
     */
    public boolean voltageControlZoneIsSet() {
        return this.currentBitset.get(0);
    }

    /**
     * Utility to set the "voltageControlZoneValue"
     *
     * @param voltageControlZoneValue
     *            instance to set
     * @param setInverse
     ...
     */
    public void setVoltageControlZone(
            VoltageControlZone voltageControlZoneValue,
            boolean setInverse) throws LinkageException {
        this.voltageControlZone = voltageControlZoneValue;
        this.currentBitset.set(0);
        if (setInverse) {
            
            if (voltageControlZoneValue != null) {
                voltageControlZoneValue.setBusbarSection(this, false);
            }
        }
    }
     ...
     *
     * @param id
     *            id of the class BusbarSection to create
     * @return the class created
     */
    public static BusbarSection create(final String id) {
        BusbarSection newBusbarSection = new BusbarSection();
        newBusbarSection.setId(id);
        return newBusbarSection;
    }
    ...
    public void resolveLinks(CIMModel model, CIMModel boundaryModel) throws LinkageException {
        if (idVoltageControlZone != null) {
            VoltageControlZone attributeToSet =
                    model.searchVoltageControlZone
                    (idVoltageControlZone);
            ...
            if (attributeToSet != null) {
                ...
                try {
                    this.setVoltageControlZone(attributeToSet, setInverse);
                } catch(LinkageException e) {
                   LOGGER.error(e.toString(), e);
                    throw new LinkageException(e.getMessage());
                }
            } else if (boundaryModel != null) {
                VoltageControlZone attributeToSetFromBoundary = boundaryModel.searchVoltageControlZone(idVoltageControlZone);
                if(attributeToSetFromBoundary != null) {
                    attributeToSetFromBoundary.setFromBoundary(true);
                    boolean setInverse = true;
                    try {
                        this.setVoltageControlZone(attributeToSetFromBoundary, setInverse);
                    } catch(LinkageException e) {
                       LOGGER.error(e.toString(), e);
                        throw new LinkageException(e.getMessage());
                    }
                    ...
                    StringBuilder errorMessage = new StringBuilder(
                            "Could not find the reference to object of type \"VoltageControlZone\" and id \"");
                    errorMessage.append(idVoltageControlZone);
                    errorMessage.append("\" in \"BusbarSection\" of id \"");
     ...
     *
     * @param otherBusbarSection
     *            the instance to copy
     */
    public void copyBase(final BusbarSection otherBusbarSection) {
        ...
        if (otherBusbarSection.currentBitset.get(0)) {
            VoltageControlZone voltageControlZoneAssociation = otherBusbarSection.getVoltageControlZone();

            //this.idVoltageControlZone = (voltageControlZoneAssociation != null) ? voltageControlZoneAssociation.getId() : "";
            if (voltageControlZoneAssociation != null) {
                this.idVoltageControlZone = voltageControlZoneAssociation.getId();
                // the proper bit will be set when the setter is called
            } else {
                this.idVoltageControlZone = "";
            }
        }
     ...
     */
    private BusbarSection(final BusbarSection otherBusbarSection) {
        // TODO : check exception safe
        this.copyBase(otherBusbarSection);
    }

   /**
    * Constructor of the class BusbarSection
    */
    protected BusbarSection() {
        ...
        // attribute "VoltageControlZone" is mandatory :
     ...
     */
    public BusbarSection clone() {
        BusbarSection newInstance = new BusbarSection(this);
        BusbarSection newInstanceSP = newInstance;
