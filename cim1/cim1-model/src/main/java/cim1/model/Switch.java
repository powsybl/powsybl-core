 ...
 * Description :
 *
 * This class "Switch.java" represents the
...
public class Switch extends ConductingEquipment {
    ...
    */
     ...
     *
     * @param id
     *            id of the class Switch to create
     * @return the class created
     */
    public static Switch create(final String id) {
     ...
     */
    private Switch(final Switch otherSwitch) {
        // TODO : check exception safe
        this.copyBase(otherSwitch);
    }

   /**
    * Constructor of the class Switch
    */
    protected Switch() {
     ...
     */
    public Switch clone() {
        Switch newInstance = new Switch(this);
        Switch newInstanceSP = newInstance;
