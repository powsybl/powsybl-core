 ...
 * Description :
 *
 * This class "EquivalentEquipment.java" represents the
 * class EquivalentEquipment extends ConductingEquipment

 */
public class EquivalentEquipment extends ConductingEquipment {

    private static Logger LOGGER = LoggerFactory.getLogger(EquivalentEquipment.class);
    ...
    */
     ...
     *
     * @param id
     *            id of the class EquivalentEquipment to create
     * @return the class created
     */
    public static EquivalentEquipment create(final String id) {
        EquivalentEquipment newEquivalentEquipment = new EquivalentEquipment();
        newEquivalentEquipment.setId(id);
        return newEquivalentEquipment;
    }
    ...
    public void readAttribute(final String class_name, final String attr_name,
        ...
        if (class_name.equals("EquivalentEquipment")) {
     ...
     *
     * @param EquivalentEquipment
     *            the reference to the class to copy
     * @return the class constructed
     */
    private EquivalentEquipment(final EquivalentEquipment otherEquivalentEquipment) {
        // TODO : check exception safe
        this.copyBase(otherEquivalentEquipment);
    }

   /**
    * Constructor of the class EquivalentEquipment
    */
     ...
     */
    public EquivalentEquipment clone() {
        EquivalentEquipment newInstance = new EquivalentEquipment(this);
        EquivalentEquipment newInstanceSP = newInstance;
