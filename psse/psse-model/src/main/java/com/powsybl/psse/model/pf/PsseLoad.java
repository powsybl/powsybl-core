...
public class PsseLoad extends PsseVersioned {
    ...
    private static final String[] FIELD_NAMES_32 = {STR_I, STR_ID, STR_STAT, STR_AREA, STR_ZONE, STR_PL, STR_QL, STR_IP,
        STR_IQ, STR_YP, STR_YQ, STR_OWNER, STR_SCALE};
    private static final String[] FIELD_NAMES_33 = {STR_I, STR_ID, STR_STAT, STR_AREA, STR_ZONE, STR_PL, STR_QL, STR_IP,
        STR_IQ, STR_YP, STR_YQ, STR_OWNER, STR_SCALE, STR_INTRPT};
    private static final String[] FIELD_NAMES_35 = {STR_I, STR_ID, STR_STAT, STR_AREA, STR_ZONE, STR_PL, STR_QL, STR_IP,
        STR_IQ, STR_YP, STR_YQ, STR_OWNER, STR_SCALE, STR_INTRPT, STR_DGENP, STR_DGENQ, STR_DGENF, STR_LOADTYPE};
    private static final String[] FIELD_NAMES_35X = {STR_IBUS, STR_LOADID, STR_STAT, STR_AREA, STR_ZONE, STR_PL, STR_QL,
        STR_IP, STR_IQ, STR_YP, STR_YQ, STR_OWNER, STR_SCALE, STR_INTRPT, STR_DGENP, STR_DGENQ, STR_DGENM, STR_LOADTYPE};
