...
public class TransformerWindingRecord {
    ...
    private static final String[] FIELD_NAMES_32_33 = {STR_WINDV, STR_NOMV, STR_ANG, STR_RATA, STR_RATB, STR_RATC,
        STR_COD, STR_CONT, STR_RMA, STR_RMI, STR_VMA, STR_VMI, STR_NTP, STR_TAB, STR_CR, STR_CX, STR_CNXA};
    private static final String[] FIELD_NAMES_35 = {STR_WINDV, STR_NOMV, STR_ANG, STR_WDGRATE1, STR_WDGRATE2,
        STR_WDGRATE3, STR_WDGRATE4, STR_WDGRATE5, STR_WDGRATE6, STR_WDGRATE7, STR_WDGRATE8, STR_WDGRATE9, STR_WDGRATE10,
        STR_WDGRATE11, STR_WDGRATE12, STR_COD, STR_CONT, STR_NODE, STR_RMA, STR_RMI, STR_VMA, STR_VMI, STR_NTP, STR_TAB, STR_CR, STR_CX, STR_CNXA};
