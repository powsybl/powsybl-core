...
public class PsseFacts extends PsseVersioned {
    ...
    private static final String[] FIELD_NAMES_32_33 = {STR_NAME, STR_I, STR_J, STR_MODE, STR_PDES, STR_QDES, STR_VSET,
        STR_SHMX, STR_TRMX, STR_VTMN, STR_VTMX, STR_VSMX, STR_IMX, STR_LINX, STR_RMPCT, STR_OWNER, STR_SET1, STR_SET2,
        STR_VSREF, STR_REMOT, STR_MNAME};
    private static final String[] FIELD_NAMES_35 = {STR_NAME, STR_I, STR_J, STR_MODE, STR_PDES, STR_QDES, STR_VSET,
        STR_SHMX, STR_TRMX, STR_VTMN, STR_VTMX, STR_VSMX, STR_IMX, STR_LINX, STR_RMPCT, STR_OWNER, STR_SET1, STR_SET2,
        STR_VSREF, STR_FCREG, STR_NREG, STR_MNAME};
    private static final String[] FIELD_NAMES_35X = {STR_NAME, STR_IBUS, STR_JBUS, STR_MODE, STR_PDES, STR_QDES, STR_VSET,
        STR_SHMX, STR_TRMX, STR_VTMN, STR_VTMX, STR_VSMX, STR_IMX, STR_LINX, STR_RMPCT, STR_OWNER, STR_SET1, STR_SET2,
        STR_VSREF, STR_FCREG, STR_NREG, STR_MNAME};
