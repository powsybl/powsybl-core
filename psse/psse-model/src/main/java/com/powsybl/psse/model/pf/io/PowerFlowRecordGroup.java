...
public enum PowerFlowRecordGroup implements RecordGroupIdentification {
    ...
    INTERNAL_TWO_TERMINAL_DC_TRANSMISSION_LINE_CONVERTER("twotermdc", "TWO-TERMINAL DC"),
    VOLTAGE_SOURCE_CONVERTER_DC_TRANSMISSION_LINE("vscdc", "VOLTAGE SOURCE CONVERTER"),
    INTERNAL_VOLTAGE_SOURCE_CONVERTER_DC_TRANSMISSION_LINE_CONVERTER("vscdc", "VOLTAGE SOURCE CONVERTER"),
