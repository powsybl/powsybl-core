...
class SwitchedShuntData extends AbstractRecordGroup<PsseSwitchedShunt> {
    ...
    SwitchedShuntData() {
        ...
        withFieldNames(V32, PsseSwitchedShunt.getFieldNames3233());
        withFieldNames(V33, PsseSwitchedShunt.getFieldNames3233());
        withFieldNames(V35, PsseSwitchedShunt.getFieldNames35());
        withQuotedFields(PsseSwitchedShunt.getFieldNamesString());
    }
