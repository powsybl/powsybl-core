...
class GeneratorData extends AbstractRecordGroup<PsseGenerator> {
    ...
    private static final String[] FIELD_NAMES_32_33 = {"i", "id", "pg", "qg", "qt", "qb", "vs", "ireg", "mbase",
        "zr", "zx", "rt", "xt", "gtap", "stat", "rmpct", "pt", "pb", "o1", "f1", "o2", "f2", "o3", "f3", "o4", "f4", "wmod", "wpf"};
    static final String[] FIELD_NAMES_35 = {"ibus", "machid", "pg", "qg", "qt", "qb", "vs", "ireg", "nreg", "mbase",
        "zr", "zx", "rt", "xt", "gtap", "stat", "rmpct", "pt", "pb", "baslod", "o1", "f1", "o2", "f2", "o3", "f3", "o4", "f4", "wmod", "wpf"};
