...
class FactsDeviceData extends AbstractRecordGroup<PsseFacts> {
    ...
    private static final String[] FIELD_NAMES_32_33 = {"name", "i", "j", "mode", "pdes", "qdes", "vset", "shmx", "trmx",
        "vtmn", "vtmx", "vsmx", "imx", "linx", "rmpct", "owner", "set1", "set2", "vsref", "remot", STR_MNAME};
    static final String[] FIELD_NAMES_35 = {"name", "ibus", "jbus", "mode", "pdes", "qdes", "vset", "shmx", "trmx",
        "vtmn", "vtmx", "vsmx", "imx", "linx", "rmpct", "owner", "set1", "set2", "vsref", "fcreg", "nreg", STR_MNAME};
