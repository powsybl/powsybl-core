...
class FactsDeviceData extends AbstractRecordGroup<PsseFacts> {
    ...
    FactsDeviceData() {
        ...
        withFieldNames(V32, PsseFacts.getFieldNames3233());
        withFieldNames(V33, PsseFacts.getFieldNames3233());
        withFieldNames(V35, PsseFacts.getFieldNames35());
        withQuotedFields(PsseFacts.getFieldNamesString());
    }
