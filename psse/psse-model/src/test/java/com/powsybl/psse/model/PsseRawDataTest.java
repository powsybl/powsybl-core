...
public class PsseRawDataTest {
    ...
    public void ieee14BusReadFieldsTest() throws IOException {
        ...
        String[] actualCaseIdentificationDataReadFields = context.getFieldNames(AbstractDataBlock.PsseDataBlock.CASE_IDENTIFICATION_DATA);
        ...
        String[] actualBusDataReadFields = context.getFieldNames(AbstractDataBlock.PsseDataBlock.BUS_DATA);
        ...
        String[] actualLoadDataReadFields = context.getFieldNames(AbstractDataBlock.PsseDataBlock.LOAD_DATA);
        ...
        String[] actualFixedBusShuntDataReadFields = context.getFieldNames(AbstractDataBlock.PsseDataBlock.FIXED_BUS_SHUNT_DATA);
        ...
        String[] expectedGeneratorDataReadFields = new String[]{"i", "id", "pg", "qg", "qt", "qb", "vs", "ireg",
            ...
            "f3", "o4", "f4", "wmod", "wpf"};
        String[] actualGeneratorDataReadFields = context.getFieldNames(AbstractDataBlock.PsseDataBlock.GENERATOR_DATA);
        ...
        String[] expectedNonTransformerBranchDataReadFields = new String[]{"i", "j", "ckt", "r", "x", "b",
            ...
            "f3", "o4", "f4"};
        String[] actualNonTransformerBranchDataReadFields = context.getFieldNames(AbstractDataBlock.PsseDataBlock.NON_TRANSFORMER_BRANCH_DATA);
        ...
        String[] actual2wTransformerDataReadFields = context.getFieldNames(AbstractDataBlock.PsseDataBlock.TRANSFORMER_2_DATA);
        ...
        String[] actualAreaInterchangeDataReadFields = context.getFieldNames(AbstractDataBlock.PsseDataBlock.AREA_INTERCHANGE_DATA);
        ...
        String[] actualZoneDataReadFields = context.getFieldNames(AbstractDataBlock.PsseDataBlock.ZONE_DATA);
        ...
        String[] actualOwnerDataReadFields = context.getFieldNames(AbstractDataBlock.PsseDataBlock.OWNER_DATA);
