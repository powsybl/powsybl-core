...
class PsseRawDataTest extends AbstractSerDeTest {
    ...
    void ieee14BusWriteTest() throws IOException {
        ...
        assertNotNull(rawData);
        rawData33.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "IEEE_14_bus_exported"));
    ...
    void ieee14BusRev35WriteTest() throws IOException {
        ...
        rawData35.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "IEEE_14_bus_rev35_exported"));
    ...
    void minimalExampleRawxWriteTest() throws IOException {
        ...
        rawXData35.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "MinimalExample_exported"));
    ...
    void ieee14BusRev35RawxWriteTest() throws IOException {
        ...
        rawXData35.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "IEEE_14_bus_rev35_exported"));
    ...
    void ieee14WhitespaceAsDelimiterWriteTest() throws IOException {
        ...
        assertNotNull(rawData);
        rawData33.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "IEEE_14_bus_whitespaceAsDelimiter_exported"));
    ...
    void ieee14IsolatedBusesWriteTest() throws IOException {
        ...
        assertNotNull(rawData);
        rawData33.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "IEEE_14_isolated_buses_exported"));
    ...
    void ieee24BusWriteTest() throws IOException {
        ...
        rawData33.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "IEEE_24_bus_exported"));
    ...
    void ieee24BusRev35WriteTest() throws IOException {
        ...
        rawData35.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "IEEE_24_bus_rev35_exported"));
    ...
    void ieee24BusRev35RawxWriteTest() throws IOException {
        ...
        rawxData35.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "IEEE_24_bus_rev35_exported"));
    ...
    void ieee14BusCompletedWriteTest() throws IOException {
        ...
        rawData33.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "IEEE_14_bus_completed_exported"));
    ...
    void ieee14BusCompletedRev35WriteTest() throws IOException {
        ...
        rawData35.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "IEEE_14_bus_completed_rev35_exported"));
    ...
    void ieee14BusCompletedRev35RawxWriteTest() throws IOException {
        ...
        rawxData35.write(rawData, context, DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "IEEE_14_bus_completed_rev35_exported"));
    ...
    void exampleVersion32WriteTest() throws IOException {
        ...
        rawData32.write(rawData, context,
            DataSourceUtil.createDataSource(fileSystem.getPath("/work/"), "", "ExampleVersion32_exported"));
