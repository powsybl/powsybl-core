 ...
 */
public record NcTapPositionAction(String mrid, String tapChangerId, NcPropertyReference propertyReference, boolean enabled,
                                String gridStateAlterationRemedialAction, String gridStateAlterationCollection) implements NcGridStateAlteration {
    public static NcTapPositionAction fromPropertyBag(PropertyBag propertyBag) {
        return new NcTapPositionAction(
