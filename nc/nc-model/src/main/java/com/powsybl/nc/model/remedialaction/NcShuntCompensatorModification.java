 ...
 */
public record NcShuntCompensatorModification(String mrid, String shuntCompensatorId, NcPropertyReference propertyReference, boolean enabled,
                                           String gridStateAlterationRemedialAction,
                                           String gridStateAlterationCollection) implements NcGridStateAlteration {
    public static NcShuntCompensatorModification fromPropertyBag(PropertyBag propertyBag) {
        return new NcShuntCompensatorModification(
