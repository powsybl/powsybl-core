...
public class ShuntCompensatorModificationReaderTest extends AbstractReaderTest {
    ...
    void importShuntCompensatorModifications() {
        ...
        assertEquals("StaticPropertyRange static-property-range-7 associated to ShuntCompensatorModification shunt-compensator-modification-7 "
        ...
        assertEquals("ShuntCompensatorModification shunt-compensator-modification-13 has no static property range and will be ignored.",
            appender.getEvents().get(12).getFormattedMessage());
        assertEquals("ShuntCompensatorModification shunt-compensator-modification-14 has multiple static property ranges and will be ignored.",
            appender.getEvents().get(13).getFormattedMessage());
        assertEquals("ShuntCompensatorModification shunt-compensator-modification-15 is not enabled and will be ignored.",
            appender.getEvents().get(14).getFormattedMessage());
        assertEquals("StaticPropertyRange static-property-range-16 associated to ShuntCompensatorModification shunt-compensator-modification-16 "
