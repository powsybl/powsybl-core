...
public class AmplNetworkWriter {
        ...
        for (Line l : network.getLines()) {
            ...
            if (config.isExportXNodes() && l.isTieLine()) {
                ...
                formatter.writeCell(variantIndex)
                        ...
                        .writeCell(getPermanentLimit(l.getActiveCurrentLimits1().orElse(null)))
                        .writeCell(Float.NaN)
                        .writeCell(merged)
                        .writeCell(faultNum)
                        .writeCell(actionNum)
                ...
                formatter.writeCell(variantIndex)
                        ...
                        .writeCell(t2.getQ())
                        .writeCell(Float.NaN)
                        .writeCell(getPermanentLimit(l.getActiveCurrentLimits2().orElse(null)))
                        .writeCell(merged)
                        .writeCell(faultNum)
                        .writeCell(actionNum)
                        .writeCell(half2Id)
    ...
    private void writeTwoWindingsTransformers(AmplExportContext context, TableFormatter formatter) throws IOException {
        for (TwoWindingsTransformer twt : network.getTwoWindingsTransformers()) {
            ...
            formatter.writeCell(variantIndex)
                    ...
                    .writeCell(t1.getQ())
                    .writeCell(t2.getQ())
                    .writeCell(getPermanentLimit(twt.getActiveCurrentLimits1().orElse(null)))
                    .writeCell(getPermanentLimit(twt.getActiveCurrentLimits2().orElse(null)))
        ...
        for (ThreeWindingsTransformer twt : network.getThreeWindingsTransformers()) {
            ...
            if (!isOnlyMainCc() || isBusExported(context, middleBusId) || isBusExported(context, bus1Id)) {
                formatter.writeCell(variantIndex)
                        ...
                        .writeCell(t1.getQ())
                        .writeCell(Double.NaN)
                        .writeCell(getPermanentLimit(twt.getLeg1().getActiveCurrentLimits().orElse(null)))
                        .writeCell(false)
                        .writeCell(faultNum)
                        .writeCell(actionNum)
                        .writeCell(id1)
            ...
            if (!isOnlyMainCc() || isBusExported(context, middleBusId) || isBusExported(context, bus2Id)) {
                formatter.writeCell(variantIndex)
                        ...
                        .writeCell(t2.getQ())
                        .writeCell(Double.NaN)
                        .writeCell(getPermanentLimit(twt.getLeg2().getActiveCurrentLimits().orElse(null)))
                        .writeCell(Double.NaN)
                        .writeCell(false)
                        .writeCell(faultNum)
                        .writeCell(actionNum)
            ...
            if (!isOnlyMainCc() || isBusExported(context, middleBusId) || isBusExported(context, bus3Id)) {
                formatter.writeCell(variantIndex)
                        ...
                        .writeCell(t3.getQ())
                        .writeCell(Double.NaN)
                        .writeCell(getPermanentLimit(twt.getLeg3().getActiveCurrentLimits().orElse(null)))
                        .writeCell(Double.NaN)
                        .writeCell(false)
                        .writeCell(faultNum)
                        .writeCell(actionNum)
    ...
    private void writeDanglingLines(AmplExportContext context, TableFormatter formatter) throws IOException {
        for (DanglingLine dl : network.getDanglingLines()) {
            ...
            double p2 = sv.getP();
            double q2 = sv.getQ();
            double patl = getPermanentLimit(dl.getActiveCurrentLimits().orElse(null));
            formatter.writeCell(variantIndex)
                    .writeCell(num)
                    .writeCell(bus1Num)
                    .writeCell(middleBusNum)
    ...
    private void writeThreeWindingsTransformerCurrentLimits(TableFormatter formatter) throws IOException {
        for (ThreeWindingsTransformer twt : network.getThreeWindingsTransformers()) {
            Optional<CurrentLimits> currentLimits1 = twt.getLeg1().getActiveCurrentLimits();
            if (currentLimits1.isPresent()) {
            ...
            Optional<CurrentLimits> currentLimits2 = twt.getLeg2().getActiveCurrentLimits();
            if (currentLimits2.isPresent()) {
            ...
            Optional<CurrentLimits> currentLimits3 = twt.getLeg3().getActiveCurrentLimits();
