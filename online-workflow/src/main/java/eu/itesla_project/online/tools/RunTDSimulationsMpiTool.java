...
public class RunTDSimulationsMpiTool implements Tool {
	...
	public void run(CommandLine line) throws Exception {
		...
		application.runTDSimulations(startconfig, line.getOptionValue("case-dir"),line.getOptionValue("case-basename"),line.getOptionValue("contingencies"),Boolean.toString(emptyContingency),line.getOptionValue("output-folder"));
	}
