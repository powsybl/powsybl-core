...
public class OnlineWorkflowCommand implements Command {
	...
	public Options getOptions() {
		...
		opts.addOption(Option.builder().longOpt(CONSTRAINT_MARGIN)
		 ...
		 /*
		 	Option opt = new Option("host",true,": jmx host");
		 	opt.setRequired(true);
		 	opts.addOption(opt);
		 
		 	opt = new Option("port",true,": jmx port");
		 	opt.setRequired(true);
			opts.addOption(opt);
	        ...
	        opt = new Option("startWorkflow",false,": start new online workflow");
			opt.setRequired(false);
			og.addOption(opt);
			opt = new Option("shutdown",false,": shutdown online workflow application");
			opt.setRequired(false);
			og.addOption(opt);
			opts.addOptionGroup(og);
			*/
