...
class ReportFormatterTest {
    ...
    void test() {
        ...
        assertEquals("Formatter test message double default format: 4.35684975 double format based on type: " +
            "4,4665 float format based on type: 0,60 string default format: tiny string format based on type: This is a sentence",
            root.getMessage(customFormatter));
    }
}
