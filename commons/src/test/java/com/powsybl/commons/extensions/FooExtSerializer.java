...
public class FooExtSerializer implements ExtensionJsonSerializer<Foo, FooExt> {
    ...
    @Override
    public FooExt deserialize(JsonParser parser, DeserializationContext deserializationContext, ReportNode reportNode) throws JacksonException {
    ...
    @Override
    public FooExt deserializeAndUpdate(JsonParser jsonParser, DeserializationContext deserializationContext, FooExt parameters, ReportNode reportNode) throws JacksonException {
