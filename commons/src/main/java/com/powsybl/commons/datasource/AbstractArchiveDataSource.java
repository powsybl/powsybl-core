...
public abstract class AbstractArchiveDataSource extends AbstractFileSystemDataSource {
    ...
    AbstractArchiveDataSource(Path directory, String archiveFileName, String baseName, String dataExtension,
                              CompressionFormat compressionFormat, ArchiveFormat archiveFormat, DataSourceObserver observer) {
