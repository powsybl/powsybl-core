...
public class Bzip2DirectoryDataSource extends DirectoryDataSource {
    ...
    public Bzip2DirectoryDataSource(Path directory, String baseName, String dataExtension, boolean isCuratedDirectory, DataSourceObserver observer) {
        super(directory, baseName, dataExtension, CompressionFormat.BZIP2, isCuratedDirectory, observer);
    }
