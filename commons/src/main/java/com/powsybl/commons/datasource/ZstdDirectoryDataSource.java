...
public class ZstdDirectoryDataSource extends DirectoryDataSource {
    ...
    public ZstdDirectoryDataSource(Path directory, String baseName, String dataExtension, boolean isCuratedDirectory, DataSourceObserver observer) {
        super(directory, baseName, dataExtension, CompressionFormat.ZSTD, isCuratedDirectory, observer);
    }
