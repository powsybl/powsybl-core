...
public class XZDirectoryDataSource extends DirectoryDataSource {
    ...
    public XZDirectoryDataSource(Path directory, String baseName, String dataExtension, boolean isCuratedDirectory, DataSourceObserver observer) {
        super(directory, baseName, dataExtension, CompressionFormat.XZ, isCuratedDirectory, observer);
    }
