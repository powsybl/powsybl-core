 ...
 */
public abstract class AbstractExtensionSerializer<T extends Extendable, E extends Extension<T>> implements ExtensionSerializer<T, E> {
    ...
    protected AbstractExtensionSerializer(String extensionName, String categoryName, Class<? super E> extensionClass,
