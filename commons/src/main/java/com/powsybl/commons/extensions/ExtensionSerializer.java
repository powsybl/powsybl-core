 ...
 */
public interface ExtensionSerializer<T extends Extendable, E extends Extension<T>> extends ExtensionProvider<T, E>, Versionable {
    ...
    void write(E extension, WriterContext context);

    E read(T extendable, ReaderContext context);
