...
public interface TreeDataWriter extends AutoCloseable {
     ...
     * @param defaultValue the default value for this field, only write if the value is not the defaultValue
     */
    void writeStringAttribute(String name, String value, String defaultValue);
