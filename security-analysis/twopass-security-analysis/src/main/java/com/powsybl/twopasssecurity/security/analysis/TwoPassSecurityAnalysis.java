 ...
 */
public class TwoPassSecurityAnalysis {
    private static final Logger LOGGER = LoggerFactory.getLogger(TwoPassSecurityAnalysis.class);
    ...
    /**
     * Executes the full two-pass analysis workflow.
     */
    public CompletableFuture<SecurityAnalysisReport> run() {
        ...
        TwoPassSecurityAnalysisReports.reportTotalContingencies(reportNode, allContingencies.size());
        ...
        return firstAnalysisFuture.thenCompose(this::processFirstPassResults)
            .exceptionally(ex -> {
                LOGGER.error("Error during two-pass security analysis", ex);
    ...
    private CompletableFuture<SecurityAnalysisReport> processFirstPassResults(SecurityAnalysisReport firstReport) {
        ...
        TwoPassSecurityAnalysisReports.reportSecondPassRequired(reportNode, contingenciesForSecondPass.size());
