...
class StateMonitorIndexTest {
    ...
    void test() {
        ...
        assertEquals(new StateMonitor(ContingencyContext.all(), Set.of("Branch4", "Branch5"),
            Set.of("Bus4", "Bus5"), Set.of("ThreeWindingsTransformer4", "ThreeWindingsTransformer5")), monitorIndex.getAllStateMonitor());
        assertEquals(new StateMonitor(ContingencyContext.none(), Set.of("Branch2", "Branch3"),
