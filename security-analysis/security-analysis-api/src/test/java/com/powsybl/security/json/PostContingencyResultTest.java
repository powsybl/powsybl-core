...
public class PostContingencyResultTest extends AbstractConverterTest {
    ...
    public void testGetters() {
        ...
        PostContingencyResult postContingencyResult = new PostContingencyResult(contingency, result, branchResults, busResults, threeWindingsTransformerResults, SecurityContingencyStatus.CONVERGED);
        ...
        assertEquals(SecurityContingencyStatus.CONVERGED, postContingencyResult.getContingencyStatus());
    }
