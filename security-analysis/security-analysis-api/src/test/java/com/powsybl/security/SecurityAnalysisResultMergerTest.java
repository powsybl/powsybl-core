...
public class SecurityAnalysisResultMergerTest {
    ...
    public void setup() {
        ...
        postContingencyResult = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency1, Arrays.asList(line1Violation, line2Violation), Collections.singletonList("action2"));

        Contingency contingency2 = Mockito.mock(Contingency.class);
        Mockito.when(contingency1.getId()).thenReturn("contingency2");
        postContingencyResult2 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency2, Arrays.asList(line1Violation, line2Violation), Collections.singletonList("action3"));
