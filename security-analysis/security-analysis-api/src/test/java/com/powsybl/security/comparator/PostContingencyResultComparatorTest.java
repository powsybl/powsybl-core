...
public class PostContingencyResultComparatorTest {
    ...
    public void compare() {
        ...
        PostContingencyResult result1 = new PostContingencyResult(contingency1, true, Collections.emptyList(), SecurityContingencyStatus.CONVERGED);
        Contingency contingency2 = Mockito.mock(Contingency.class);
        Mockito.when(contingency2.getId()).thenReturn("contingency2");
        PostContingencyResult result2 = new PostContingencyResult(contingency2, true, Collections.emptyList(), SecurityContingencyStatus.CONVERGED);
        Contingency contingency3 = Mockito.mock(Contingency.class);
        Mockito.when(contingency3.getId()).thenReturn("contingency3");
        PostContingencyResult result3 = new PostContingencyResult(contingency3, true, Collections.emptyList(), SecurityContingencyStatus.CONVERGED);
