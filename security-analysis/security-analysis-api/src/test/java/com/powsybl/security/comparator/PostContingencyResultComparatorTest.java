...
public class PostContingencyResultComparatorTest {
    ...
    public void compare() {
        ...
        PostContingencyResult result1 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency1, Collections.emptyList());
        Contingency contingency2 = Mockito.mock(Contingency.class);
        Mockito.when(contingency2.getId()).thenReturn("contingency2");
        PostContingencyResult result2 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency2, Collections.emptyList());
        Contingency contingency3 = Mockito.mock(Contingency.class);
        Mockito.when(contingency3.getId()).thenReturn("contingency3");
        PostContingencyResult result3 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency3, Collections.emptyList());
