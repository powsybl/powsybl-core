...
public class SecurityAnalysisResultEquivalenceTest {
    ...
    public void equivalent() {
        ...
        PostContingencyResult postContingencyResult11 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency1, new LimitViolationsResult(Arrays.asList(line1Violation1, line1Violation2)));
        PostContingencyResult postContingencyResult12 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency2, new LimitViolationsResult(Arrays.asList(line1Violation1, line2Violation)));
        ...
        PostContingencyResult postContingencyResult21 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency1, new LimitViolationsResult(Arrays.asList(similarLine1Violation1, similarLine1Violation2)));
        PostContingencyResult postContingencyResult22 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency2, new LimitViolationsResult(Arrays.asList(similarLine1Violation1, similarLine2Violation)));
        ...
        postContingencyResult21 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency1, new LimitViolationsResult(Arrays.asList(similarLine1Violation1, differentLine1Violation2)));
        result2 = new SecurityAnalysisResult(preContingencyResult2, LoadFlowResult.ComponentResult.Status.CONVERGED, Arrays.asList(postContingencyResult22, postContingencyResult21));

        assertFalse(resultEquivalence.equivalent(result1, result2));

        // similar pre contingency results, different post contingency results: more contingencies at the end of result2
        postContingencyResult21 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency1, new LimitViolationsResult(Arrays.asList(similarLine1Violation1, similarLine1Violation2)));
        PostContingencyResult postContingencyResult23 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency3, new LimitViolationsResult(Arrays.asList(similarLine1Violation1, similarLine3Violation)));
        ...
        PostContingencyResult postContingencyResult13 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency3, new LimitViolationsResult(Arrays.asList(line1Violation1, line3Violation)));
        ...
        postContingencyResult12 = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency2, new LimitViolationsResult(Arrays.asList(smallLine1Violation1, smallLine2Violation)));
        result1 = new SecurityAnalysisResult(preContingencyResult1, LoadFlowResult.ComponentResult.Status.CONVERGED, Arrays.asList(postContingencyResult13, postContingencyResult11, postContingencyResult12));
