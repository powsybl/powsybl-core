...
public class SecurityAnalysisResultEquivalenceTest {
    ...
    public void equivalent() {
        ...
        PostContingencyResult postContingencyResult11 = new PostContingencyResult(contingency1, new LimitViolationsResult(Arrays.asList(line1Violation1, line1Violation2)), SecurityContingencyStatus.CONVERGED);
        PostContingencyResult postContingencyResult12 = new PostContingencyResult(contingency2, new LimitViolationsResult(Arrays.asList(line1Violation1, line2Violation)), SecurityContingencyStatus.CONVERGED);
        ...
        PostContingencyResult postContingencyResult21 = new PostContingencyResult(contingency1, new LimitViolationsResult(Arrays.asList(similarLine1Violation1, similarLine1Violation2)), SecurityContingencyStatus.CONVERGED);
        PostContingencyResult postContingencyResult22 = new PostContingencyResult(contingency2, new LimitViolationsResult(Arrays.asList(similarLine1Violation1, similarLine2Violation)), SecurityContingencyStatus.CONVERGED);
        ...
        postContingencyResult21 = new PostContingencyResult(contingency1, new LimitViolationsResult(Arrays.asList(similarLine1Violation1, differentLine1Violation2)), SecurityContingencyStatus.CONVERGED);
        result2 = new SecurityAnalysisResult(preContingencyResult2, LoadFlowResult.ComponentResult.Status.CONVERGED, Arrays.asList(postContingencyResult22, postContingencyResult21));

        assertFalse(resultEquivalence.equivalent(result1, result2));

        // similar pre contingency results, different post contingency results: more contingencies at the end of result2
        postContingencyResult21 = new PostContingencyResult(contingency1, new LimitViolationsResult(Arrays.asList(similarLine1Violation1, similarLine1Violation2)), SecurityContingencyStatus.CONVERGED);
        PostContingencyResult postContingencyResult23 = new PostContingencyResult(contingency3, new LimitViolationsResult(Arrays.asList(similarLine1Violation1, similarLine3Violation)), SecurityContingencyStatus.CONVERGED);
        ...
        PostContingencyResult postContingencyResult13 = new PostContingencyResult(contingency3, new LimitViolationsResult(Arrays.asList(line1Violation1, line3Violation)), SecurityContingencyStatus.CONVERGED);
        ...
        postContingencyResult12 = new PostContingencyResult(contingency2, new LimitViolationsResult(Arrays.asList(smallLine1Violation1, smallLine2Violation)), SecurityContingencyStatus.CONVERGED);
        result1 = new SecurityAnalysisResult(preContingencyResult1, LoadFlowResult.ComponentResult.Status.CONVERGED, Arrays.asList(postContingencyResult13, postContingencyResult11, postContingencyResult12));
