...
public class SecurityTest {
    ...
    public void printLimitsViolations() throws Exception {
        assertEquals("+---------------+-------+---------+--------------+----------------+-----------------+---------+---------+------------------+----------------+\n" +
                        ...
                        "+---------------+-------+---------+--------------+----------------+-----------------+---------+---------+------------------+----------------+\n" +
                        "| NHV1_NHV2_1   | VLHV1 | FR      |          380 | CURRENT        | Permanent limit | 1100.00 | 950.000 |          150.000 |        110.000 |\n" +
                        "| NHV1_NHV2_2   | VLHV1 | FR      |          380 | CURRENT        | Permanent limit | 950.000 | 855.000 |          95.0000 |        105.556 |\n" +
                        "+---------------+-------+---------+--------------+----------------+-----------------+---------+---------+------------------+----------------+",
