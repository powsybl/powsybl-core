...
public class SecurityTest {
    ...
    public void setUp() {
        ...
        PostContingencyResult postContingencyResult = new PostContingencyResult(contingency1, true, Arrays.asList(line1Violation, line2Violation), Collections.singletonList("action2"), PostContingencyComputationStatus.CONVERGED);
