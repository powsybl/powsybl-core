...
public class SecurityTest {
    ...
    public void setUp() {
        ...
        PostContingencyResult postContingencyResult = new PostContingencyResult(PostContingencyComputationStatus.CONVERGED, contingency1, Arrays.asList(line1Violation, line2Violation), Collections.singletonList("action2"));
