...
public class SecurityAnalysisResultEquivalence extends Equivalence<SecurityAnalysisResult> {
    ...
    public SecurityAnalysisResultEquivalence(double threshold, Writer writer, TableFormatterConfig config) {
        this.threshold = threshold;
        this.comparisonWriter = new SecurityAnalysisResultComparisonWriter(writer, config);
    }
