 ...
 * <p>You can retrieve the scaled limits by using the {@link #computeLimits(Object, LimitType, ThreeSides, boolean)} method
 ...
 * the original limits (accessible via {@link LimitsContainer#getOriginalLimits()}) and the scaled limits
 * (accessible via {@link LimitsContainer#getLimits()}).</p>
 * <p>Since LimitScalings depend on the contingency context, you should call {@link #setWorkingContingency(String contingencyId)}
...
public class DefaultLimitScalingsApplier extends AbstractLimitScalingsApplier<Identifiable<?>, LoadingLimits> {
    ...
    @Override
    protected AbstractLimitsScalerCreator<LoadingLimits, AbstractLimitsScaler<LoadingLimits>> getLimitsScalerCreator() {
