...
public class CurrentExtensionSerializer implements ExtensionJsonSerializer<LimitViolation, CurrentExtension> {
    ...
    @Override
    public void serialize(CurrentExtension extension, JsonGenerator jsonGenerator, SerializationContext serializationContext) throws JacksonException {
    ...
    @Override
    public CurrentExtension deserialize(JsonParser parser, DeserializationContext deserializationContext) throws JacksonException {
