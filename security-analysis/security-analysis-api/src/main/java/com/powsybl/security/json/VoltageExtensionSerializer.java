...
public class VoltageExtensionSerializer implements ExtensionJsonSerializer<LimitViolation, VoltageExtension> {
    ...
    @Override
    public void serialize(VoltageExtension extension, JsonGenerator jsonGenerator, SerializationContext serializationContext) throws JacksonException {
    ...
    @Override
    public VoltageExtension deserialize(JsonParser parser, DeserializationContext deserializationContext) throws JacksonException {
