    ...
    public LimitViolation deserialize(JsonParser parser, DeserializationContext deserializationContext) throws IOException {
        ...
        while (parser.nextToken() != JsonToken.END_OBJECT) {
            switch (parser.getCurrentName()) {
                ...
                case "limitType":
                    parser.nextToken();
                    limitType = JsonUtil.readValueWithContext(deserializationContext, parser, LimitViolationType.class);
                    break;
                ...
                case "side":
                    parser.nextToken();
                    side = JsonUtil.readValueWithContext(deserializationContext, parser, Branch.Side.class);
                    break;
