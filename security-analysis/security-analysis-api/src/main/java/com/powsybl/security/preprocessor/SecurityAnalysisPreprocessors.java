...
public final class SecurityAnalysisPreprocessors {
     ...
     */
    public static SecurityAnalysisPreprocessorFactory defaultConfiguredFactory() {
        return SecurityAnalysisConfig.load()
                .getPreprocessorName()
                .map(SecurityAnalysisPreprocessors::factoryForName)
                .orElseGet(DefaultSecurityAnalysisPreprocessorFactory::new);
    }
