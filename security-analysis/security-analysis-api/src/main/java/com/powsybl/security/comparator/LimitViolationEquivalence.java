...
public class LimitViolationEquivalence extends Equivalence<LimitViolation> {
    ...
    protected boolean doEquivalent(LimitViolation violation1, LimitViolation violation2) {
        return violation1.getSubjectId().equals(violation2.getSubjectId())
               && (violation1.getOperationalLimitsGroupId() == null ?
            violation2.getOperationalLimitsGroupId() == null :
            violation1.getOperationalLimitsGroupId().equals(violation2.getOperationalLimitsGroupId()))
               ...
               && Math.abs(violation1.getLimitScaling() - violation2.getLimitScaling()) <= threshold
