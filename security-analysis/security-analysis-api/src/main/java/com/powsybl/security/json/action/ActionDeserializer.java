            ...
            if ("type".equals(parser.getCurrentName())) {
                switch (parser.nextTextValue()) {
                    ...
                    case GeneratorAction.NAME:
                        GeneratorActionDeserializer generatorActionDeserializer = new GeneratorActionDeserializer();
                        return generatorActionDeserializer.deserialize(parser, deserializationContext);
                    default:
