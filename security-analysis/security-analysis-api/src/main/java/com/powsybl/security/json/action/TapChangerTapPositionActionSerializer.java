 ...
 */
public class TapChangerTapPositionActionSerializer extends StdSerializer<AbstractTapChangerTapPositionAction> {

    public TapChangerTapPositionActionSerializer() {
        super(AbstractTapChangerTapPositionAction.class);
    }

    @Override
    public void serialize(AbstractTapChangerTapPositionAction action, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
