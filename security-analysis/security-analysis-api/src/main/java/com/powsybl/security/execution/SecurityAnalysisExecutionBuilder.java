...
public class SecurityAnalysisExecutionBuilder {
     ...
     * @param securityAnalysisName The named security-analysis implement to use. If {@literal null}, the default would be used
    ...
    public SecurityAnalysisExecutionBuilder(Supplier<ExternalSecurityAnalysisConfig> externalConfig,
                                            @Nullable String securityAnalysisName,
    ...
    public SecurityAnalysisExecution build() {
        if (forward) {
            ...
            return new SecurityAnalysisExecutionImpl(securityAnalysisName, inputBuildStrategy());
        }
    }
