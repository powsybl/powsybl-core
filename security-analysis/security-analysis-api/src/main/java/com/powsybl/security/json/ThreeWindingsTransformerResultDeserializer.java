...
public class ThreeWindingsTransformerResultDeserializer extends StdDeserializer<ThreeWindingsTransformerResult> {
    ...
    @Override
    public ThreeWindingsTransformerResult deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JacksonException {
