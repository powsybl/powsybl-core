...
##### Doc
- core grid model: [grid_model/network_subnetwork.html#shunt-compensator](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_model/network_subnetwork.html#shunt-compensator)
- core grid features: [grid_features/loadflow_validation.html#shunts](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_features/loadflow_validation.html#shunts)
- core tool loadflow-validation: [user/itools/loadflow-validation.html#shunt-compensator](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/user/itools/loadflow-validation.html#shunt-compensator)
#### Notes
...
- Added util methods in ValidationUtils
    - `isUndefinedOrZero`
    - `isOutsideTolerance`
...
##### Doc
- core grid model: [grid_model/network_subnetwork.html#static-var-compensator](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_model/network_subnetwork.html#static-var-compensator)
- core grid features: [grid_features/loadflow_validation.html#static-var-compensators](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_features/loadflow_validation.html#static-var-compensators)
- core tool loadflow-validation: [user/itools/loadflow-validation.html#static-var-compensators](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/user/itools/loadflow-validation.html#static-var-compensators)
...
##### Doc
- core grid model: [grid_model/network_subnetwork.html#generator](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_model/network_subnetwork.html#generator)
- core grid features: [grid_features/loadflow_validation.html#generators](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_features/loadflow_validation.html#generators)
- core tool loadflow-validation: [user/itools/loadflow-validation.html#generators](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/user/itools/loadflow-validation.html#generators)
##### Notes (draft) 
...
##### Doc
- core grid model: ..
- core grid features: [grid_features/loadflow_validation.html#buses](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_features/loadflow_validation.html#buses)
- core tool loadflow-validation: [user/itools/loadflow-validation.html#buses](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/user/itools/loadflow-validation.html#buses)
##### Notes
> [!NOTE]
...
- Branch: equipment with two terminals. Line, TieLine, TwoWindingsTransformer
- Rules for valid results:
  - Rule 1: **checks disconnected terminals** 
    - Checks disconnected **terminal 1**: P and Q must be NaN or ~0 
    - Checks disconnected **terminal 2**: P and Q must be NaN or ~0
  - Rule 2: **checks connected terminals**
    - checks connected terminal: |P - Pcalc| <= ε and |Q - Qcalc| <= ε
    - checks connected terminal: |P - Pcalc| <= ε and |Q - Qcalc| <= ε
##### Doc
- core grid model: ..
- core grid features: [grid_features/loadflow_validation.html#branches](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_features/loadflow_validation.html#branches)
- core tool loadflow-validation: [user/itools/loadflow-validation.html#branches](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/user/itools/loadflow-validation.html#branches)
##### Notes (draft)
- Flows (BranchData) can be constructed from
    - Line Flows => Line specific rules
    - TwoWindingsTransformer Flows => TWT specific rules
    - TieLine Flows => TieLine specific rules
##### Actions
- Refactor (to be done in https://github.com/powsybl/powsybl-core/pull/3683)
### Transformers (TWT) validation 

Doc up to date
##### Doc
- core grid model: [grid_model/network_subnetwork.html#two-winding-transformer](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_model/network_subnetwork.html#two-winding-transformer)
- core grid features: [grid_features/loadflow_validation.html#transformers-with-a-ratio-tap-changer](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_features/loadflow_validation.html#transformers-with-a-ratio-tap-changer)
- core tool loadflow-validation: [user/itools/loadflow-validation.html#transformers-with-a-ratio-tap-changer](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/user/itools/loadflow-validation.html#transformers-with-a-ratio-tap-changer)
...
##### Doc
- core grid model: [grid_model/network_subnetwork.html#three-winding-transformer](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_model/network_subnetwork.html#three-winding-transformer)
- core grid features: [grid_features/loadflow_validation.html#three-winding-transformers](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/grid_features/loadflow_validation.html#three-winding-transformers)
    - marked "To be implemented, based on a conversion into 3 two-winding transformers." => create issue comple documentation ...
- core tool loadflow-validation: [user/itools/loadflow-validation.html#three-winding-transformers](https://powsybl--3830.org.readthedocs.build/projects/powsybl-core/en/3830/user/itools/loadflow-validation.html#three-winding-transformers)
    - marked "To be implemented but code already validates 3WT" => create issue comple documentation ...
##### Notes
##### Actions
- create issue comple documentation ... (core grid features, core tool loadflow-validation) for Transformers3W 
