...
public class ValidationFormatterCsvMultilineWriterFactory implements ValidationWriterFactory {
    ...
    @Override
    public ValidationWriter create(String id, Class<? extends TableFormatterFactory> formatterFactoryClass, TableFormatterConfig tableFormatterConfig, Writer writer, boolean verbose, ValidationType validationType, boolean compareResults) {
        return new ValidationFormatterCsvMultilineWriter(id, formatterFactoryClass, tableFormatterConfig, writer, verbose, validationType, compareResults);
    }
