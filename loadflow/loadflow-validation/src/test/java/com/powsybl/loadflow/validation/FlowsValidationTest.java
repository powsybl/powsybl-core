...
public class FlowsValidationTest extends AbstractValidationTest {
    ...
    public void checkFlows() {
        ...
        assertTrue(FlowsValidation.checkFlows(new BranchData("test", r, x, rho1, rho2, u1, u2, theta1, theta2, alpha1, alpha2, g1, g2, b1, b2, p1, q1, p2, q2, connected1, connected2,
                                              mainComponent1, mainComponent2, looseConfig.getEpsilonX(), looseConfig.applyReactanceCorrection()), looseConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertFalse(FlowsValidation.checkFlows(new BranchData("test", r, x, rho1, rho2, u1, u2, theta1, theta2, alpha1, alpha2, g1, g2, b1, b2, p1, q1, p2, q2, connected1, connected2,
                                               mainComponent1, mainComponent2, strictConfig.getEpsilonX(), strictConfig.applyReactanceCorrection()), strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        ...
        assertTrue(FlowsValidation.checkFlows(new BranchData("test", r, x, rho1, rho2, Double.NaN, u2, Double.NaN, theta2, alpha1, alpha2, g1, g2, b1, b2, Double.NaN, Double.NaN, 0f, 0f, false, connected2,
                                            mainComponent1, mainComponent2, looseConfig.getEpsilonX(), looseConfig.applyReactanceCorrection()), looseConfig, tableFormatterConfig, new PrintWriter(System.err)));
        ...
        assertTrue(FlowsValidation.checkFlows(new BranchData("test", r, x, rho1, rho2, Double.NaN, Double.NaN, Double.NaN, Double.NaN, alpha1, alpha2, g1, g2, b1, b2, Float.NaN, Float.NaN, Float.NaN, Float.NaN,
                                              false, false, mainComponent1, mainComponent2, looseConfig.getEpsilonX(), looseConfig.applyReactanceCorrection()), looseConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
    ...
    public void checkLineFlows() {
        assertTrue(FlowsValidation.checkFlows(line1, looseConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertFalse(FlowsValidation.checkFlows(line1, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        ...
        assertTrue(FlowsValidation.checkFlows(line1, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
    }

    @Test
    public void checkTransformerFlows() {
        assertTrue(FlowsValidation.checkFlows(transformer1, looseConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertFalse(FlowsValidation.checkFlows(transformer1, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        Mockito.when(bus1.isInMainConnectedComponent()).thenReturn(false);
        Mockito.when(bus2.isInMainConnectedComponent()).thenReturn(false);
        assertTrue(FlowsValidation.checkFlows(transformer1, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
    }

    @Test
    public void checkTransformerFlowsSpecificCompatibility() {
        assertTrue(FlowsValidation.checkFlows(transformer1, looseConfigSpecificCompatibility, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertFalse(FlowsValidation.checkFlows(transformer1, strictConfigSpecificCompatibility, tableFormatterConfig, NullWriter.NULL_WRITER));
    }
    ...
    public void checkNetworkFlows() throws IOException {
        ...
        assertTrue(FlowsValidation.checkFlows(transformer2, looseConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertFalse(FlowsValidation.checkFlows(transformer2, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        ...
        assertTrue(FlowsValidation.checkFlows(network, looseConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertFalse(FlowsValidation.checkFlows(network, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));

        assertTrue(ValidationType.FLOWS.check(network, looseConfig, tableFormatterConfig, path));
        assertFalse(ValidationType.FLOWS.check(network, strictConfig, tableFormatterConfig, path));

        ValidationWriter validationWriter = ValidationUtils.createValidationWriter(network.getId(), looseConfig, tableFormatterConfig, NullWriter.NULL_WRITER, ValidationType.FLOWS);
