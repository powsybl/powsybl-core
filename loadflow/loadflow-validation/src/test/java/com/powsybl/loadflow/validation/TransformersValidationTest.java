...
public class TransformersValidationTest extends AbstractValidationTest {
    ...
    public void checkTwtsValues() {
        assertTrue(TransformersValidation.checkTransformer("test", rho, rhoPreviousStep, rhoNextStep, tapPosition, lowTapPosition, highTapPosition,
                                                            targetV, regulatedSide, v, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        ...
        assertFalse(TransformersValidation.checkTransformer("test", rho, rhoPreviousStep, rhoNextStep, tapPosition, lowTapPosition, highTapPosition,
                                                             targetV, regulatedSide, lowV, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        ...
        assertFalse(TransformersValidation.checkTransformer("test", rho, rhoPreviousStep, rhoNextStep, tapPosition, lowTapPosition, highTapPosition,
                                                             targetV, regulatedSide, highV, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        ...
        // check NaN vales
        assertFalse(TransformersValidation.checkTransformer("test", rho, rhoPreviousStep, rhoNextStep, tapPosition, lowTapPosition, highTapPosition,
                                                             Float.NaN, regulatedSide, v, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertFalse(TransformersValidation.checkTransformer("test", rho, rhoPreviousStep, rhoNextStep, tapPosition, lowTapPosition, highTapPosition,
                                                             targetV, regulatedSide, Float.NaN, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
    }

    @Test
    public void checkTwts() {
        assertTrue(TransformersValidation.checkTransformer(transformer, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        Mockito.when(bus.getV()).thenReturn(highV);
        assertFalse(TransformersValidation.checkTransformer(transformer, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
    }
    ...
    public void checkNetworkTwts() throws IOException {
        ...
        assertTrue(TransformersValidation.checkTransformers(network, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertTrue(ValidationType.TWTS.check(network, strictConfig, tableFormatterConfig, path));

        ValidationWriter validationWriter = ValidationUtils.createValidationWriter(network.getId(), strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER, ValidationType.TWTS);
