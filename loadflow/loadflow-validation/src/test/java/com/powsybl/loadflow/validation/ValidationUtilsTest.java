...
public class ValidationUtilsTest extends AbstractValidationTest {
    ...
    public void boundedWithin() {
        assertTrue(ValidationUtils.boundedWithin(0.0, 10.0, 5.0, 0f));
        assertFalse(ValidationUtils.boundedWithin(0.0, 10.0, -5.0, 0f));
        assertFalse(ValidationUtils.boundedWithin(0.0, 10.0, 15.0, 0f));

        assertFalse(ValidationUtils.boundedWithin(0.0, 10.0, Double.NaN, 0f));
        assertFalse(ValidationUtils.boundedWithin(Double.NaN, Double.NaN, 5.0, 0f));

        assertTrue(ValidationUtils.boundedWithin(Double.NaN, 10.0, 5.0, 0f));
        assertFalse(ValidationUtils.boundedWithin(Double.NaN, 10.0, 15.0, 0f));

        assertTrue(ValidationUtils.boundedWithin(0.0, Double.NaN, 5.0, 0f));
        assertFalse(ValidationUtils.boundedWithin(0.0, Double.NaN, -5.0, 0f));
    }
