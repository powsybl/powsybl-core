...
public class TwtTestData {
    ...
    public static final double P1 = 99.218431;
    public static final double Q1 = 2.7304328;
    public static final double P2 = -216.19819;
    public static final double Q2 = -85.368180;
    public static final double P3 = 118;
    public static final double Q3 = 92.612077;

    public static final double COMPUTED_P1 = 99.227288294050368;
    public static final double COMPUTED_Q1 = 2.747147185209846;
    public static final double COMPUTED_P2 = -216.195866533486196;
    public static final double COMPUTED_Q2 = -85.490493190353362;
    public static final double COMPUTED_P3 = 117.988318295632794;
    public static final double COMPUTED_Q3 = 92.500849015581423;

    public static final double U1 = 412.989001;
    public static final double ANGLE1 = -6.78071;
    public static final double U2 = 224.315268;
    public static final double ANGLE2 = -8.77012;
    public static final double U3 = 21.987;
    public static final double ANGLE3 = -6.6508;

    public static final double STAR_U = 412.662007016922757;
    public static final double STAR_ANGLE = -7.353686938578365;

    public static final double R1 = 0.898462;
    public static final double X1 = 17.204128;
    public static final double G11 = 0;
    public static final double B11 = 2.4375E-6;
    public static final double G12 = 0;
    public static final double B12 = 0;
    public static final double RATED_U1 = 400;
    public static final double R2 = 1.070770247933884;
    public static final double X2 = 19.6664;
    public static final double G21 = 0;
    public static final double B21 = 0;
    public static final double G22 = 0;
    public static final double B22 = 0;
    public static final double RATED_U2 = 220;
    public static final double R3 = 4.837006802721089;
    public static final double X3 = 21.76072562358277;
    public static final double G31 = 0;
    public static final double B31 = 0;
    public static final double G32 = 0;
    public static final double B32 = 0;
    public static final double RATED_U3 = 21;
    public static final int PHASE_ANGLE_CLOCK_2 = 0;
    public static final int PHASE_ANGLE_CLOCK_3 = 0;
    public static final double RATED_U0 = RATED_U1;

    public static final boolean CONNECTED1 = true;
    public static final boolean CONNECTED2 = true;
    public static final boolean CONNECTED3 = true;
    public static final boolean MAIN_COMPONENT1 = true;
    public static final boolean MAIN_COMPONENT2 = true;
    public static final boolean MAIN_COMPONENT3 = true;

    private final Terminal leg1Terminal;
    private final Terminal leg2Terminal;
    private final Terminal leg3Terminal;
    private final ThreeWindingsTransformer twt3w;
