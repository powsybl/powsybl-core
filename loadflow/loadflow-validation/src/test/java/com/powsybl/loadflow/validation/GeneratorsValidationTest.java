...
public class GeneratorsValidationTest extends AbstractValidationTest {
    ...
    public void checkGeneratorsValues() {
        ...
        assertTrue(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, targetV, voltageRegulatorOn, minP, maxP, minQ, maxQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        p = -39.8;
        assertFalse(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, targetV, voltageRegulatorOn, minP, maxP, minQ, maxQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        p = -39.5056;
        assertTrue(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, targetV, voltageRegulatorOn, minP, maxP, minQ, maxQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        // check with NaN values
        assertFalse(GeneratorsValidation.checkGenerators("test", p, q, v, Float.NaN, targetQ, targetV, voltageRegulatorOn, minP, maxP, minQ, maxQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        strictConfig.setOkMissingValues(true);
        assertTrue(GeneratorsValidation.checkGenerators("test", p, q, v, Float.NaN, targetQ, targetV, voltageRegulatorOn, minP, maxP, minQ, maxQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        ...
        q = 3.7;
        assertFalse(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, targetV, voltageRegulatorOn, minP, maxP, minQ, maxQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertTrue(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, targetV, voltageRegulatorOn, minP, maxP, minQ, maxQ, connected, mainComponent, looseConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        // check with NaN values
        assertFalse(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, Float.NaN, targetV, voltageRegulatorOn, minP, maxP, minQ, maxQ, connected, mainComponent, looseConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        looseConfig.setOkMissingValues(true);
        assertTrue(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, Float.NaN, targetV, voltageRegulatorOn, minP, maxP, minQ, maxQ, connected, mainComponent, looseConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        ...
        // check with NaN values
        v = 380;
        assertFalse(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, targetV, voltageRegulatorOn, minP, maxP, Float.NaN, maxQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertFalse(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, targetV, voltageRegulatorOn, minP, maxP, minQ, Float.NaN, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertFalse(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, Float.NaN, voltageRegulatorOn, minP, maxP, minQ, maxQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        strictConfig.setOkMissingValues(true);
        assertTrue(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, targetV, voltageRegulatorOn, minP, maxP, Float.NaN, maxQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertTrue(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, targetV, voltageRegulatorOn, minP, maxP, minQ, Float.NaN, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        assertTrue(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, Float.NaN, voltageRegulatorOn, minP, maxP, minQ, maxQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        strictConfig.setOkMissingValues(false);
        ...
        assertTrue(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, targetV, voltageRegulatorOn, minP, maxP, maxQ, minQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        ...
        assertFalse(GeneratorsValidation.checkGenerators("test", p, q, v, targetP, targetQ, targetV, voltageRegulatorOn, minP, maxP, maxQ, minQ, connected, mainComponent, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
    ...
    public void checkGenerators() {
        // active power should be equal to setpoint
        assertTrue(GeneratorsValidation.checkGenerators(generator, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
        Mockito.when(genTerminal.getP()).thenReturn(-39.8);
        assertFalse(GeneratorsValidation.checkGenerators(generator, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
    ...
    public void checkNetworkGenerators() throws IOException {
        ...
        assertTrue(GeneratorsValidation.checkGenerators(generator1, strictConfig, tableFormatterConfig, NullWriter.NULL_WRITER));
