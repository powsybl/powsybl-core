...
public class GeneratorsValidationTest extends AbstractValidationTest {
    ...
    public void setUp() throws IOException {
        ...
        Mockito.when(generator.isVoltageRegulatorOn()).thenReturn(Optional.of(false));
    ...
    public void checkNetworkGenerators() throws IOException {
        ...
        Mockito.when(generator1.isVoltageRegulatorOn()).thenReturn(Optional.of(false));
        ...
        Mockito.when(generator2.isVoltageRegulatorOn()).thenReturn(Optional.of(false));
