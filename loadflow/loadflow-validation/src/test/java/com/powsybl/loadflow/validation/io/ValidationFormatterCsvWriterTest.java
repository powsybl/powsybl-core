    ...
    protected String getTwts3wVerboseContent() {
        return String.join(System.lineSeparator(),
                ...
                String.join(";", "id", AbstractValidationFormatterWriter.NETWORK_P1, AbstractValidationFormatterWriter.EXPECTED_P1,
                            ...
                            AbstractValidationFormatterWriter.THETA3, "starTheta", "g", "b", "r1", "r2", "r3", "x1", "x2", "x3",
                ...
                String.join(";", twt3wId,
                            ...
                            String.format(Locale.getDefault(), "%g", Twt3wTestData.U3), String.format(Locale.getDefault(), "%g", Twt3wTestData.STAR_U),
                            String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE1)), String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE2)),
                            String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE3)), String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.STAR_ANGLE)),
