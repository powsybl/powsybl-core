...
public class ValidationFormatterCsvWriterTest extends AbstractValidationFormatterWriterTest {
    ...
    private final ValidationWriterFactory factory = new ValidationFormatterCsvWriterFactory();
    ...
    protected String getTwts3wVerboseContent() {
        return String.join(System.lineSeparator(),
                ...
                String.join(";", "id", AbstractValidationFormatterWriter.NETWORK_P1, AbstractValidationFormatterWriter.EXPECTED_P1,
                            ...
                            AbstractValidationFormatterWriter.THETA3, "starTheta", "g1", "b1", "g2", "b2",
                            "g3", "b3", "r1", "r2", "r3", "x1", "x2", "x3",
                ...
                String.join(";", twt3wId,
                            ...
                            String.format(Locale.getDefault(), "%g", TwtTestData.G1), String.format(Locale.getDefault(), "%g", TwtTestData.B1),
                            String.format(Locale.getDefault(), "%g", TwtTestData.G2), String.format(Locale.getDefault(), "%g", TwtTestData.B2),
                            String.format(Locale.getDefault(), "%g", TwtTestData.G3), String.format(Locale.getDefault(), "%g", TwtTestData.B3),
                            ...
                            String.format(Locale.getDefault(), "%g", TwtTestData.RATED_U3), Boolean.toString(TwtTestData.CONNECTED1),
    ...
    protected String getTwts3wCompareVerboseContent() {
        return String.join(System.lineSeparator(),
                ...
                String.join(";", "id", AbstractValidationFormatterWriter.NETWORK_P1, AbstractValidationFormatterWriter.EXPECTED_P1,
                            ...
                            "g1" + AbstractValidationFormatterWriter.POST_COMPUTATION_SUFFIX, "b1" + AbstractValidationFormatterWriter.POST_COMPUTATION_SUFFIX,
                            "g2" + AbstractValidationFormatterWriter.POST_COMPUTATION_SUFFIX, "b2" + AbstractValidationFormatterWriter.POST_COMPUTATION_SUFFIX,
                            "g3" + AbstractValidationFormatterWriter.POST_COMPUTATION_SUFFIX, "b3" + AbstractValidationFormatterWriter.POST_COMPUTATION_SUFFIX,
