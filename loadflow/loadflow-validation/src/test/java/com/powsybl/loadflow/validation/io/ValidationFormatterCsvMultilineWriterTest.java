...
public class ValidationFormatterCsvMultilineWriterTest extends AbstractValidationFormatterWriterTest {
    ...
    protected String getTwts3wContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            String.join(";", "id", "characteristic", "value"),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_P1, String.format(Locale.getDefault(), "%g", Twt3wTestData.P1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_P1, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_Q1, String.format(Locale.getDefault(), "%g", Twt3wTestData.Q1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_Q1, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_P2, String.format(Locale.getDefault(), "%g", Twt3wTestData.P2)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_P2, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P2)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_Q2, String.format(Locale.getDefault(), "%g", Twt3wTestData.Q2)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_Q2, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q2)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_P3, String.format(Locale.getDefault(), "%g", Twt3wTestData.P3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_P3, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_Q3, String.format(Locale.getDefault(), "%g", Twt3wTestData.Q3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_Q3, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q3)));
    }
    ...
    protected String getTwts3wVerboseContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            ...
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_Q3, String.format(Locale.getDefault(), "%g", Twt3wTestData.Q3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_Q3, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q3)),
                            String.join(";", twt3wId, "u1", String.format(Locale.getDefault(), "%g", Twt3wTestData.U1)),
                            String.join(";", twt3wId, "u2", String.format(Locale.getDefault(), "%g", Twt3wTestData.U2)),
                            String.join(";", twt3wId, "u3", String.format(Locale.getDefault(), "%g", Twt3wTestData.U3)),
                            String.join(";", twt3wId, "starU", String.format(Locale.getDefault(), "%g", Twt3wTestData.STAR_U)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.THETA1, String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE1))),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.THETA2, String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE2))),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.THETA3, String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE3))),
                            String.join(";", twt3wId, "starTheta", String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.STAR_ANGLE))),
                            String.join(";", twt3wId, "g", String.format(Locale.getDefault(), "%g", Twt3wTestData.G)),
                            String.join(";", twt3wId, "b", String.format(Locale.getDefault(), "%g", Twt3wTestData.B)),
                            String.join(";", twt3wId, "r1", String.format(Locale.getDefault(), "%g", Twt3wTestData.R1)),
                            String.join(";", twt3wId, "r2", String.format(Locale.getDefault(), "%g", Twt3wTestData.R2)),
                            String.join(";", twt3wId, "r3", String.format(Locale.getDefault(), "%g", Twt3wTestData.R3)),
                            String.join(";", twt3wId, "x1", String.format(Locale.getDefault(), "%g", Twt3wTestData.X1)),
                            String.join(";", twt3wId, "x2", String.format(Locale.getDefault(), "%g", Twt3wTestData.X2)),
                            String.join(";", twt3wId, "x3", String.format(Locale.getDefault(), "%g", Twt3wTestData.X3)),
                            String.join(";", twt3wId, "ratedU1", String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U1)),
                            String.join(";", twt3wId, "ratedU2", String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U2)),
                            String.join(";", twt3wId, "ratedU3", String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.CONNECTED + "1", Boolean.toString(Twt3wTestData.CONNECTED1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.CONNECTED + "2", Boolean.toString(Twt3wTestData.CONNECTED2)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.CONNECTED + "3", Boolean.toString(Twt3wTestData.CONNECTED3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.MAIN_COMPONENT + "1", Boolean.toString(Twt3wTestData.MAIN_COMPONENT1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.MAIN_COMPONENT + "2", Boolean.toString(Twt3wTestData.MAIN_COMPONENT1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.MAIN_COMPONENT + "3", Boolean.toString(Twt3wTestData.MAIN_COMPONENT1)),
    ...
    protected String getTwts3wCompareContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            String.join(";", "id", "characteristic", "value", "value" + AbstractValidationFormatterWriter.POST_COMPUTATION_SUFFIX),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_P1, String.format(Locale.getDefault(), "%g", Twt3wTestData.P1),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.P1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_P1, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P1),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_Q1, String.format(Locale.getDefault(), "%g", Twt3wTestData.Q1),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.Q1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_Q1, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q1),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_P2, String.format(Locale.getDefault(), "%g", Twt3wTestData.P2),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.P2)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_P2, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P2),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P2)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_Q2, String.format(Locale.getDefault(), "%g", Twt3wTestData.Q2),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.Q2)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_Q2, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q2),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q2)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_P3, String.format(Locale.getDefault(), "%g", Twt3wTestData.P3),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.P3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_P3, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P3),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_Q3, String.format(Locale.getDefault(), "%g", Twt3wTestData.Q3),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.Q3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_Q3, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q3),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q3)));
    }
    ...
    protected String getTwts3wCompareDifferentIdsContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            String.join(";", "id", "characteristic", "value", "value" + AbstractValidationFormatterWriter.POST_COMPUTATION_SUFFIX),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.NETWORK_P1, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.P1)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.EXPECTED_P1, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P1)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.NETWORK_Q1, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.Q1)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.EXPECTED_Q1, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q1)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.NETWORK_P2, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.P2)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.EXPECTED_P2, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P2)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.NETWORK_Q2, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.Q2)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.EXPECTED_Q2, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q2)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.NETWORK_P3, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.P3)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.EXPECTED_P3, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P3)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.NETWORK_Q3, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.Q3)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.EXPECTED_Q3, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_P1, String.format(Locale.getDefault(), "%g", Twt3wTestData.P1), ""),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_P1, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_P1), ""),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.NETWORK_Q1, String.format(Locale.getDefault(), "%g", Twt3wTestData.Q1), ""),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_Q1, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q1), ""),
    ...
    protected String getTwts3wCompareVerboseContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            ...
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.EXPECTED_Q3, String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q3),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q3)),
                            String.join(";", twt3wId, "u1", String.format(Locale.getDefault(), "%g", Twt3wTestData.U1), String.format(Locale.getDefault(), "%g", Twt3wTestData.U1)),
                            String.join(";", twt3wId, "u2", String.format(Locale.getDefault(), "%g", Twt3wTestData.U2), String.format(Locale.getDefault(), "%g", Twt3wTestData.U2)),
                            String.join(";", twt3wId, "u3", String.format(Locale.getDefault(), "%g", Twt3wTestData.U3), String.format(Locale.getDefault(), "%g", Twt3wTestData.U3)),
                            String.join(";", twt3wId, "starU", String.format(Locale.getDefault(), "%g", Twt3wTestData.STAR_U), String.format(Locale.getDefault(), "%g", Twt3wTestData.STAR_U)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.THETA1, String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE1)),
                                        String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE1))),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.THETA2, String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE2)),
                                        String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE2))),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.THETA3, String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE3)),
                                        String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE3))),
                            String.join(";", twt3wId, "starTheta", String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.STAR_ANGLE)),
                                        String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.STAR_ANGLE))),
                            String.join(";", twt3wId, "g", String.format(Locale.getDefault(), "%g", Twt3wTestData.G), String.format(Locale.getDefault(), "%g", Twt3wTestData.G)),
                            String.join(";", twt3wId, "b", String.format(Locale.getDefault(), "%g", Twt3wTestData.B), String.format(Locale.getDefault(), "%g", Twt3wTestData.B)),
                            String.join(";", twt3wId, "r1", String.format(Locale.getDefault(), "%g", Twt3wTestData.R1), String.format(Locale.getDefault(), "%g", Twt3wTestData.R1)),
                            String.join(";", twt3wId, "r2", String.format(Locale.getDefault(), "%g", Twt3wTestData.R2), String.format(Locale.getDefault(), "%g", Twt3wTestData.R2)),
                            String.join(";", twt3wId, "r3", String.format(Locale.getDefault(), "%g", Twt3wTestData.R3), String.format(Locale.getDefault(), "%g", Twt3wTestData.R3)),
                            String.join(";", twt3wId, "x1", String.format(Locale.getDefault(), "%g", Twt3wTestData.X1), String.format(Locale.getDefault(), "%g", Twt3wTestData.X1)),
                            String.join(";", twt3wId, "x2", String.format(Locale.getDefault(), "%g", Twt3wTestData.X2), String.format(Locale.getDefault(), "%g", Twt3wTestData.X2)),
                            String.join(";", twt3wId, "x3", String.format(Locale.getDefault(), "%g", Twt3wTestData.X3), String.format(Locale.getDefault(), "%g", Twt3wTestData.X3)),
                            String.join(";", twt3wId, "ratedU1", String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U1),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U1)),
                            String.join(";", twt3wId, "ratedU2", String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U2),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U2)),
                            String.join(";", twt3wId, "ratedU3", String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U3),
                                        String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.CONNECTED + "1", Boolean.toString(Twt3wTestData.CONNECTED1),
                                        Boolean.toString(Twt3wTestData.CONNECTED1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.CONNECTED + "2", Boolean.toString(Twt3wTestData.CONNECTED2),
                                        Boolean.toString(Twt3wTestData.CONNECTED2)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.CONNECTED + "3", Boolean.toString(Twt3wTestData.CONNECTED3),
                                        Boolean.toString(Twt3wTestData.CONNECTED3)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.MAIN_COMPONENT + "1", Boolean.toString(Twt3wTestData.MAIN_COMPONENT1),
                                        Boolean.toString(Twt3wTestData.MAIN_COMPONENT1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.MAIN_COMPONENT + "2", Boolean.toString(Twt3wTestData.MAIN_COMPONENT1),
                                        Boolean.toString(Twt3wTestData.MAIN_COMPONENT1)),
                            String.join(";", twt3wId, AbstractValidationFormatterWriter.MAIN_COMPONENT + "3", Boolean.toString(Twt3wTestData.MAIN_COMPONENT1),
                                        Boolean.toString(Twt3wTestData.MAIN_COMPONENT1)),
    ...
    protected String getTwts3wCompareDifferentIdsVerboseContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            ...
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.NETWORK_Q3, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.Q3)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.EXPECTED_Q3, "", String.format(Locale.getDefault(), "%g", Twt3wTestData.COMPUTED_Q3)),
                            String.join(";", otherTwt3wId, "u1", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.U1)),
                            String.join(";", otherTwt3wId, "u2", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.U2)),
                            String.join(";", otherTwt3wId, "u3", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.U3)),
                            String.join(";", otherTwt3wId, "starU", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.STAR_U)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.THETA1, "", String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE1))),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.THETA2, "", String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE2))),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.THETA3, "", String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.ANGLE3))),
                            String.join(";", otherTwt3wId, "starTheta", "", String.format(Locale.getDefault(), "%g", Math.toRadians(Twt3wTestData.STAR_ANGLE))),
                            String.join(";", otherTwt3wId, "g", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.G)),
                            String.join(";", otherTwt3wId, "b", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.B)),
                            String.join(";", otherTwt3wId, "r1", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.R1)),
                            String.join(";", otherTwt3wId, "r2", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.R2)),
                            String.join(";", otherTwt3wId, "r3", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.R3)),
                            String.join(";", otherTwt3wId, "x1", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.X1)),
                            String.join(";", otherTwt3wId, "x2", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.X2)),
                            String.join(";", otherTwt3wId, "x3", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.X3)),
                            String.join(";", otherTwt3wId, "ratedU1", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U1)),
                            String.join(";", otherTwt3wId, "ratedU2", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U2)),
                            String.join(";", otherTwt3wId, "ratedU3", "", String.format(Locale.getDefault(), "%g", Twt3wTestData.RATED_U3)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.CONNECTED + "1", "", Boolean.toString(Twt3wTestData.CONNECTED1)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.CONNECTED + "2", "", Boolean.toString(Twt3wTestData.CONNECTED2)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.CONNECTED + "3", "", Boolean.toString(Twt3wTestData.CONNECTED3)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.MAIN_COMPONENT + "1", "", Boolean.toString(Twt3wTestData.MAIN_COMPONENT1)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.MAIN_COMPONENT + "2", "", Boolean.toString(Twt3wTestData.MAIN_COMPONENT1)),
                            String.join(";", otherTwt3wId, AbstractValidationFormatterWriter.MAIN_COMPONENT + "3", "", Boolean.toString(Twt3wTestData.MAIN_COMPONENT1)),
