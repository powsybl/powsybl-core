...
public class ValidationFormatterCsvMultilineWriterTest extends AbstractValidationFormatterWriterTest {
    ...
    protected String getBusesVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", busId, "danglingLineP", String.format(Locale.getDefault(), "%g", boundaryLineP)),
                           String.join(";", busId, "danglingLineQ", String.format(Locale.getDefault(), "%g", boundaryLineQ)),
    ...
    protected String getBusesCompareVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", busId, "danglingLineP", String.format(Locale.getDefault(), "%g", boundaryLineP), String.format(Locale.getDefault(), "%g", boundaryLineP)),
                           String.join(";", busId, "danglingLineQ", String.format(Locale.getDefault(), "%g", boundaryLineQ), String.format(Locale.getDefault(), "%g", boundaryLineQ)),
    ...
    protected String getBusesCompareDifferentIdsVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", otherBusId, "danglingLineP", "", String.format(Locale.getDefault(), "%g", boundaryLineP)),
                           String.join(";", otherBusId, "danglingLineQ", "", String.format(Locale.getDefault(), "%g", boundaryLineQ)),
