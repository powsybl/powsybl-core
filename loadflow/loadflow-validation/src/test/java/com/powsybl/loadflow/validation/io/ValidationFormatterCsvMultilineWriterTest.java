    ...
    protected String getTwts3wVerboseContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            ...
                            String.join(";", twt3wId, "g1", String.format(Locale.getDefault(), "%g", TwtTestData.G1)),
                            String.join(";", twt3wId, "b1", String.format(Locale.getDefault(), "%g", TwtTestData.B1)),
                            String.join(";", twt3wId, "g2", String.format(Locale.getDefault(), "%g", TwtTestData.G2)),
                            String.join(";", twt3wId, "b2", String.format(Locale.getDefault(), "%g", TwtTestData.B2)),
                            String.join(";", twt3wId, "g3", String.format(Locale.getDefault(), "%g", TwtTestData.G3)),
                            String.join(";", twt3wId, "b3", String.format(Locale.getDefault(), "%g", TwtTestData.B3)),
    ...
    protected String getTwts3wCompareVerboseContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            ...
                            String.join(";", twt3wId, "g1", String.format(Locale.getDefault(), "%g", TwtTestData.G1), String.format(Locale.getDefault(), "%g", TwtTestData.G1)),
                            String.join(";", twt3wId, "b1", String.format(Locale.getDefault(), "%g", TwtTestData.B1), String.format(Locale.getDefault(), "%g", TwtTestData.B1)),
                            String.join(";", twt3wId, "g2", String.format(Locale.getDefault(), "%g", TwtTestData.G2), String.format(Locale.getDefault(), "%g", TwtTestData.G2)),
                            String.join(";", twt3wId, "b2", String.format(Locale.getDefault(), "%g", TwtTestData.B2), String.format(Locale.getDefault(), "%g", TwtTestData.B2)),
                            String.join(";", twt3wId, "g3", String.format(Locale.getDefault(), "%g", TwtTestData.G3), String.format(Locale.getDefault(), "%g", TwtTestData.G3)),
                            String.join(";", twt3wId, "b3", String.format(Locale.getDefault(), "%g", TwtTestData.B3), String.format(Locale.getDefault(), "%g", TwtTestData.B3)),
    ...
    protected String getTwts3wCompareDifferentIdsVerboseContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            ...
                            String.join(";", otherTwt3wId, "g1", "", String.format(Locale.getDefault(), "%g", TwtTestData.G1)),
                            String.join(";", otherTwt3wId, "b1", "", String.format(Locale.getDefault(), "%g", TwtTestData.B1)),
                            String.join(";", otherTwt3wId, "g2", "", String.format(Locale.getDefault(), "%g", TwtTestData.G2)),
                            String.join(";", otherTwt3wId, "b2", "", String.format(Locale.getDefault(), "%g", TwtTestData.B2)),
                            String.join(";", otherTwt3wId, "g3", "", String.format(Locale.getDefault(), "%g", TwtTestData.G3)),
                            String.join(";", otherTwt3wId, "b3", "", String.format(Locale.getDefault(), "%g", TwtTestData.B3)),
