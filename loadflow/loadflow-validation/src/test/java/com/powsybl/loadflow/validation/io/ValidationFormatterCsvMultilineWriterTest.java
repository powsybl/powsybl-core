    ...
    protected String getTwts3wVerboseContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            ...
                            String.join(";", twt3wId, "g", String.format(Locale.getDefault(), "%g", TwtTestData.G)),
                            String.join(";", twt3wId, "b", String.format(Locale.getDefault(), "%g", TwtTestData.B)),
    ...
    protected String getTwts3wCompareVerboseContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            ...
                            String.join(";", twt3wId, "g", String.format(Locale.getDefault(), "%g", TwtTestData.G), String.format(Locale.getDefault(), "%g", TwtTestData.G)),
                            String.join(";", twt3wId, "b", String.format(Locale.getDefault(), "%g", TwtTestData.B), String.format(Locale.getDefault(), "%g", TwtTestData.B)),
    ...
    protected String getTwts3wCompareDifferentIdsVerboseContent() {
        return String.join(System.lineSeparator(),
                           "test " + ValidationType.TWTS3W + " check",
                            ...
                            String.join(";", otherTwt3wId, "g", "", String.format(Locale.getDefault(), "%g", TwtTestData.G)),
                            String.join(";", otherTwt3wId, "b", "", String.format(Locale.getDefault(), "%g", TwtTestData.B)),
