...
public class ValidationFormatterCsvMultilineWriterTest extends AbstractValidationFormatterWriterTest {
    ...
    protected String getFlowsCompareVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", branchId, "connected1", Boolean.toString(connected1), Boolean.toString(connected1)),
                           String.join(";", branchId, "connected2", Boolean.toString(connected2), Boolean.toString(connected2)),
                           String.join(";", branchId, "mainComponent1", Boolean.toString(mainComponent1), Boolean.toString(mainComponent1)),
                           String.join(";", branchId, "mainComponent2", Boolean.toString(mainComponent2), Boolean.toString(mainComponent2)),
    ...
    protected String getFlowsCompareDifferentIdsVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", otherBranchId, "connected1", "", Boolean.toString(connected1)),
                           String.join(";", otherBranchId, "connected2", "", Boolean.toString(connected2)),
                           String.join(";", otherBranchId, "mainComponent1", "", Boolean.toString(mainComponent1)),
                           String.join(";", otherBranchId, "mainComponent2", "", Boolean.toString(mainComponent2)),
    ...
    protected String getShuntsCompareVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", shuntId, "nominalV", String.format(Locale.getDefault(), "%g", nominalV), String.format(Locale.getDefault(), "%g", nominalV)),
    ...
    protected String getShuntsCompareDifferentIdsVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", otherShuntId, "nominalV", "", String.format(Locale.getDefault(), "%g", nominalV)),
    ...
    protected String getTwtsVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", twtId, "targetV", String.format(Locale.getDefault(), "%g", twtTargetV)),
    ...
    protected String getTwtsCompareVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", twtId, "targetV", String.format(Locale.getDefault(), "%g", twtTargetV), String.format(Locale.getDefault(), "%g", twtTargetV)),
    ...
    protected String getTwtsCompareDifferentIdsVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", otherTwtId, "targetV", "", String.format(Locale.getDefault(), "%g", twtTargetV)),
