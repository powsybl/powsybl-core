...
public class ValidationFormatterCsvMultilineWriterTest extends AbstractValidationFormatterWriterTest {
    ...
    protected String getGeneratorsVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", generatorId, "regulationMode", genRegulationMode.name()),
    ...
    protected String getGeneratorsCompareVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", generatorId, "regulationMode", genRegulationMode.name(), genRegulationMode.name()),
    ...
    protected String getGeneratorsCompareDifferentIdsVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", otherGeneratorId, "regulationMode", "", genRegulationMode.name()),
    ...
    protected String getSvcsVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", svcId, "regulationMode", svcRegulationMode.name()),
    ...
    protected String getSvcsCompareVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", svcId, "regulationMode", svcRegulationMode.name(), svcRegulationMode.name()),
    ...
    protected String getSvcsCompareDifferentIdsVerboseContent() {
        return String.join(System.lineSeparator(),
                           ...
                           String.join(";", otherSvcId, "regulationMode", "", svcRegulationMode.name()),
