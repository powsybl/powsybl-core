...
public abstract class AbstractLoadFlowResultsCompletionTest {
    ...
    public void setUp() {
        ...
        Mockito.when(step.getG1()).thenReturn(0.0);
        Mockito.when(step.getB1()).thenReturn(0.0);
        ...
        Mockito.when(leg1.getB1()).thenReturn(2.4375E-6);
        Mockito.when(leg1.getG1()).thenReturn(0d);
