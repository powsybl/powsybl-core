 ...
 * Description :
 *
 * This class "RatioTapChanger.java" represents the
...
public class RatioTapChanger extends TapChanger {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(RatioTapChanger.class);
    ...
    */
    ...
    public void setTransformerWinding(
        ...
        if (setInverse) {
            ...
            if (transformerWindingValue != null) {
                transformerWindingValue.setRatioTapChanger(this, false);
            }
        }
    }
     ...
     *
     * @param id
     *            id of the class RatioTapChanger to create
     * @return the class created
     */
    public static RatioTapChanger create(final String id) {
        RatioTapChanger newRatioTapChanger = new RatioTapChanger();
        newRatioTapChanger.setId(id);
    ...
    public void readAttribute(final String class_name, final String attr_name,
        ...
        if (class_name.equals("RatioTapChanger")) {
     ...
     *
     * @param otherRatioTapChanger
     *            the instance to copy
     */
    public void copyBase(final RatioTapChanger otherRatioTapChanger) {
        ...
        if (otherRatioTapChanger.currentBitset.get(0)) {
            TransformerWinding transformerWindingAssociation = otherRatioTapChanger.getTransformerWinding();
     ...
     */
    private RatioTapChanger(final RatioTapChanger otherRatioTapChanger) {
        // TODO : check exception safe
        this.copyBase(otherRatioTapChanger);
    }

   /**
    * Constructor of the class RatioTapChanger
    */
     ...
     */
    public RatioTapChanger clone() {
        RatioTapChanger newInstance = new RatioTapChanger(this);
        RatioTapChanger newInstanceSP = newInstance;
