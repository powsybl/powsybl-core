 ...
 * Description :
 *
 * This class "VoltageControlZone.java" represents the
 * class VoltageControlZone extends IdentifiedObject
 *    + BusbarSection   0..1   BusbarSection 

 */
public class VoltageControlZone extends IdentifiedObject {

    private static Logger LOGGER = LoggerFactory.getLogger(VoltageControlZone.class);

    /**
     * Attribute "busbarSection"
     *
    ...
    /**
     * The id of the attribute "busbarSection"
     * This id is mainly used to resolve links after parsing an instance
     */

    public String idBusbarSection;
    ...
    */
    ...
    /**
     * Utility to return the "busbarSection"
     *
     * @return the value of the attribute "busbarSection"
     */
    ...
    /**
     * Utility to test if the value of "busbarSection" has been set
     *
     * @return boolean
     *            if true the attribute "busbarSection" is already set
     *            if false it isn't yet
     */
    public boolean busbarSectionIsSet() {
        return this.currentBitset.get(0);
    }

    /**
     * Utility to set the "busbarSectionValue"
     *
     * @param busbarSectionValue
     *            instance to set
     * @param setInverse
     ...
     */
    public void setBusbarSection(
            BusbarSection busbarSectionValue,
            boolean setInverse) throws LinkageException {
        this.busbarSection = busbarSectionValue;
        this.currentBitset.set(0);
        if (setInverse) {
            
            if (busbarSectionValue != null) {
                busbarSectionValue.setVoltageControlZone(this, false);
            }
        }
    }
     ...
     *
     * @param id
     *            id of the class VoltageControlZone to create
     * @return the class created
     */
    public static VoltageControlZone create(final String id) {
        VoltageControlZone newVoltageControlZone = new VoltageControlZone();
        newVoltageControlZone.setId(id);
        return newVoltageControlZone;
    }
    ...
    public void readResource(final String class_name,
        ...
        if (class_name.equals("VoltageControlZone")) {
        if (resource_name.equals("BusbarSection")) {
            idBusbarSection = id.substring(1);
    ...
    public void resolveLinks(CIMModel model, CIMModel boundaryModel) throws LinkageException {
        if (idBusbarSection != null) {
            BusbarSection attributeToSet =
                    model.searchBusbarSection
                    (idBusbarSection);
            ...
            if (attributeToSet != null) {
                ...
                try {
                    this.setBusbarSection(attributeToSet, setInverse);
                } catch(LinkageException e) {
                   LOGGER.error(e.toString(), e);
                    throw new LinkageException(e.getMessage());
                }
            } else if (boundaryModel != null) {
                BusbarSection attributeToSetFromBoundary = boundaryModel.searchBusbarSection(idBusbarSection);
                if(attributeToSetFromBoundary != null) {
                    attributeToSetFromBoundary.setFromBoundary(true);
                    boolean setInverse = true;
                    try {
                        this.setBusbarSection(attributeToSetFromBoundary, setInverse);
                    } catch(LinkageException e) {
                       LOGGER.error(e.toString(), e);
                        throw new LinkageException(e.getMessage());
                    }
                    ...
                    StringBuilder errorMessage = new StringBuilder(
                            "Could not find the reference to object of type \"BusbarSection\" and id \"");
                    errorMessage.append(idBusbarSection);
                    errorMessage.append("\" in \"VoltageControlZone\" of id \"");
     ...
     *
     * @param otherVoltageControlZone
     *            the instance to copy
     */
    public void copyBase(final VoltageControlZone otherVoltageControlZone) {
        ...
        if (otherVoltageControlZone.currentBitset.get(0)) {
            BusbarSection busbarSectionAssociation = otherVoltageControlZone.getBusbarSection();

            //this.idBusbarSection = (busbarSectionAssociation != null) ? busbarSectionAssociation.getId() : "";
            if (busbarSectionAssociation != null) {
                this.idBusbarSection = busbarSectionAssociation.getId();
                // the proper bit will be set when the setter is called
            } else {
                this.idBusbarSection = "";
            }
        }
    ...
    private String getMessageForConsistency(final BitSet minBitset) {
        ...
        StringBuilder message = new StringBuilder(
                "Instance of \"VoltageControlZone\" of id \"");
        ...
        if (isNotSet.get(0)) {
            message.append("\t\"BusbarSection\" needs to be set\n");
        }
     ...
     *
     * @param VoltageControlZone
     *            the reference to the class to copy
     * @return the class constructed
     */
    private VoltageControlZone(final VoltageControlZone otherVoltageControlZone) {
        // TODO : check exception safe
        this.copyBase(otherVoltageControlZone);
    }

   /**
    * Constructor of the class VoltageControlZone
    */
    protected VoltageControlZone() {
        ...
        // attribute "BusbarSection" is optional :
     ...
     */
    public VoltageControlZone clone() {
        VoltageControlZone newInstance = new VoltageControlZone(this);
        VoltageControlZone newInstanceSP = newInstance;
