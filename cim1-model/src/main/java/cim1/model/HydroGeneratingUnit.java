 ...
 * Description :
 *
 * This class "HydroGeneratingUnit.java" represents the
 * class HydroGeneratingUnit extends GeneratingUnit

 */
public class HydroGeneratingUnit extends GeneratingUnit {

    private static Logger LOGGER = LoggerFactory.getLogger(HydroGeneratingUnit.class);
    ...
    */
     ...
     *
     * @param id
     *            id of the class HydroGeneratingUnit to create
     * @return the class created
     */
    public static HydroGeneratingUnit create(final String id) {
        HydroGeneratingUnit newHydroGeneratingUnit = new HydroGeneratingUnit();
        newHydroGeneratingUnit.setId(id);
        return newHydroGeneratingUnit;
    }
    ...
    public void readAttribute(final String class_name, final String attr_name,
        ...
        if (class_name.equals("HydroGeneratingUnit")) {
     ...
     *
     * @param otherHydroGeneratingUnit
     *            the instance to copy
     */
    public void copyBase(final HydroGeneratingUnit otherHydroGeneratingUnit) {
     ...
     *
     * @param HydroGeneratingUnit
     *            the reference to the class to copy
     * @return the class constructed
     */
    private HydroGeneratingUnit(final HydroGeneratingUnit otherHydroGeneratingUnit) {
        // TODO : check exception safe
        this.copyBase(otherHydroGeneratingUnit);
    }
    ...
    */
     ...
     */
    public HydroGeneratingUnit clone() {
        HydroGeneratingUnit newInstance = new HydroGeneratingUnit(this);
        HydroGeneratingUnit newInstanceSP = newInstance;
