 ...
 * Description :
 *
 * This class "SubGeographicalRegion.java" represents the
 * class SubGeographicalRegion extends IdentifiedObject
 *    + Region   1..1   GeographicalRegion 
 *    + Substations   0..-1   Substation   (inverseAssociation) 

 */
public class SubGeographicalRegion extends IdentifiedObject {

    private static Logger LOGGER = LoggerFactory.getLogger(SubGeographicalRegion.class);
    ...
    */
    ...
    public void setRegion(
            GeographicalRegion regionValue,
        ...
        if (setInverse) {
            ...
            if (regionValue != null) {
                regionValue.addRegions(this, false);
            }
        }
    }
  /**
   * Utility to return the "substations" List of 
   * "Substation" enum
   *
   * @return the list of the attributes "substations"
   */
    ...
    /**
     * Utility to add a value within the "substations" ArrayList of 
     * "Substation"
     *
     ...
     * @throws LinkageException
     */
    public void addSubstations(
            Substation substationsValue, 
            boolean setInverse) throws LinkageException {
        ...
        this.substations.add(substationsValue);
        this.currentBitset.set(1);
       
        if (setInverse) {
            
            if (substationsValue != null) {
                substationsValue.setRegion(this, false);
            }
        }
    }

    /**
     * Utility to test if the value of "substations" has been set
     *
     * @return boolean
     *            if true the attribute "substations" is already set
     *            if false it isn't yet
     */
    public boolean substationsIsSet() {
     ...
     *
     * @param id
     *            id of the class SubGeographicalRegion to create
     * @return the class created
     */
    public static SubGeographicalRegion create(final String id) {
        SubGeographicalRegion newSubGeographicalRegion = new SubGeographicalRegion();
        newSubGeographicalRegion.setId(id);
    ...
    public void readAttribute(final String class_name, final String attr_name,
        ...
        if (class_name.equals("SubGeographicalRegion")) {
    ...
    public void write(XMLStreamWriter xmlsw, boolean writeID) {
        ...
        if (writeID) {
            ...
            try {
                xmlsw.writeStartElement(CIMURI.CIMURI, "SubGeographicalRegion");
                xmlsw.writeAttribute(CIMModel.rdfURI, "ID", getId());
                // xmlsw.writeCharacters("\n");
            } catch (XMLStreamException e) {
                StringBuilder errorMessage = new StringBuilder(
                        "Error while trying to write the class ");
                errorMessage.append("SubGeographicalRegion ");
    ...
    public void resolveLinks(CIMModel model, CIMModel boundaryModel) throws LinkageException {
        if (idRegion != null) {
            GeographicalRegion attributeToSet =
                    model.searchGeographicalRegion
                    (idRegion);
            ...
            if (attributeToSet != null) {
                ...
                GeographicalRegion attributeToSetFromBoundary = boundaryModel.searchGeographicalRegion(idRegion);
                if(attributeToSetFromBoundary != null) {
                    attributeToSetFromBoundary.setFromBoundary(true);
                    try {
                        model.createGeographicalRegion(idRegion, attributeToSetFromBoundary);
                    ...
                    StringBuilder errorMessage = new StringBuilder(
                            "Could not find the reference to object of type \"GeographicalRegion\" and id \"");
                    errorMessage.append(idRegion);
                    errorMessage.append("\" in \"SubGeographicalRegion\" of id \"");
     ...
     *
     * @param otherSubGeographicalRegion
     *            the instance to copy
     */
    public void copyBase(final SubGeographicalRegion otherSubGeographicalRegion) {
        ...
        if (otherSubGeographicalRegion.currentBitset.get(0)) {
            GeographicalRegion regionAssociation = otherSubGeographicalRegion.getRegion();
    ...
    private void writeClass(XMLStreamWriter xmlsw) {
      ...
      for (Substation substations : this.substations){
               try {
     ...
     */
    private SubGeographicalRegion(final SubGeographicalRegion otherSubGeographicalRegion) {
        // TODO : check exception safe
        this.copyBase(otherSubGeographicalRegion);
    }

   /**
    * Constructor of the class SubGeographicalRegion
    */
     ...
     */
    public SubGeographicalRegion clone() {
        SubGeographicalRegion newInstance = new SubGeographicalRegion(this);
        SubGeographicalRegion newInstanceSP = newInstance;
