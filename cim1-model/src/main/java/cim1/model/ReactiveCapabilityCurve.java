 ...
 * Description :
 *
 * This class "ReactiveCapabilityCurve.java" represents the
 * class ReactiveCapabilityCurve extends Curve
 *    + InitiallyUsedBySynchronousMachine   0..-1   SynchronousMachine   (inverseAssociation) 

 */
public class ReactiveCapabilityCurve extends Curve {

    private static Logger LOGGER = LoggerFactory.getLogger(ReactiveCapabilityCurve.class);
     ...
     */
    public List<SynchronousMachine> initiallyUsedBySynchronousMachine;
   ...
   *
   * @return the list of the attributes "initiallyUsedBySynchronousMachine"
   */
    public List<SynchronousMachine > getInitiallyUsedBySynchronousMachine() {
        return this.initiallyUsedBySynchronousMachine;
    }
     ...
     * "SynchronousMachine"
     *
     * @param initiallyUsedBySynchronousMachineValue 
     *            value to add within the ArrayList
     * @param setInverse
     *            boolean to specify whether to set the inverse association or not
     * @throws LinkageException
     */
    public void addInitiallyUsedBySynchronousMachine(
            SynchronousMachine initiallyUsedBySynchronousMachineValue, 
            boolean setInverse) throws LinkageException {
        
        if (initiallyUsedBySynchronousMachine == null) {
            initiallyUsedBySynchronousMachine = new ArrayList<SynchronousMachine>();
        }
        
        this.initiallyUsedBySynchronousMachine.add(initiallyUsedBySynchronousMachineValue);
        this.currentBitset.set(0);
       
        if (setInverse) {
            
            if (initiallyUsedBySynchronousMachineValue != null) {
                initiallyUsedBySynchronousMachineValue.setInitialReactiveCapabilityCurve(this, false);
            }
        }
    }
     ...
     *
     * @return boolean
     *            if true the attribute "initiallyUsedBySynchronousMachine" is already set
     ...
     *
     * @param id
     *            id of the class ReactiveCapabilityCurve to create
     * @return the class created
     */
    public static ReactiveCapabilityCurve create(final String id) {
        ReactiveCapabilityCurve newReactiveCapabilityCurve = new ReactiveCapabilityCurve();
        newReactiveCapabilityCurve.setId(id);
    ...
    public void readAttribute(final String class_name, final String attr_name,
        ...
        if (class_name.equals("ReactiveCapabilityCurve")) {
    ...
    public void write(XMLStreamWriter xmlsw, boolean writeID) {
        ...
        if (writeID) {
            ...
            try {
                xmlsw.writeStartElement(CIMURI.CIMURI, "ReactiveCapabilityCurve");
     ...
     *
     * @param otherReactiveCapabilityCurve
     *            the instance to copy
     */
    public void copyBase(final ReactiveCapabilityCurve otherReactiveCapabilityCurve) {
    ...
    private String getMessageForConsistency(final BitSet minBitset) {
        ...
        StringBuilder message = new StringBuilder(
                "Instance of \"ReactiveCapabilityCurve\" of id \"");
        ...
        if (isNotSet.get(0)) {
            message.append("\t\"InitiallyUsedBySynchronousMachine\" needs to be set\n");
        }
     ...
     *
     * @param ReactiveCapabilityCurve
     *            the reference to the class to copy
     * @return the class constructed
     */
    private ReactiveCapabilityCurve(final ReactiveCapabilityCurve otherReactiveCapabilityCurve) {
        // TODO : check exception safe
        this.copyBase(otherReactiveCapabilityCurve);
    }
    ...
    */
    ...
    protected void clearAssociations(final Subset subset) {
        ...
        switch (subset) {
            ...
            case Equipment: {
                if (initiallyUsedBySynchronousMachine != null) {
                    initiallyUsedBySynchronousMachine.clear();
                }
     ...
     */
    public ReactiveCapabilityCurve clone() {
        ReactiveCapabilityCurve newInstance = new ReactiveCapabilityCurve(this);
        ReactiveCapabilityCurve newInstanceSP = newInstance;
