 ...
 * Description :
 *
 * This class "Curve.java" represents the
 * class Curve extends IdentifiedObject
 *    + CurveScheduleDatas   0..-1   CurveData   (inverseAssociation) 

 */
public class Curve extends IdentifiedObject {

    private static Logger LOGGER = LoggerFactory.getLogger(Curve.class);

    /**
     * Attribute "curveScheduleDatas"
     *
     * Comment from profile:
     * The point data values that define a curve
     */
    public List<CurveData> curveScheduleDatas;
  ...
  /**
   * Utility to return the "curveScheduleDatas" List of 
   * "CurveData" enum
   *
   * @return the list of the attributes "curveScheduleDatas"
   */
    public List<CurveData > getCurveScheduleDatas() {
        return this.curveScheduleDatas;
    }

    /**
     * Utility to add a value within the "curveScheduleDatas" ArrayList of 
     * "CurveData"
     *
     * @param curveScheduleDatasValue 
     *            value to add within the ArrayList
     * @param setInverse
     *            boolean to specify whether to set the inverse association or not
     * @throws LinkageException
     */
    public void addCurveScheduleDatas(
            CurveData curveScheduleDatasValue, 
            boolean setInverse) throws LinkageException {
        
        if (curveScheduleDatas == null) {
            curveScheduleDatas = new ArrayList<CurveData>();
        }
        
        this.curveScheduleDatas.add(curveScheduleDatasValue);
        this.currentBitset.set(0);
       
        if (setInverse) {
            
            if (curveScheduleDatasValue != null) {
                curveScheduleDatasValue.setCurveSchedule(this, false);
            }
        }
    }

    /**
     * Utility to test if the value of "curveScheduleDatas" has been set
     *
     * @return boolean
     *            if true the attribute "curveScheduleDatas" is already set
     *            if false it isn't yet
     */
    public boolean curveScheduleDatasIsSet() {
     ...
     *
     * @param id
     *            id of the class Curve to create
     * @return the class created
     */
    public static Curve create(final String id) {
     ...
     *            the instance to copy
     */
    public void copyBase(final Curve otherCurve) {
     ...
     */
    private Curve(final Curve otherCurve) {
        // TODO : check exception safe
        this.copyBase(otherCurve);
    }
    ...
    */
    protected Curve() {
        ...
        // attribute "CurveScheduleDatas" is optional :
     ...
     */
    public Curve clone() {
        Curve newInstance = new Curve(this);
        Curve newInstanceSP = newInstance;
