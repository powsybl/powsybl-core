 ...
 * Description :
 *
 * This class "ACLineSegment.java" represents the
 * class ACLineSegment extends Conductor

 */
public class ACLineSegment extends Conductor {

    private static Logger LOGGER = LoggerFactory.getLogger(ACLineSegment.class);
    ...
    */
     ...
     *
     * @param id
     *            id of the class ACLineSegment to create
     * @return the class created
     */
    public static ACLineSegment create(final String id) {
        ACLineSegment newACLineSegment = new ACLineSegment();
        newACLineSegment.setId(id);
        return newACLineSegment;
    }
    ...
    public void readAttribute(final String class_name, final String attr_name,
        ...
        if (class_name.equals("ACLineSegment")) {
     ...
     *
     * @param otherACLineSegment
     *            the instance to copy
     */
    public void copyBase(final ACLineSegment otherACLineSegment) {
        ...
        super.copyBase(otherACLineSegment);
     ...
     */
    private ACLineSegment(final ACLineSegment otherACLineSegment) {
        // TODO : check exception safe
        this.copyBase(otherACLineSegment);
    }

   /**
    * Constructor of the class ACLineSegment
    */
     ...
     */
    public ACLineSegment clone() {
        ACLineSegment newInstance = new ACLineSegment(this);
        ACLineSegment newInstanceSP = newInstance;
