 ...
 * Description :
 *
 * This class "WindGeneratingUnit.java" represents the
 * class WindGeneratingUnit extends GeneratingUnit

 */
public class WindGeneratingUnit extends GeneratingUnit {

    private static Logger LOGGER = LoggerFactory.getLogger(WindGeneratingUnit.class);
    ...
    */
     ...
     *
     * @param id
     *            id of the class WindGeneratingUnit to create
     * @return the class created
     */
    public static WindGeneratingUnit create(final String id) {
        WindGeneratingUnit newWindGeneratingUnit = new WindGeneratingUnit();
        newWindGeneratingUnit.setId(id);
        return newWindGeneratingUnit;
    }
    ...
    public void readAttribute(final String class_name, final String attr_name,
        ...
        if (class_name.equals("WindGeneratingUnit")) {
     ...
     *
     * @param otherWindGeneratingUnit
     *            the instance to copy
     */
    public void copyBase(final WindGeneratingUnit otherWindGeneratingUnit) {
    ...
    private String getMessageForConsistency(final BitSet minBitset) {
        ...
        StringBuilder message = new StringBuilder(
                "Instance of \"WindGeneratingUnit\" of id \"");
     ...
     *
     * @param WindGeneratingUnit
     *            the reference to the class to copy
     * @return the class constructed
     */
    private WindGeneratingUnit(final WindGeneratingUnit otherWindGeneratingUnit) {
        // TODO : check exception safe
        this.copyBase(otherWindGeneratingUnit);
    }

   /**
    * Constructor of the class WindGeneratingUnit
    */
    protected WindGeneratingUnit() {
     ...
     */
    public WindGeneratingUnit clone() {
        WindGeneratingUnit newInstance = new WindGeneratingUnit(this);
        WindGeneratingUnit newInstanceSP = newInstance;
