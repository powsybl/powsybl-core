 ...
 * Description :
 *
 * This class "VoltageLimit.java" represents the
...
public class VoltageLimit extends OperationalLimit {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(VoltageLimit.class);
    ...
    */
     ...
     *
     * @param id
     *            id of the class VoltageLimit to create
     * @return the class created
     */
    public static VoltageLimit create(final String id) {
        VoltageLimit newVoltageLimit = new VoltageLimit();
        newVoltageLimit.setId(id);
        return newVoltageLimit;
    }
    ...
    public void readAttribute(final String class_name, final String attr_name,
        ...
        if (class_name.equals("VoltageLimit")) {
    ...
    public void write(XMLStreamWriter xmlsw, boolean writeID) {
        ...
        if (writeID) {
            ...
            try {
                xmlsw.writeStartElement(CIMURI.CIMURI, "VoltageLimit");
     ...
     *
     * @param otherVoltageLimit
     *            the instance to copy
     */
    public void copyBase(final VoltageLimit otherVoltageLimit) {
        float newvalue;
        // assigning primitive type :
        if (otherVoltageLimit.currentBitset.get(0)) {
            newvalue = otherVoltageLimit.getValue();
    ...
    private String getMessageForConsistency(final BitSet minBitset) {
        ...
        StringBuilder message = new StringBuilder(
                "Instance of \"VoltageLimit\" of id \"");
     ...
     */
    private VoltageLimit(final VoltageLimit otherVoltageLimit) {
        // TODO : check exception safe
        this.copyBase(otherVoltageLimit);
    }

   /**
    * Constructor of the class VoltageLimit
    */
     ...
     */
    public VoltageLimit clone() {
        VoltageLimit newInstance = new VoltageLimit(this);
        VoltageLimit newInstanceSP = newInstance;
