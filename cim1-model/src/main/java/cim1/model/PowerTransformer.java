 ...
 * Description :
 *
 * This class "PowerTransformer.java" represents the
 * class PowerTransformer extends Equipment
 *    + Contains_TransformerWindings   0..-1   TransformerWinding   (inverseAssociation) 

 */
public class PowerTransformer extends Equipment {

    private static Logger LOGGER = LoggerFactory.getLogger(PowerTransformer.class);

    /**
     * Attribute "contains_TransformerWindings"
     *
     * Comment from profile:
     * A transformer has windings
     */
    public List<TransformerWinding> contains_TransformerWindings;
  ...
  /**
   * Utility to return the "contains_TransformerWindings" List of 
   * "TransformerWinding" enum
   *
   * @return the list of the attributes "contains_TransformerWindings"
   */
    public List<TransformerWinding > getContains_TransformerWindings() {
        return this.contains_TransformerWindings;
    }

    /**
     * Utility to add a value within the "contains_TransformerWindings" ArrayList of 
     * "TransformerWinding"
     *
     * @param contains_TransformerWindingsValue 
     *            value to add within the ArrayList
     * @param setInverse
     *            boolean to specify whether to set the inverse association or not
     * @throws LinkageException
     */
    public void addContains_TransformerWindings(
            TransformerWinding contains_TransformerWindingsValue, 
            boolean setInverse) throws LinkageException {
        
        if (contains_TransformerWindings == null) {
            contains_TransformerWindings = new ArrayList<TransformerWinding>();
        }
        
        this.contains_TransformerWindings.add(contains_TransformerWindingsValue);
        this.currentBitset.set(0);
       
        if (setInverse) {
            
            if (contains_TransformerWindingsValue != null) {
                contains_TransformerWindingsValue.setMemberOf_PowerTransformer(this, false);
            }
        }
    }

    /**
     * Utility to test if the value of "contains_TransformerWindings" has been set
     *
     * @return boolean
     *            if true the attribute "contains_TransformerWindings" is already set
     *            if false it isn't yet
     */
    public boolean contains_TransformerWindingsIsSet() {
     ...
     *
     * @param id
     *            id of the class PowerTransformer to create
     * @return the class created
     */
    public static PowerTransformer create(final String id) {
        PowerTransformer newPowerTransformer = new PowerTransformer();
        newPowerTransformer.setId(id);
        return newPowerTransformer;
    }
    ...
    public void readAttribute(final String class_name, final String attr_name,
        ...
        if (class_name.equals("PowerTransformer")) {
    ...
    public void write(XMLStreamWriter xmlsw, boolean writeID) {
        ...
        if (writeID) {
            ...
            try {
                xmlsw.writeStartElement(CIMURI.CIMURI, "PowerTransformer");
     ...
     *
     * @param otherPowerTransformer
     *            the instance to copy
     */
    public void copyBase(final PowerTransformer otherPowerTransformer) {
     ...
     */
    private PowerTransformer(final PowerTransformer otherPowerTransformer) {
        // TODO : check exception safe
        this.copyBase(otherPowerTransformer);
    }

   /**
    * Constructor of the class PowerTransformer
    */
    ...
    protected void clearAssociations(final Subset subset) {
        ...
        switch (subset) {
            ...
            case Equipment: {
                if (contains_TransformerWindings != null) {
                    contains_TransformerWindings.clear();
                }
     ...
     */
    public PowerTransformer clone() {
        PowerTransformer newInstance = new PowerTransformer(this);
        PowerTransformer newInstanceSP = newInstance;
