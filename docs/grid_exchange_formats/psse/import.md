...
![TwoWindingsTransformerModels](img/two-windings-transformer-model.svg){: width="100%" .center-image}
...
![ThreeWindingsTransformerModels](img/three-windings-transformer-model.svg){: width="100%" .center-image}
