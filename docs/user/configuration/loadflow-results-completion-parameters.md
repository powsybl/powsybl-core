...
The `loadflow-results-completion-parameters` module is used by the [load flow validation](../../grid_features/loadflow_validation.md) and the [load flow post processor](../../grid_features/import_post_processor.md) features.
