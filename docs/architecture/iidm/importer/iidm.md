...
## Use the IIDM importer
To support IIDM-XML files in your project, you have to add the following dependency to your `pom.xml` file.
```xml
<dependency>
...
## References
- [IIDM format specification](../model/README.md)
